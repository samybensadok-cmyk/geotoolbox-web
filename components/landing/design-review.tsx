  ...
  return <section style={{background:"#e7ece8",padding:"28px 20px",color:"#173c35"}}>
    <div style={{maxWidth:1280,margin:"auto"}}>
      ...
      <div style={{display:"flex",gap:10,flexWrap:"wrap",alignItems:"center",margin:"18px 0"}}>
        ...
        <label style={{fontSize:12}}>Width <select aria-label="Viewport width" value={width} style={choice} onChange={event=>setWidth(Number(event.target.value))}>{[320,375,390,640,768,1024,1280].map(n=><option value={n} key={n}>{n}px</option>)}</select></label>
