...
date: "2026-09-05"
updated: "2026-09-25"
recheckBy: "2026-10-06"   # 09-25: GPT-6 Sol ($2,00/$10,00) + GPT-6 Luna ($0,10/$0,50) toegevoegd, gelanceerd 22-09-2026 in Work/Codex voor Plus+ (Astra ongewijzigd, blijft volgens eigen aankondiging OpenAI's beste model); AA Intelligence Index opnieuw geversioneerd naar v4.3.2 (Astra 53, gelijk met Fable 5.1; Claude Opus 5.5 leidt met 58) - elke AA-score in dit artikel moet gelabeld blijven met de indexversie, scores tussen versies zijn niet vergelijkbaar.
...
- **GPT-6 Astra is OpenAI's vlaggenschipmodel, boven de GPT-5.6-lijn, uitgebracht op 3 september 2026 en beschikbaar via de API als `gpt-6-astra`, met een contextvenster van 1.050.000 tokens.**
...
GPT-6 Astra is OpenAI's frontier-[taalmodel](/blog/how-does-chatgpt-work), uitgebracht op 3 september 2026 als frontiermodel boven de GPT-5.6-lijn (de directe opvolger van GPT-5.6 Sol is GPT-6 Sol, niet Astra). Ontwikkelaars roepen het via de API aan onder de modelnaam `gpt-6-astra`.
...
Als de term [agentic](/blog/agentic-ai) nieuw voor je is: Astra is een [reasoning model](/blog/how-ai-models-think) met veel meer speelruimte dan de [GPT-5.6-familie](/blog/gpt-5-6) die het vervangt - het verschil tussen een model dat op elke stap wacht op een instructie en een model dat een hele reeks stappen zelf aan elkaar rijgt.
...
<figure>
  <img src="/blog/gpt-6-astra/release-timeline-nl.png" alt="Releasetijdlijn van GPT-6 Astra: 1 september, Path to Astra gepubliceerd; 3 september, beperkte preview en algemeen beschikbaar in Microsoft Foundry; 4 september, publieke release en algemeen beschikbaar in GitHub Copilot" />
  <figcaption>De uitrol van GPT-6 Astra verliep gefaseerd over vier dagen, geen losse releasedatum.</figcaption>
</figure>
...
<figure>
  <img src="/blog/gpt-6-astra/access-status-nl.png" alt="Wie kan GPT-6 Astra gebruiken op 5 september 2026: geen toegang bij ChatGPT Free, alleen in Work en Codex bij Plus, live inclusief gewone Chat bij Pro/Business/Enterprise, live bij de OpenAI API, en alleen Pro+/Max/Business/Enterprise bij GitHub Copilot" />
  <figcaption>De aangekondigde lijst en de daadwerkelijk uitgerolde lijst lopen uiteen, vooral bij het Plus-abonnement.</figcaption>
</figure>
...
Op de modelpagina (niet de prijzenpagina) staat nog een detail: prompts boven de 272.000 inputtokens worden voor de hele aanvraag afgerekend tegen 2x het input- en cachetarief en 1,5x het outputtarief; cache writes kosten 1,25x het ongecachete inputtarief. Flex draait, net als Batch, op 50%. Zie onze gidsen over [tokenkosten](/blog/ai-token-cost) en het [contextvenster](/blog/how-does-ai-search-work) voor de volledige mechaniek.

## GPT-6 Sol en GPT-6 Luna voegen zich bij de familie

Astra kwam op 3 september alleen uit. Drie weken later, op 22 september 2026, voegde OpenAI twee GPT-6-modellen toe: **GPT-6 Sol** en **GPT-6 Luna**. In tegenstelling tot Astra is geen van beide een frontier-model – OpenAI zegt het zelf met zoveel woorden: "GPT-6 Astra continues to be our best model across the board." Sol en Luna vervangen in plaats daarvan [GPT-5.6 Sol en Luna](https://geotoolbox.ai/blog/gpt-5-6) als werk- en snelle laag binnen ChatGPT Work en Codex, voor Plus, Pro, Business, Enterprise en Edu. Free en Go krijgen GPT-6 Luna alleen in de desktopapp, niet in de normale chat.

Op de API kost GPT-6 Sol $2,00 input en $10,00 output per miljoen tokens, GPT-6 Luna $0,10 en $0,50 – elk ongeveer de helft van het promotietarief van hun GPT-5.6-tegenhanger ($4/$20 voor Sol, $0,20/$1,20 voor Luna) en een fractie van Astra's $10,00/$50,00. Een normale ChatGPT-chat draait op het moment van schrijven nog altijd op GPT-5.6, niet op GPT-6 Sol of Luna. Drie weken na de lancering bestaat de GPT-6-familie dus uit één frontier-model (Astra) plus twee werk-laag-broertjes (Sol, Luna) die er in prijs en productbereik onder zitten.
...
**Update, 25 september 2026:** Artificial Analysis heeft de Intelligence Index opnieuw geversioneerd, naar **v4.3.2**. Op die schaal scoort Astra **53**, gelijk met Claude Fable 5.1, terwijl **Claude Opus 5.5** de algehele index aanvoert met **58**. De cijfers v4.1.1 en v4.2 hierboven horen elk bij de schaal van die dag, niet bij deze: Artificial Analysis herziet tussen indexversies zijn tests en scoring (v4.3.2 heeft twee op ratings gebaseerde tests opnieuw verankerd en opnieuw gefit), dus scores uit verschillende versies zijn nooit direct vergelijkbaar, alleen de relatieve rangorde binnen één versie.
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Intelligence Index v4.3.2</td><td>53</td><td>53 (gelijk)</td><td>Artificial Analysis</td></tr>
...
Astra ligt voor op documentredeneren en tokenefficiëntie; Artificial Analysis noteert dat Astra per taak minder dan de helft kost van Claude Fable 5 (niet 5.1) voor eenzelfde score op de Coding Agent Index, waar de twee ongeveer gelijk liggen op 67. Fable 5.1 leidde de algemene Intelligence Index bij lancering (v4.2); op de huidige v4.3.2-herversionering staan beide gelijk op 53, terwijl Claude Opus 5.5 de algehele index nu aanvoert met 58. Fable 5.1 heeft nog altijd een gunstiger cachetarief - een kwart van dat van Astra, wat telt in agentloops die telkens dezelfde context herlezen.
...
De les voor wie hierover schrijft: snelheid van publicatie koopt de eerste paar dagen, zolang het antwoord specifiek, gedateerd en vindbaar is voor een [AI-crawler](/blog/ai-crawlers). Zie onze gidsen over [hoe ChatGPT-zoeken werkt](/blog/how-chatgpt-search-works), [AI-citaties](/blog/how-to-get-cited-by-ai) en [wat AI-zichtbaarheid is](/blog/what-is-ai-visibility), en test je eigen site met de gratis [AI-crawler-checker](/tools/ai-crawler-checker).

## Veelgestelde vragen

### Is GPT-6 uit?

Ja. GPT-6 Astra verscheen op 3 september 2026 als beperkte preview voor het Daybreak-programma en kwam diezelfde dag algemeen beschikbaar in Microsoft Foundry; betaalde ChatGPT-abonnementen en GitHub Copilot volgden vanaf 4 september 2026. Astra is de frontier-release van GPT-6; op 22 september 2026 voegde OpenAI twee extra GPT-6-modellen toe, Sol en Luna, als werk-laag-broertjes binnen ChatGPT Work en Codex, onder Astra in prijs en bereik.

### Wat is GPT-6 Astra?

OpenAI's frontier-taalmodel, boven GPT-6 Sol en Luna, met een contextvenster van 1.050.000 tokens, tekst en beeld als input, alleen tekst als output, en een instelbare reasoning effort van low tot max. De kennisafkapdatum is 30 april 2026. Beschikbaar via de API als `gpt-6-astra`.
