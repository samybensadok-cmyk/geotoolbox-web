...
date: "2026-07-26"
updated: "2026-09-26"
recheckBy: "2026-10-09"  # 09-26: AA Intelligence Index figures moved from the stale v4.1.1 scale (K3 60 tied #1 open, Opus 5 63, Fable 5 62, Sol 61) to v4.3.2 (K3 44, #3 open behind MiMo-V2.6-Pro 46 and GLM-5.3 45; Opus 5 51, Fable 5 50, GPT-5.6 Sol 47; Opus 5.5 leads at 58), verified on the artificialanalysis.ai model pages 2026-09-26, in prose, table, Sol paragraph, FAQ and quick-verdict row. Scorecard PNG is a dated August 2026 snapshot (eyebrow says so): not regenerated, alt+figcaption now dated. Earlier: FIXED 08-18 (independent Sonnet QA review of the freshness-audit batch caught this): L96's cost table still showed the cancelled Sonnet-5 rate hike ("to $3 after Aug 31" / "to $15") four days after the 08-14 corpus-wide Sonnet-5 sweep touched this file's `updated` date without actually fixing this table — a self-contradiction against L51's own correct row in the same file. Also fixed L88 prose, which claimed K3's $15 output "sits at Sonnet 5's post-August standard rate" (false: Sonnet 5's real permanent rate is $10, so K3 runs 50% above it, not equal). No recheckBy guard existed before this.
...
So here is the comparison those models cannot give you, current as of July 2026, with independent index scores updated in September 2026: Kimi K3 vs Claude, head to head on coding, reasoning, speed, and what each actually costs. There is no single winner; the honest answer depends on the job. We flag which numbers are independently measured and which come from the labs themselves, because on models this new that distinction is most of the story.
...
<tr><td><strong>General intelligence</strong></td><td><strong>Claude</strong></td><td>Opus 5 leads this set on the Artificial Analysis Intelligence Index; K3 trails all three</td></tr>
...
<tr><td><strong>Cost per task</strong></td><td><strong>Kimi K3</strong></td><td>Around $0.95 per Intelligence Index task versus $2.03 for Opus 5 (summer 2026 index run)</td></tr>
...
Three configurations matter for this comparison. **[Fable 5.1](https://geotoolbox.ai/blog/claude-fable-5-1)** is Anthropic's top-tier model for long-running autonomous agents, and its most expensive (it replaced Fable 5 on September 1, 2026 at the same $10/$50 price). **Opus 5**, released July 24, 2026, is the prior high-end model for reasoning, since superseded by Opus 5.5 ($4/$20, September 22, 2026), which now leads the independent intelligence leaderboard. **Sonnet 5** is the balanced production default, and the one whose sticker price lands closest to K3. There is also a legacy Opus 4.8 you will still see in older benchmark tables.
...
<tr><td><strong>Opus 5</strong></td><td>High-end reasoning and coding</td><td>$5 / $25</td><td>Prior Opus; Opus 5.5 now leads the AA index (58)</td></tr>
...
The independent picture is consistent. On the [Artificial Analysis](https://artificialanalysis.ai/models/kimi-k3) Intelligence Index (v4.3.2, September 2026), K3 scores 44, third among open-weight models behind Xiaomi's MiMo-V2.6-Pro (46) and GLM-5.3 (45), and behind all three closed models compared here: Opus 5 at 51, Fable 5 at 50, and GPT-5.6 Sol at 47. Anthropic's newer Claude Opus 5.5 now leads the whole index at 58. But on the [Frontend Code Arena](https://arena.ai/leaderboard), a human-preference vote on generated interfaces that leans toward frontend and visual tasks, K3 ranks first, the first open-weight model to lead it, and it beats Fable 5 head to head. Read those two results together: K3 is a coding and interface specialist at the frontier of its lane, and only competitive outside it.

<figure className="not-prose my-8">
  <BlogImage src="/blog/kimi-k3-vs-claude/kimi-k3-vs-claude-benchmarks.png" alt="Who-wins-what scorecard, as of August 2026, comparing Kimi K3, Claude, and GPT-5.6 Sol across six dimensions: Kimi K3 leads frontend coding (Frontend Code Arena Elo 1,682), cost per task ($0.95), and open weights, while Claude leads general intelligence (Opus 5 at 63 on the August 2026 index), hard reasoning (53 on Humanity's Last Exam), and output speed (Fable 5 at 71 tokens per second)." w="1100" h="744" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Independently measured results tell a different story from the vendor tables. K3 owns frontend and cost; Claude owns reasoning and speed. Scores as of August 2026; the September 2026 Intelligence Index re-version (v4.3.2) lowered every score but kept the order (Opus 5 51, Fable 5 50, GPT-5.6 Sol 47, K3 44).</figcaption>
</figure>
...
<tr><td><strong>AA Intelligence Index</strong> (v4.3.2, Sept 2026)</td><td>44</td><td><strong>51 (Opus 5), 50 (Fable 5)</strong></td><td>47</td><td><strong>Independent</strong> (Artificial Analysis)</td></tr>
...
On paper this is the easiest win in the comparison. Kimi K3 charges $3 per million input tokens and $15 per million output, with cache hits dropping input to $0.30. That output rate runs 50% above Sonnet 5's permanent $10 rate, undercuts Opus 5, and is a third of Fable 5. And on Artificial Analysis's controlled cost-per-task measure, in its summer 2026 index run, K3 was the cheapest model in the set at about $0.95, under Opus 5 at $2.03 and Fable 5 at $2.75 (the September v4.3.2 re-version re-measured cost and token use, and its figures are not comparable with these). If you stop reading here, K3 looks like a straight price cut.

<table>
<thead>
<tr><th>Model</th><th>Input / 1M</th><th>Output / 1M</th><th>Cached input</th><th>Cost per task (AA, max, summer 2026 run)</th></tr>
</thead>
<tbody>
...
Two things complicate the clean number. The first is verbosity. K3 reasons on every request, and with its reasoning effort locked to the single "max" setting on Moonshot's API and OpenRouter alike, it meters far more output than a comparable Claude call: Artificial Analysis clocked K3 at 130M output tokens to run the summer 2026 version of its index, against a 63M median. On an agent job with retries and a growing history, that extra output lands on the $15 line, which is why first-week users on Kimi's coding plans repeatedly report a single task eating a startling share of their quota.
...
<tr><td>High-volume coding on a tight budget</td><td><strong>Kimi K3</strong></td><td>Lowest cost per task in the summer 2026 index run, if you can tolerate the latency</td></tr>
...
For frontend and interface coding, yes: K3 ranks first on the human-preference Frontend Code Arena, ahead of Claude Fable 5. For general reasoning and the hardest problems, no: Claude Opus 5 and Fable 5 score well above K3 on the independent Intelligence Index and score about ten points higher on Humanity's Last Exam. K3 is a specialist that wins its lane, not an across-the-board replacement.

### Is Kimi K3 cheaper than Claude?

Against Opus 5 and Fable 5, yes: K3's per-token rates undercut both, and on Artificial Analysis's cost-per-task measure from its summer 2026 index run, K3 was the cheapest model in the set at about $0.95, below Opus 5's $2.03. Sonnet 5 is the exception, cheaper per token today, though K3 was still cheaper per task in that run. And K3's verbose reasoning meters more output on real jobs, so comparing its API price to a flat Claude subscription is not like-for-like.
