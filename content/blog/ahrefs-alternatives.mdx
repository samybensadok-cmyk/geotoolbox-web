...
<table>
  ...
  <tbody>
    ...
    <tr><td><a href="/go/seranking?ref=ahrefs-alternatives-pricing" target="_blank" rel="sponsored nofollow noopener noreferrer">SE Ranking</a></td><td>Cheaper all-in-one</td><td>$129/mo ($103 annual)</td><td>Basic AI-search visibility in-plan, fuller toolkit $89/mo (€79 in the EU) add-on; white-label reporting is the Agency Pack add-on (+$69/mo); 14-day trial, no card</td></tr>
