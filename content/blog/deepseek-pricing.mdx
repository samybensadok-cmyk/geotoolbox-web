...
Two older details still confuse people. DeepSeek's earlier off-peak discount, the V3-era window that knocked 50 to 75% off during quiet hours, no longer appears on the current pricing, which is flat, with no time-of-day discount to schedule around. The peak-hour pricing that circulated as rumor is now official: DeepSeek's pricing page states that peak hours (09:00-12:00 and 14:00-18:00 Beijing time, UTC+8) will bill at 2x the regular rate. As of August 2026 its start date is still "subject to official announcement," so the USD rates stay flat for the moment, but plan for it if your traffic runs during Beijing business hours. The move that never fails: check the date on any DeepSeek price before you trust it.
