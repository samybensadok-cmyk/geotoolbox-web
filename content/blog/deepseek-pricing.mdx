...
<figure className="not-prose my-8">
  <BlogImage src="/blog/deepseek-pricing/deepseek-vs-frontier-output-cost.png" alt="Bar chart drawn to scale comparing API output price per million tokens in August 2026, at DeepSeek's off-peak rate: DeepSeek V4 Flash at $0.66 is far smaller than every rival shown, V4 Pro at $1.98 sits just under Grok 4.3's $2.50 and is far smaller than Gemini 3.1 Pro at $12, GPT-5.6 Sol at $20 on its promotional rate, and Claude Opus 5 at $25." w="2200" h="1442" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Output tokens per 1M, to scale against a $25 axis, at DeepSeek's off-peak rate. Peak-hour DeepSeek pricing (01:00-04:00 and 06:00-10:00 UTC) is double these bars.</figcaption>
</figure>
