...
Start with the names, because that is where comparisons go wrong first. xAI's current flagship is **Grok 4.5**, launched July 8, 2026, with the prior **Grok 4.3** and **Grok 4.20** for heavier multi-agent reasoning and a cheap **grok-code-fast-1** for coding. Google runs on **Gemini 3.1 Pro** for hard tasks and the newer, faster **Gemini 3.5 Flash** as its default, with Deep Think reserved for its top tier. If a comparison still pits Grok 4 against Gemini 2.5, it is describing 2025.
...
Gemini's flagship runs to about 1 million tokens, while Grok 4.5 sits at 500K (the prior Grok 4.3 was closer to 1M). Both handle long documents and codebases comfortably, but Gemini currently has more headroom. Treat the flagship figure as the practical number.

## Sources

- [xAI Grok model docs](https://docs.x.ai/docs/models) - Grok 4.5/4.3 specs, API pricing, and real-time search tools
- [llm-stats: Gemini 3 Pro vs Grok 4.1 Thinking](https://llm-stats.com/models/compare/gemini-3-pro-preview-vs-grok-4.1-thinking-2025-11-17) - GPQA, AIME, creative writing and EQ-Bench scores
- [Tom's Guide: Gemini 3.0 vs Grok 4.1, 9 prompts](https://www.tomsguide.com/ai/i-just-tested-gemini-3-0-vs-grok-4-1-with-9-prompts-and-theres-a-clear-winner) - real-world head-to-head
- [Tom's Guide: Google Gemini 3 explained](https://www.tomsguide.com/ai/google-gemini-3-everything-you-need-to-know) - Gemini 3 family and Deep Think
- [PiunikaWeb: Grok moderation update backlash](https://piunikaweb.com/2026/01/20/grok-censoring-everything-users-say/) - the January 2026 content tightening
- [Google AI subscriptions](https://blog.google/products-and-platforms/products/google-one/google-ai-subscriptions/) - Gemini consumer plan structure
