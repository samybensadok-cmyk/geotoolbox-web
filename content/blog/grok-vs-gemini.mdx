...
Start with the names, because that is where comparisons go wrong first. xAI's current flagship is [**Grok 4.6**](https://geotoolbox.ai/blog/grok-4-6), launched August 12, 2026, with the prior **Grok 4.5**, **Grok 4.3**, and **Grok 4.20** for heavier multi-agent reasoning and a cheap **grok-code-fast-1** for coding. Google runs on **Gemini 3.1 Pro** for hard tasks and the newer, faster **Gemini 3.6 Flash** as its default, with Deep Think reserved for its top tier. If a comparison still pits Grok 4 against Gemini 2.5, it is describing 2025.
...
<tr><td><strong>Current flagship</strong></td><td>Grok 4.6 (Aug 2026); Grok 4.5, 4.3, 4.20 prior-gen</td><td>Gemini 3.1 Pro; Gemini 3.6 Flash (newest default)</td></tr>
...
Read that table as a map of temperaments, not a scoreboard. Gemini is the careful analyst; Grok is the quick, expressive generalist, and both descriptions predate the models you would run today. **Grok 4.5**, launched July 8, 2026, sharpened xAI's standing: it landed 4th on the Artificial Analysis Intelligence Index, notably above every Gemini model on that index, though it shipped without a clean side-by-side against Gemini 3.5. The August 2026 [Grok 4.6](https://geotoolbox.ai/blog/grok-4-6) is now the current flagship. For the reasoning-heavy end of this debate, our [Claude vs Gemini comparison](https://geotoolbox.ai/blog/claude-vs-gemini) covers a third contender that often beats both on careful analysis.
