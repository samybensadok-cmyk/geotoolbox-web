...
<figure className="not-prose my-8">
  <BlogImage src="/blog/grok-vs-gemini/grok-vs-gemini-scorecard.png" alt="Scorecard of where Grok and Gemini each lean, from real-time data to value." w="1200" h="944" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">A winner per job, not one winner: Grok takes the live and cheap lanes, Gemini the multimodal and Workspace ones.</figcaption>
</figure>
...
Start with the names, because that is where comparisons go wrong first. xAI's current flagship is [**Grok 4.5**](https://geotoolbox.ai/blog/grok-4-5), launched July 8, 2026, with the prior **Grok 4.3** and **Grok 4.20** for heavier multi-agent reasoning and a cheap **grok-code-fast-1** for coding. Google runs on **Gemini 3.1 Pro** for hard tasks and the newer, faster **Gemini 3.6 Flash** as its default, with Deep Think reserved for its top tier. If a comparison still pits Grok 4 against Gemini 2.5, it is describing 2025.
...
<tr><td><strong>Current flagship</strong></td><td>Grok 4.5 (July 2026); Grok 4.3 and 4.20 prior-gen</td><td>Gemini 3.1 Pro; Gemini 3.6 Flash (newest default)</td></tr>
...
Both have a free tier, and for a lot of people it is enough. Grok's free plan gives limited prompts plus basic image and video generation. Gemini's free plan runs on 3.6 Flash with a roughly 1-million-token context, which makes it the more generous free option for everyday work.
...
<tbody>
<tr><td><strong>Free</strong></td><td>Limited prompts + basic media</td><td>Gemini 3.6 Flash, ~1M context</td></tr>
