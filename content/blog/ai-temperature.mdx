...
- [Is Temperature the Creativity Parameter of Large Language Models?](https://arxiv.org/abs/2405.00492) - Peeperkorn, Kouwenhoven, Brown, and Jordanous, 2024
- [What Is LLM Temperature?](https://www.ibm.com/think/topics/llm-temperature) - IBM
- [Why is the API output inconsistent even after the temperature is set to 0?](https://community.openai.com/t/why-the-api-output-is-inconsistent-even-after-the-temperature-is-set-to-0/329541) - OpenAI Developer Community
- [ChatGPT Was Asked the Same Question 10 Times. The Answers Kept Changing.](https://scitechdaily.com/chatgpt-was-asked-the-same-question-10-times-the-answers-kept-changing/) - SciTechDaily, reporting a study by Cicek et al., Rutgers Business Review, 2025
- [New Research: AIs Are Highly Inconsistent When Recommending Brands or Products](https://sparktoro.com/blog/new-research-ais-are-highly-inconsistent-when-recommending-brands-or-products-marketers-should-take-care-when-tracking-ai-visibility/) - Rand Fishkin, SparkToro and Gumshoe.ai, 2026
