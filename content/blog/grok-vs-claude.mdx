...
<tr><td><strong>Context window</strong></td><td>1M tokens on Opus 4.8 and Sonnet 5</td><td>500K tokens on Grok 4.5 (Grok 4.3 was 1M)</td></tr>
...
<tr><td><strong>API, per 1M tokens</strong></td><td>Opus 4.8 at $5 in / $25 out; Sonnet 5 at $3 / $15</td><td>Grok 4.5 at $2 in / $6 out (Grok 4.3 was $1.25 / $2.50)</td></tr>
</tbody>
</table>

On the API the gap is still large. Per [xAI's pricing](https://docs.x.ai/docs/models), Grok 4.5 runs $2 per million input tokens and $6 per million output tokens, while per [Anthropic's pricing](https://claude.com/pricing) Claude Opus 4.8 is $5 and $25 — well over double on input and roughly four times on output. So you get Opus-class capability from Grok 4.5 at more than 60% less: Grok 4.5 costs more than the prior Grok 4.3 did, but still lands far under Opus. If you are generating at volume, that difference compounds fast and Grok is the cheaper engine on sticker rates, though caching discounts and how many reasoning tokens each model burns can narrow the real-world gap.
