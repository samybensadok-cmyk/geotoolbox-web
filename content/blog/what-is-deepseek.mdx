...
One change arrived with V4's GA: DeepSeek has now published a peak/off-peak scheme on its [official pricing page](https://api-docs.deepseek.com/quick_start/pricing), which will charge 2x the regular rate during Beijing peak hours (09:00-12:00 and 14:00-18:00, UTC+8). As of August 2026 the effective date is still "subject to official announcement," so the rates above remain flat for now, but the policy is confirmed rather than rumored. Confirm the current rates on the official pricing page before you build.
