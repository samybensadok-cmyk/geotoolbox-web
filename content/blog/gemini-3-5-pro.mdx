...
<figure>
  <BlogImage src="/blog/gemini-3-5-pro/gemini-3-5-rollout-status.png" w={1300} h={649} alt="Gemini 3.5 rollout status: Flash generally available, Pro in internal preview, GA reported months behind schedule." />
  <figcaption>Where each Gemini 3.5 model stands as of July 17, 2026: Flash shipped, Pro delayed and still internal-only.</figcaption>
</figure>
