...
date: "2026-06-28"
updated: "2026-09-20"  # Sep refresh: SemiAnalysis cancellation report (2026-08-07, not confirmed by Google) new section, 3.8 Flash GA 09-02 + intro pricing
author: "Samy BEN SADOK"
tags: ["gemini-3-5-pro", "gemini", "google-gemini", "gemini-ai", "llm", "guide"]
draft: false
---

Gemini 3.5 Pro is the Google model everyone is waiting for and almost no one can use. As of September 20, 2026 it still has not shipped, Google has published no specs for it, and most of what you will read about its context window, pricing, reasoning, and release date, including a report that it was cancelled outright, is either rumor formatted to look official or an unconfirmed claim.
...
No. As of September 20, 2026, Gemini 3.5 Pro is still not generally available, and most of what you can read about its specs is guesswork. (Last verified September 20, 2026. When the rollout completes, the API model-list status line covered below is the fastest way to check.)
...
- **Gemini 3.5 Flash** is live, though on July 21, 2026 its successor [Gemini 3.6 Flash](https://geotoolbox.ai/blog/gemini-3-6-flash-vs-3-5-flash-lite) took over as the default model in the Gemini app and AI Mode in Search.
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/gemini-3-5-pro/gemini-3-5-rollout-status.png" alt="Gemini 3.5 rollout status: Flash generally available, Pro in internal preview, GA reported months behind schedule." w="1300" h="392" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
...
Short answer: unconfirmed. Google has not denied or confirmed it. On August 7, 2026, [SemiAnalysis reported](https://newsletter.semianalysis.com/p/gemini-is-cooked-but-gcp-is-cooking) that Google had silently cancelled 3.5 Pro and was "coping by hyping up Gemini 4 instead," with Gemini 3.6 Flash serving as a bridge model in the meantime. Industry chatter relayed in the same report puts Pro's capability level at roughly Claude Opus 4.5 (November 2025).

Google has not confirmed the report, and has not withdrawn its prior position either: as of September 20, 2026, its public line remains what it was before the report: 3.5 Pro is "currently testing with partners" and will ship "as soon as it's ready." Google also publicly confirmed pre-training on Gemini 4 back on July 21, 2026, so Gemini 4 itself is not "unannounced," only undated. There is still no 3.5 Pro model card, no API entry, and Google's own materials continue to describe Pro as in progress rather than shelved.

Treat the cancellation report the way this page treats the rumored specs below: a single well-sourced outlet, unconfirmed by the vendor, with no independent confirmation either way. If Pro really is dead, the tell will be Google quietly dropping the "testing with partners" language, not this report.
...
<tr><td><strong>Cancelled outright</strong></td><td>Shelved in favor of Gemini 4</td><td>SemiAnalysis (August 7, 2026)</td><td><strong>No.</strong> Google has not confirmed a cancellation; its public line is unchanged since before the report</td></tr>
</tbody>
</table>

The cleanest example is the [context window](https://geotoolbox.ai/blog/how-does-ai-search-work). Several widely-shared specs tables list "2 million tokens" for Gemini 3.5 Pro as a confirmed figure. Google's actual announcement gives no token count for Pro at all, and the 1M figure in circulation is associated with Flash, not Pro. So a spec presented as fact is, at the source level, an assumption.
...
The [Deep Think reasoning mode](https://geotoolbox.ai/blog/how-ai-models-think) is real as a concept Google has discussed elsewhere, but it has not been attached to a published Gemini 3.5 Pro spec. Treat it as possible but unconfirmed until Google ties it to a 3.5 Pro model card.
...
<tbody>
<tr><td><strong>Gemini 3.5 Flash</strong></td><td>Generally available; was the app + AI Mode default until 3.6 Flash (July 2026)</td><td>Terminal-Bench 2.1 76.2%, GDPval-AA 1656, MCP Atlas 83.6%, CharXiv 84.2%</td><td>Fast, cheaper tier you can use today; already beats 3.1 Pro on coding/agentic</td></tr>
<tr><td><strong>Gemini 3.5 Pro</strong></td><td>Not released; internal preview, reported months behind schedule (Bloomberg, July 2026); unconfirmed cancellation report (SemiAnalysis, August 2026)</td><td>None published</td><td>The higher-ceiling tier, on paper. No verified numbers exist yet</td></tr>
...
Here is the part that affects your traffic whether or not Pro ever ships on your timeline: the Gemini Flash shift is already live in Google's AI surfaces. Google says the current Flash model, now Gemini 3.6 Flash (which succeeded 3.5 Flash as the default on July 21, 2026), is the default in [AI Mode](https://geotoolbox.ai/blog/what-is-google-ai-mode), and AI Overviews, the AI answers in regular Search, run on Gemini models too. The model upgrade reached your audience the day it shipped, not on Pro's launch day.
...
**Flash is no longer the cheap tier.** At $1.50 in and $9.00 out per million tokens, 3.5 Flash costs exactly three times the Gemini 3 Flash Preview it succeeds ($0.50 / $3.00). If you want cheap, 3.1 Flash-Lite at $0.25 / $1.50 is the tier that now plays that role. One correction on a claim circulating in those threads: 3.5 Flash does not cost more than 3.1 Pro on list price, since 3.1 Pro Preview is $2.00 / $12.00. The argument people are actually making is about effective cost per completed task once thinking verbosity is counted, which is a different and harder-to-verify claim. Google has since shipped [Gemini 3.6 Flash and a new 3.5 Flash-Lite](https://geotoolbox.ai/blog/gemini-3-6-flash-vs-3-5-flash-lite), which reshuffle this low-cost lineup again, then Gemini 3.7 Flash on August 13 and **Gemini 3.8 Flash** on September 2, 2026, now the top Flash model (Stable). All of 3.6, 3.7, and 3.8 Flash currently share the same introductory pricing of $0.75 input / $3.75 output per million tokens through December 31, 2026, doubling to $1.50 / $7.50 after.
...
No. As of September 20, 2026, Gemini 3.5 Pro is still not generally available. Google announced the Gemini 3.5 family at I/O on May 19, 2026, but only Gemini 3.5 Flash shipped. On July 16, 2026, Bloomberg reported the rollout is months behind schedule and Alphabet shares fell about 4% that day; on August 7, 2026 SemiAnalysis reported it had been silently cancelled in favor of Gemini 4; Google has not confirmed this and its public materials still describe Pro as in partner testing, not cancelled.

### When will Gemini 3.5 Pro come out?
Google originally pointed to June 2026, then reporting pointed to a July 17, 2026 target. That date has now passed with no release. On July 16, 2026, Bloomberg reported Pro is months behind schedule, tied to coding performance that fell short of Google's internal bar, with no new date given. Earlier reporting also said Google rebuilt Pro from a new base model rather than the earlier 2.5 Pro one. An August 7, 2026 SemiAnalysis report claims the model was cancelled outright in favor of Gemini 4; Google has not confirmed a cancellation. Expect a limited preview first if it does ship, not an immediate global launch.
