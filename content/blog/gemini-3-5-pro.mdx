...
Gemini 3.5 Pro is the Google model everyone is waiting for and almost no one can use. As of July 17, 2026 it still has not shipped, Google has published no specs for it, and most of what you will read about its context window, pricing, reasoning, and release date is rumor formatted to look official.
...
No. As of July 17, 2026, Gemini 3.5 Pro is still not generally available, and most of what you can read about its specs is guesswork. (Last verified July 17, 2026. When the rollout completes, the API model-list status line covered below is the fastest way to check.)
...
<figure className="not-prose my-8">
  ...
  <figcaption className="mt-3 text-center text-sm text-gray-500">Where each Gemini 3.5 model stands as of July 17, 2026: Flash shipped, Pro delayed and still internal-only.</figcaption>
</figure>
