...
<tr><td><strong>Clip length</strong></td><td>3 to 10 seconds at 720p. Longer durations were announced as coming; still unavailable as of July 19, 2026</td></tr>
...
Not as of July 19, 2026. Clips run 3 to 10 seconds at 720p and 24fps. Google announced longer durations as coming and described the 10-second cap as a rollout decision rather than a model limit, but nothing longer has shipped.

### Is Gemini Omni available on Vertex AI?
Yes, though the name is the problem. Google renamed Vertex AI to the Gemini Enterprise Agent Platform in April 2026, so searching for "Vertex AI Omni" turns up nothing useful. The model is documented there as `gemini-omni-flash-preview`, at preview stage.
