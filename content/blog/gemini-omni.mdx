...
<figure>
  <BlogImage src="/blog/gemini-omni/gemini-omni-inputs-outputs-access-diagram.png" alt="How Gemini Omni Flash works: mixed inputs, one model, a 10-second video, and five access surfaces." w="1040" h="614" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
