...
<figure className="not-prose my-8">
  <Image src="/blog/best-content-optimization-tools/content-score-is-not-a-citation.png" alt="A 94/100 content-optimizer score next to an AI answer that cites other sources instead." width={2400} height={1320} sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
...
<figure className="not-prose my-8">
  <Image src="/blog/best-content-optimization-tools/how-we-judged-tools.png" alt="Five numbered criteria cards describing how the content optimization tools were judged." width={2200} height={1017} sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto" />
...
<figure className="not-prose my-8">
  <Image src="/blog/best-content-optimization-tools/tools-at-a-glance.png" alt="A comparison table of seven content optimization tools with best-for, price, and AI-citation tracking." width={2200} height={1629} sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto" />
