...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>Fast mode</strong></td><td>$30 / $150 per million tokens (in, out)</td><td>Research preview, consumption plans</td></tr>
  </tbody>
</table>
...
- [Claude Code overview](https://code.claude.com/docs/en/overview) (Anthropic, Claude Code Docs)
- [Set up Claude Code](https://code.claude.com/docs/en/setup) (Anthropic, Claude Code Docs)
- [How Claude Code works](https://code.claude.com/docs/en/how-claude-code-works) (Anthropic, Claude Code Docs)
- [Manage costs effectively](https://code.claude.com/docs/en/costs) (Anthropic, Claude Code Docs)
- [Data usage](https://code.claude.com/docs/en/data-usage) (Anthropic, Claude Code Docs)
- [Usage limit best practices](https://support.claude.com/en/articles/9797557-usage-limit-best-practices) (Anthropic, Claude Support)
- [Claude Code product page](https://claude.com/product/claude-code) (Anthropic)
- [anthropics/claude-code](https://github.com/anthropics/claude-code) (Anthropic, GitHub)
- [Claude Code [Beta] plugin listing](https://plugins.jetbrains.com/plugin/27310-claude-code-beta-) (Anthropic, via JetBrains Marketplace)
- [AI tooling in 2026](https://newsletter.pragmaticengineer.com/p/ai-tooling-2026) (Gergely Orosz and Elin Nilsson, The Pragmatic Engineer, March 2026)
- [Claude Usage Limits Discussion Megathread](https://www.reddit.com/r/ClaudeAI/comments/1s7fcjf/claude_usage_limits_discussion_megathread_ongoing/) (r/ClaudeAI)
- [Claude Code sends 33k tokens before reading the prompt; OpenCode sends 7k](https://news.ycombinator.com/item?id=48883275) (Hacker News, July 2026)
