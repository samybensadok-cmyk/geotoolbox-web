...
The practical shape of it: you open a terminal in a project, type `claude`, and describe what you want in a sentence. It explores the codebase itself rather than waiting for you to paste the relevant files in. For a working definition of the broader category, our [AI agent](https://geotoolbox.ai/blog/agentic-ai) guide covers the general pattern; Claude Code is one of the more literal implementations of it.
...
The cost is that everything it reads occupies the same budget. Your instructions, the files it opened, every command's output, and the entire conversation share one [context window](https://geotoolbox.ai/blog/how-does-ai-search-work), and it fills faster than most people expect. We covered the mechanics of that in detail in our guide to the [Claude Code context window](https://geotoolbox.ai/blog/claude-code-context-window), including how to read the meter before output quality starts degrading.
