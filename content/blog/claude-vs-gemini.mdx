...
date: "2026-07-05"
updated: "2026-09-05"
recheckBy: "2026-10-06"  # backfilled 2026-09-05 freshness audit (no prior guard); flagship-comparison table. Re-verify: Anthropic top tier (Fable 5.1 since 2026-09-01) and whether Gemini 3.5 Pro has finally shipped (still partner-testing at 2026-09-05, no API model ID)
...
<tr><td><strong>Top models (September 2026)</strong></td><td>Opus 5, Sonnet 5, and the higher-tier Fable 5.1 (Fable 5 and Opus 4.8 now legacy)</td><td>Gemini 3.1 Pro (still in preview) and 3.8 Flash (September 2, 2026), with Gemini 3.5 Pro still in partner testing (not yet released)</td></tr>
