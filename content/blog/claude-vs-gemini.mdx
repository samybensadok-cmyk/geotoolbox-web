...
<tr><td><strong>Top models (June 2026)</strong></td><td>Opus 4.8, Sonnet 5, and the newer Fable 5</td><td>Gemini 3.1 Pro and 3.5 Flash, with Gemini 3.5 Pro rolling out</td></tr>
...
<tr><td><strong>Context window</strong></td><td>Up to <a href="https://platform.claude.com/docs/en/about-claude/models/overview">1M tokens on Opus 4.8 and Sonnet 5</a> (API); the consumer app exposes less</td><td>1M tokens on Gemini 3.1 Pro; <a href="https://geotoolbox.ai/blog/gemini-3-5-pro">Gemini 3.5 Pro</a> is rumored at 2M (no official spec yet)</td></tr>
