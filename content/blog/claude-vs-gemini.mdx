...
<tr><td><strong>Context window</strong></td><td>Up to <a href="https://platform.claude.com/docs/en/about-claude/models/overview">1M tokens on Opus 4.8 and Sonnet 4.6</a> (API); the consumer app exposes less</td><td>1M tokens on Gemini 3.1 Pro; Gemini 3.5 Pro targets 2M</td></tr>
