...
<tr><td><strong>Top models (July 2026)</strong></td><td>Opus 5, Sonnet 5, and the higher-tier Fable 5 (Opus 4.8 now legacy)</td><td>Gemini 3.1 Pro (still in preview) and 3.6 Flash, with Gemini 3.5 Pro still in partner testing (not yet released)</td></tr>
