...
<tr><td><strong>Top models (July 2026)</strong></td><td>Opus 4.8, Sonnet 5, and the newer Fable 5</td><td>Gemini 3.1 Pro (still in preview) and 3.6 Flash, with Gemini 3.5 Pro rolling out</td></tr>
...
**This is where the two pull furthest apart.** A model only knows the world up to its training cutoff. As of July 2026 that is around January 2026 for Claude Opus 4.8, per Anthropic's docs. Anything newer, including most recent facts about your company, reaches the model only at query time through live web search, the context you paste in, or files you upload.
...
At the consumer level they are close, both around $20 a month for the main paid plan, with Gemini offering a cheaper entry tier around $5. At the API it depends on the pair: Gemini 3.1 Pro ($2/$12 per million tokens) undercuts Claude's Opus 4.8 ($5/$25), but Claude's Haiku 4.5 ($1/$5) undercuts Gemini's 3.6 Flash ($1.50/$7.50) on both input and output. Claude's tighter usage limits also cut heavy sessions off sooner. Which one bills less at volume depends on which models you actually run, not on the logo.
