...
<figure className="not-prose my-8">
  <BlogImage src="/blog/entity-seo/brand-entity-knowledge-graph.png" alt="Brand entity node linked to its category, location, and sameAs profiles as triples." w="1100" h="702" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">How an engine stores your brand: one entity node, with facts attached as triples it corroborates across the web.</figcaption>
</figure>
...
Entity SEO does not replace keyword work. It sits underneath it. The clearer your entity, the more of your keyword and content effort actually lands, because the engine knows which brand to credit. It is one half of [semantic SEO](https://geotoolbox.ai/blog/semantic-seo), the same instinct behind [generative engine optimization](https://geotoolbox.ai/blog/what-is-geo), applied to the question of identity.

## The Knowledge Graph: How Google (and AI) Build a Model of Your Brand

The [knowledge graph](https://geotoolbox.ai/glossary/knowledge-graph) is where engines store what they know about entities and how those entities connect. Google launched its version in 2012 with a post literally titled ["things, not strings,"](https://blog.google/products/search/introducing-knowledge-graph-things-not/) describing a starting set of about 500 million objects and 3.5 billion facts. By Google's last public figure, [from May 2020](https://blog.google/products-and-platforms/products/search/about-knowledge-graph-and-knowledge-panels/), that had grown to over 500 billion facts about five billion entities. The graph is also actively pruned, not just grown: in June 2025, Kalicube's long-running tracker [recorded Google deleting more than 3 billion entities](https://searchengineland.com/google-great-clarity-cleanup-knowledge-graph-ai-future-460836) in a single week, a 6.26 percent contraction by its count, which implies the graph had grown to roughly ten times Google's 2020 entity figure before the cull. Kalicube, writing in Search Engine Land, read the cleanup as Google trading raw volume for entity clarity in the dataset that feeds its AI features.
...
Recognition is the start; authority is what makes an engine trust you on a subject, the [E-E-A-T signals that decide AI citation](https://geotoolbox.ai/blog/eeat-ai-search). You build it by surrounding your entity with content that proves depth on the topics you want to be known for, and by linking that content so the relationships are obvious.

Think in clusters, not isolated pages. A pillar page defines your core topic, and supporting pages cover the sub-questions around it, each linked back to the pillar and to each other. That internal linking does two jobs: it passes relevance between related pages, and it tells the engine these pieces belong to the same entity and topic. A scattered set of unconnected posts reads as noise; a connected cluster reads as expertise, which is exactly how [topical authority](https://geotoolbox.ai/blog/topical-authority) gets built.
...
The cheapest first move is also the easiest to skip: confirm the engines can actually reach and read you, and check whether they describe you correctly today. Geotoolbox's free [AI-Readiness Score](https://geotoolbox.ai/tools/ai-readiness) checks the crawler-access foundations on your entity home, and the [Content Analyzer](https://geotoolbox.ai/features/content-analyzer) grades how citable the page itself is: answer structure, sourced facts, and whether AI crawlers can read it. Start there, fix what it flags, then work down the list.
...
- Introducing the Knowledge Graph: things, not strings - Google, 2012 - `blog.google/products/search/introducing-knowledge-graph-things-not`
- A reintroduction to Google's Knowledge Graph and knowledge panels - Google, May 2020 (500B facts / 5B entities figure) - `blog.google/products-and-platforms/products/search/about-knowledge-graph-and-knowledge-panels`
- Google's great clarity cleanup: 3 shifts redefining the Knowledge Graph and its AI future - Search Engine Land / Kalicube, August 2025 - `searchengineland.com/google-great-clarity-cleanup-knowledge-graph-ai-future-460836`
- We Tracked 1,885 Pages Adding Schema. AI Citations Barely Moved. - Ahrefs, May 2026 - `ahrefs.com/blog/schema-ai-citations`
- Microsoft: Bing/Copilot use schema for its LLMs - Search Engine Land, March 2025 - `searchengineland.com/microsoft-bing-copilot-use-schema-for-its-llms-453455`
- AI features and your website - Google Search Central - `developers.google.com/search/docs/appearance/ai-features`
- sameAs property - Schema.org - `schema.org/sameAs`
- Wikidata:Notability - Wikidata - `wikidata.org/wiki/Wikidata:Notability`
- Get a knowledge panel for your entity - Google Knowledge Panel Help - `support.google.com/knowledgepanel/answer/9163198`
- Knowledge Vault - Dong et al., KDD 2014 - `cs.ubc.ca/~murphyk/Papers/kv-kdd14.pdf`
- Question answering using entity references (US9477759B2) - Google LLC patent (entity definition) - `patents.google.com/patent/US9477759B2`
