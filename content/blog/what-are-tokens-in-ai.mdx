...
The earliest one is access. If an AI crawler cannot reach your page, none of this token machinery ever runs on it, because the page never enters the budget. That gate you can actually test: our free [AI Readiness check](https://geotoolbox.ai/tools/ai-readiness) shows whether the crawlers behind ChatGPT, Perplexity, and Google's AI features can reach a page, and what is blocking them when they cannot. Tokens tell you how the machine reads. Reachability tells you whether it reads you at all.
...
- [OpenAI Tokenizer (interactive tool)](https://platform.openai.com/tokenizer) and [tiktoken (library)](https://github.com/openai/tiktoken)
...
- [Dataconomy: GPT-5.2 still counts two R's in strawberry](https://dataconomy.com/2025/12/15/gpt-5-2-still-counts-two-rs-in-strawberry/)
- [Google Search Central: Guidance on AI features and generative AI](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide)
- [Pivot Point Security: AI tokens and how they impact usage costs](https://www.pivotpointsecurity.com/ai-tokens-how-they-impact-usage-costs/)
- [Artificial Analysis: AI model comparison, including context windows (2026)](https://artificialanalysis.ai/models)
