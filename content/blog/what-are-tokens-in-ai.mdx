...
What is real sits one layer up. AI search shortlists content by meaning, comparing the embeddings of your passages against a query using [semantic search](https://geotoolbox.ai/blog/how-does-ai-search-work). Passages that are clear and self-contained tend to retrieve better. But that is just good writing. It is the same advice that worked before anyone said the word token, and it has a mechanism behind it, not a trick.
