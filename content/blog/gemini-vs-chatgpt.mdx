...
date: "2026-06-25"
updated: "2026-08-18"
recheckBy: "2026-09-24"  # Gemini 3.7 Flash added 08-18 (shipped 08-13, ai.google.dev + blog.google confirmed live in Gemini Spark; not confirmed as API/free-tier default yet, so only the "newest" framing was updated, not the free-tier model claim)
...
<tr><td><strong>Current flagship</strong></td><td>GPT-5.6 (Sol / Terra / Luna)</td><td>Gemini 3.1 Pro (preview); Gemini 3.7 Flash (newest, Aug 13); 3.5 Pro not yet shipped</td></tr>
