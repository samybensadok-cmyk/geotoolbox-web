...
<figure className="not-prose my-8">
  <BlogImage src="/blog/gemini-vs-chatgpt/gemini-vs-chatgpt-by-category.png" alt="A category-by-category scorecard of ChatGPT versus Gemini for July 2026." w="2400" h="1773" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
...
<tr><td><strong>Current flagship</strong></td><td>GPT-5.6 (Sol / Terra / Luna)</td><td>Gemini 3.1 Pro; Gemini 3.5 Flash (newest); 3.5 Pro in preview</td></tr>
<tr><td><strong>Free model</strong></td><td>GPT-5.6 Terra (limited)</td><td>Gemini 3.5 Flash</td></tr>
...
<tbody>
<tr><td><strong>Free</strong></td><td>$0 - GPT-5.6 Terra, limited</td><td>$0 - Gemini 3.5 Flash, ~1M context</td></tr>
...
For most people, yes. Gemini's free tier runs on Gemini 3.5 Flash with a roughly 1-million-token context, while ChatGPT's free tier uses GPT-5.6 Terra with tighter message caps and a much smaller context. If you need a capable assistant without paying, Gemini's free plan is the more generous of the two.
