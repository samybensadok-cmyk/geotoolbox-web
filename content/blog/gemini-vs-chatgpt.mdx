...
<figure className="not-prose my-8">
  <Image src="/blog/gemini-vs-chatgpt/gemini-vs-chatgpt-by-category.png" alt="A category-by-category scorecard of ChatGPT versus Gemini for June 2026." width={2400} height={1773} sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
...
<figure className="not-prose my-8">
  <Image src="/blog/gemini-vs-chatgpt/chatgpt-gemini-context-window.png" alt="Two horizontal bars comparing ChatGPT and Gemini context windows on a shared 0-to-1M-token scale." width={2200} height={1019} sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto" />
...
<figure className="not-prose my-8">
  <Image src="/blog/gemini-vs-chatgpt/which-engine-cites-you.png" alt="An illustrative grid showing which engine cites your brand across different prompt types." width={2200} height={1293} sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto" />
