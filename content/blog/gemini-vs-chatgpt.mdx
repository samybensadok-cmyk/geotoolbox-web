...
<tr><td><strong>Current flagship</strong></td><td>GPT-6 Astra (Sept 3, 2026), with GPT-5.6 (Sol / Terra / Luna) below it</td><td>Gemini 3.1 Pro (preview); Gemini 3.8 Flash (newest, Sept 2); 3.5 Pro not yet shipped</td></tr>
<tr><td><strong>Free model</strong></td><td>GPT-5.6 Luna (rolling out; Instant still GPT-5.5)</td><td>Gemini 3.6 Flash</td></tr>
