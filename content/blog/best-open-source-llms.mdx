...
date: "2026-07-22"
recheckBy: "2026-07-27"  # Kimi K3 weights land July 27; the K3 entry, FAQ answer, and glance table flip from scheduled to live that day
...
For the full breakdown of what each label legally means, see our guide to [open weights vs open source](https://geotoolbox.ai/blog/open-weights-vs-open-source). The practical takeaway for this article: every model ranked below either has downloadable <a href="https://geotoolbox.ai/glossary/open-weights">open weights</a> today or, in K3's single case, has them scheduled for July 27, and we flag the license catch on each one.
