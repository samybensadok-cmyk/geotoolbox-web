...
date: "2026-07-22"
updated: "2026-08-01"
recheckBy: "2026-08-31"  # Kimi K3 weights went public 2026-07-27 (tense flipped); full K3 ranking/benchmark re-check still pending
...
The short answer: **GLM-5.2** is the best open-source LLM you can download and run today, **DeepSeek V4** is the best value, and **Kimi K3** is the new frontier flagship, its launch benchmarks already ahead of the open field, with downloadable weights public since July 27, 2026. Expect the #1 slot to stay contested now that they have landed. Which one you should use depends on the job, the license terms you can live with, and the hardware you have.
...
<tr><td><strong>Kimi K2.6 / K3</strong></td><td>Moonshot AI</td><td>1T / 32B and 2.8T (K3)</td><td>256K / 1M</td><td>Modified MIT (K2.6); K3 TBD Jul 27</td><td>Agent swarms, frontier scale</td></tr>
...
<tr><td>Frontier scale, newest weights</td><td><strong>Kimi K3</strong> (from July 27)</td><td>2.8T parameters, launch benchmarks near the proprietary top</td></tr>
