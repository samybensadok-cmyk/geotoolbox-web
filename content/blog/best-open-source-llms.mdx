...
description: "The best open source LLMs of $MONTH_YEAR, ranked: GLM-5.2, DeepSeek V4, Kimi K3 and more, with licenses, real hardware needs, and every claim dated and verified."
date: "2026-07-22"
updated: "2026-08-08"
recheckBy: "2026-08-14"  # Qwen3.8-Max GA 2026-08-03 (closed Max API line, $2/$6); open weights committed week of 2026-08-10; none on huggingface.co/Qwen as of 2026-08-08, no license named. K3 re-check 2026-08-01: top open-weight on AA Intelligence Index (57 vs GLM-5.2 51, DeepSeek V4 Pro 44); weights public 2026-07-27; custom Kimi K3 License
...
*Qwen's naming runs two tracks (open-weight releases and the closed Max API line), which is itself a recurring source of listicle confusion. Case in point: the 2.4T Qwen3.8-Max shipped August 3, 2026 as the closed Max API line, with open weights committed for the week of August 10 but not yet delivered, so it does not yet belong in an open-weight ranking.
