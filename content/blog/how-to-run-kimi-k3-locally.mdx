...
<tbody>
<tr><td><strong>5. Use a provider</strong></td><td>Nothing, an API key</td><td>~32-165 tok/s, provider-dependent</td><td>$3 in / $15 out per M tokens</td><td>Almost everyone</td></tr>
