...
<tr><td>Amazon</td><td>Rufus</td><td>Sales &amp; commerce</td><td>Compares products, answers questions, and can auto-add items to your cart</td></tr>
...
**Salesforce's Agentforce SDR** reads inbound leads, checks them against CRM history, answers product questions, and books a meeting on a human rep's calendar - the sales-development job that used to require a person reading every form submission. **[Amazon's Rufus](https://www.aboutamazon.com/news/retail/amazon-rufus-ai-assistant-personalized-shopping-features)** does the shopping-side equivalent and goes a step further: beyond comparing products and answering questions inside the Amazon app, it can automatically add items to your cart, for a curated list or a reorder, for you to review before checkout.
