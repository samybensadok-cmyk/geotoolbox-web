...
Among the tools reviewers price publicly, Otterly's reported $29 a month is the lowest figure for serious mention monitoring. If you want Profound Growth's engine coverage rather than its price, geotoolbox's $99 Starter (disclosure: ours) tracks the same three engines Growth sells for $399. Cheapest is not automatically right, though: the better question is which job you are hiring the tool for, which is how our Profound alternatives guide organizes the field.
