...
date: "2026-08-30"
updated: "2026-09-25"
recheckBy: "2026-10-25"  # GPT-6 Sol/Luna + Claude Opus 5.5 rows added 25 Sep 2026; GPT-5.6 Sol promo runs to Nov 21 2026; DeepSeek peak/off-peak re-check. Price-dense page: re-verify every row monthly.
...
Here is the current rate card. Every figure is per million tokens, standard tier, checked against the provider's own page. The OpenAI row was updated 25 September 2026 for the GPT-6 Sol and GPT-6 Luna launch (Work, Codex, and the API); the Anthropic Opus row was updated the same day for Claude Opus 5.5. The rest of OpenAI and Anthropic were re-verified on 5 September 2026 after the GPT-6 Astra and Claude Fable 5.1 launches; the xAI and DeepSeek rows were re-verified on 26 September 2026 (Grok 4.7 and DeepSeek V4.1 Flash); the remaining vendors were checked on 30 August 2026.
...
<tbody>
<tr><td><strong><a href="https://geotoolbox.ai/blog/gpt-6-astra">OpenAI GPT-6 Astra</a></strong></td><td>$10.00</td><td>$50.00</td><td>1.05M</td></tr>
<tr><td><strong>OpenAI GPT-6 Sol</strong> (Work/Codex/API)</td><td>$2.00</td><td>$10.00</td><td>1.05M</td></tr>
<tr><td><strong>OpenAI GPT-6 Luna</strong> (Work/Codex/API)</td><td>$0.10</td><td>$0.50</td><td>1.05M</td></tr>
<tr><td><strong>OpenAI GPT-5.6 Sol</strong> (in standard Chat)</td><td>$4.00</td><td>$20.00</td><td>1.05M</td></tr>
<tr><td><strong>OpenAI GPT-5.6 Terra</strong></td><td>$2.00</td><td>$12.00</td><td>1.05M</td></tr>
<tr><td><strong>OpenAI GPT-5.6 Luna</strong> (in standard Chat)</td><td>$0.20</td><td>$1.20</td><td>1.05M</td></tr>
<tr><td><strong><a href="https://geotoolbox.ai/blog/claude-fable-5-1">Anthropic Claude Fable 5.1</a></strong></td><td>$10.00</td><td>$50.00</td><td>1M</td></tr>
<tr><td><strong>Anthropic Claude Opus 5.5</strong></td><td>$4.00</td><td>$20.00</td><td>1M</td></tr>
...
<tr><td><strong>xAI Grok 4.7</strong></td><td>$2.00</td><td>$6.00</td><td>500K</td></tr>
<tr><td><strong>DeepSeek V4 Pro</strong></td><td>$0.66</td><td>$1.98</td><td>1M</td></tr>
<tr><td><strong>DeepSeek V4.1 Flash</strong></td><td>$0.15</td><td>$0.60</td><td>1M</td></tr>
...
A pair of numbers anchors the table. The floor is OpenAI's GPT-6 Luna, Z.ai GLM-5.3 Flash and DeepSeek V4.1 Flash, from about $0.50 to $0.60 per million on output. The ceiling is the two September 2026 frontier models, [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra) and [Claude Fable 5.1](https://geotoolbox.ai/blog/claude-fable-5-1), both at $50 on output. [Claude Opus 5.5](https://geotoolbox.ai/blog/claude-pricing) and GPT-5.6 Sol, both at $20, now sit a tier below.

That gap, from $0.50 to $50 on output alone, is a hundred to one. It makes **model choice usually the biggest single lever on an AI budget**, ahead of the optimizations below.

A few rows carry an asterisk that the table cannot show. DeepSeek's figures are its off-peak rate; for several hours a day they double. GPT-5.6 Sol's $4 and $20 are a promotional cut, not the standing price. Anthropic's Sonnet 5 at $2 was almost $3. Those moving parts are the reason a flat table is never the whole answer, and we come back to them below. (Alibaba's Qwen3.8-Max is reportedly close to Grok 4.7's tier but is left off the table because we could not verify its dollar rate on an English vendor page.)

<figure className="not-prose my-8">
  <BlogImage src="/blog/ai-token-cost/output-cost-per-1m.png" alt="Horizontal bar chart, drawn to scale, of API output price per million tokens as of 30 August 2026, from cheapest to priciest: GLM-5.3 Flash $0.50, DeepSeek V4 Flash $0.66, Mistral Large 3 $1.50, Gemini 2.5 Flash $2.50, Grok 4.6 $6, Gemini 3.1 Pro $12, Kimi K3 $15, GPT-5.6 Sol $20 on its promotional rate, and Claude Opus 5 $25." w="2188" h="1520" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Output tokens per 1M, to scale. GLM-5.3 Flash is shown at list price, DeepSeek at its off-peak rate (it doubles during peak hours), and GPT-5.6 Sol at its promotional rate (guaranteed through 21 November 2026). The chart reflects the 30 August rate card, so the two $50 models released in early September, GPT-6 Astra and Claude Fable 5.1, are not shown. It also predates Claude Opus 5.5 ($20 output, which replaced Opus 5's $25 on 22 September) and GPT-6 Luna ($0.50 output, level with the cheapest bar), and DeepSeek's V4 Flash bar is now V4.1 Flash at $0.60, since the 10 September swap.</figcaption>
</figure>

## Why Output Tokens Cost More Than Input

Output runs several times the input rate on almost every model. Look down the table: Sonnet 5 is $2 in and $10 out, Gemini 3.1 Pro is $2 in and $12 out, Opus 5.5 is $4 in and $20 out, and [Grok 4.7](https://geotoolbox.ai/blog/grok-pricing) is $2 in and $6 out. The gap is not arbitrary. Reading your prompt is one pass over a fixed block of text. Writing a reply means predicting each token one at a time, and every new token is another full run through the model.
...
OpenAI is the most-searched of these rate cards, so it deserves its own read. At the top sits [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra), released 3 September 2026 at $10 input and $50 output. That is exactly 2.5 times GPT-5.6 Sol in every cell of OpenAI's table, and prompts above 272,000 input tokens move to a long-context band at $20 and $75.

Below it sit two generations, all sharing a context window above a million tokens. Since 22 September 2026, GPT-6 Sol ($2 input, $10 output) and GPT-6 Luna ($0.10 and $0.50) run under Astra in ChatGPT Work, Codex and the API, and GPT-6 Luna is now the cheapest OpenAI model. The GPT-5.6 family, which standard ChatGPT chat still runs, splits into a working flagship, a mid, and a budget tier. GPT-5.6 Sol is the working tier at $4 input and $20 output. Terra sits in the middle at $2 and $12. GPT-5.6 Luna is the budget tier at $0.20 and $1.20.

The catch on GPT-5.6 Sol is that $4 and $20 is a **promotional rate**, cut from $5 and $30 in late August 2026. OpenAI has guaranteed the promo through 21 November 2026 and has not said what follows. Plan on it if you like, but know it can revert then. This is also why comparison pages disagree about OpenAI: many still quote the old $5 and $30, and some quote a batch rate as if it were standard. If a table shows GPT-5.6 Sol at $5/$30, it is reading an older week; $2/$10 is GPT-6 Sol, a different model.

A couple more OpenAI-specific rules move real bills. Very long prompts, past a few hundred thousand input tokens, bill the whole request at double the input rate and half again on output, so a single long-context call on GPT-5.6 Sol effectively costs $8 and $30 (and $4 and $15 on GPT-6 Sol). And a Batch API runs asynchronous work at a steep discount for results you can wait up to 24 hours to get back. For the consumer side, the ChatGPT subscriptions and their limits, see our [ChatGPT pricing](https://geotoolbox.ai/blog/chatgpt-pricing) breakdown; this section is the developer API only.
...
<tbody>
<tr><td><strong>High-volume chat, classification, extraction</strong></td><td>GPT-6 Luna, DeepSeek V4.1 Flash, Gemini 2.5 Flash, GLM-5.3 Flash</td><td>Output from $0.50 to $2.50 per 1M; quality is enough for structured, repetitive work</td></tr>
...
<tbody>
<tr><td><strong>GPT-6 Astra</strong></td><td>$6,900</td></tr>
<tr><td><strong>GPT-5.6 Sol</strong> (promo)</td><td>$2,760</td></tr>
<tr><td><strong>GPT-6 Sol</strong></td><td>$1,380</td></tr>
...
<tr><td><strong>DeepSeek V4.1 Flash</strong></td><td>$90</td></tr>
<tr><td><strong>GPT-6 Luna</strong></td><td>$69</td></tr>
</tbody>
</table>

Same traffic, a spread of a hundred times, decided entirely by which model answers. That is the case for routing: send the bulk of that volume to the bottom of the table and reserve Astra, Sol or Opus for the requests that genuinely need them. A couple more habits keep the estimate honest. Add a comfortable buffer for context growth and retries, and re-run the math after every price change, because the cheapest row moves. This math covers text generation only: embeddings for a retrieval index, fine-tuning, and image or audio tokens bill separately, though for most text apps generation is the dominant cost.
...
Tokens are priced per million, not one at a time, and split into input and output. As of September 2026, output ranges from about $0.50 per million on GPT-6 Luna and GLM-5.3 Flash to $50 on the two frontier models, GPT-6 Astra and Claude Fable 5.1, with input several times cheaper. A single token is a fraction of a cent; the bill comes from volume.

### Which AI API is the cheapest?

For raw price, a cluster of budget models sits at the bottom: OpenAI's GPT-6 Luna, GLM-5.3 Flash, DeepSeek V4.1 Flash, and Mistral Large 3, with Google Gemini 2.5 Flash close behind. But cheapest per token is not cheapest per task: a budget model that needs retries or cleanup can cost more than a mid-tier model that answers once. Match the model to the job rather than defaulting to the lowest rate.
...
- GPT-6 Astra, GPT-6 Sol/Luna and GPT-5.6 API pricing - OpenAI, verified 25 September 2026 - `developers.openai.com/api/docs/pricing`
- Introducing Claude Opus 5.5 ($4/$20 per MTok) - Anthropic, 22 September 2026 - `anthropic.com/news/claude-opus-5-5`
- Claude models and pricing (Fable 5.1 at $10/$50, 1M context) - Anthropic, verified 5 September 2026 - `platform.claude.com/docs/en/about-claude/models/overview`
