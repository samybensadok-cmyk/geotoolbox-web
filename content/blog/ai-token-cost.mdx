...
Here is the current rate card. Every figure is per million tokens, standard tier, checked against the provider's own page. The OpenAI and Anthropic rows were re-verified on 5 September 2026 after the GPT-6 Astra and Claude Fable 5.1 launches; the rest were checked on 30 August 2026.
...
A pair of numbers anchors the table. The floor is Z.ai GLM-5.3 Flash and DeepSeek V4 Flash, from about $0.50 to $0.66 per million on output. The ceiling is the two September 2026 frontier models, [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra) and [Claude Fable 5.1](https://geotoolbox.ai/blog/claude-fable-5-1), both at $50 on output. [Claude Opus 5](https://geotoolbox.ai/blog/claude-pricing) at $25 and GPT-5.6 Sol at $20 now sit a tier below.
...
Below it, the GPT-5.6 family splits into a working flagship, a mid, and a budget tier, all sharing a context window above a million tokens. Sol is the working tier under Astra at $4 input and $20 output. Terra sits in the middle at $2 and $12. Luna is the budget tier at $0.20 and $1.20, which undercuts almost everything except DeepSeek.
...
Tokens are priced per million, not one at a time, and split into input and output. As of September 2026, output ranges from about $0.50 per million on GLM-5.3 Flash to $50 on the two frontier models, GPT-6 Astra and Claude Fable 5.1, with input several times cheaper. A single token is a fraction of a cent; the bill comes from volume.
...
- GPT-6 Astra and GPT-5.6 API pricing - OpenAI, verified 5 September 2026 - `developers.openai.com/api/docs/pricing`
