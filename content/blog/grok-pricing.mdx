...
date: "2026-06-27"
updated: "2026-09-19"
recheckBy: "2026-10-19"  # generic 30-day pricing/ranking volatility check
...
The new flagship is [grok-4.6](https://geotoolbox.ai/blog/grok-4-6), released August 12, 2026 at the same $2 input and $6 output per million tokens and 500K-token context window as grok-4.5 before it. Watch the context tier, because the headline price is only half the story: xAI's docs list grok-4.6 at $2 input / $6 output for prompts **under 200K tokens**, and **$4 / $12 above that**, with cached input at $0.50 (rising to $1 above 200K). Since the model's selling point is a 500K window, any prompt that actually uses it bills at the higher rate. That is pricier than the outgoing grok-4.3 ($1.25/$2.50, also doubling above 200K), but still under rivals like Claude Opus 5 ($5/$25) and GPT-5.6 Sol ($4/$20 since OpenAI's August 21, 2026 cut, and promotional only through November 21) — though at that long-context tier its $4 input now merely ties Sol's rather than undercutting it. grok-4.3 remains the value option, and at $1.25 input and $2.50 output it undercuts the comparable frontier models from OpenAI and Anthropic, whose top tiers run several times higher. That price-per-intelligence is xAI's main pitch to developers right now.
...
<tbody>
<tr><td><strong>xAI Grok</strong></td><td>SuperGrok $30</td><td>grok-4.6, $2.00 / $6.00 (grok-4.3, $1.25 / $2.50)</td></tr>
<tr><td><strong>OpenAI ChatGPT</strong></td><td>ChatGPT Plus about $20</td><td>GPT-5.6 Sol, about $4.00 / $20.00 (promotional to Nov 21, 2026)</td></tr>
<tr><td><strong>Anthropic Claude</strong></td><td><a href="https://geotoolbox.ai/blog/claude-pricing">Claude Pro</a> about $20</td><td>Claude Opus 5, about $5.00 / $25.00</td></tr>
...
It depends on the tier. SuperGrok Lite at $10 undercuts ChatGPT Plus, but the mainstream SuperGrok tier at $30 costs more than Plus at about $20. On the API it is clearer: grok-4.3 at $1.25 and $2.50 per million tokens is cheaper than [GPT-5.6 Sol](https://developers.openai.com/api/docs/pricing), which runs about $4 and $20 on the promotional rate OpenAI set on August 21, 2026 and has committed to only through November 21.
