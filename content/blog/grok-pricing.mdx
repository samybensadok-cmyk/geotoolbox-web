---
title: "Grok Pricing in $YEAR: Plans, Free Tier, and Is It Worth It?"
description: "Grok pricing explained, current to $UPDATED_MONTH_YEAR: the free tier, SuperGrok ($10/$30/$100), Heavy, X Premium vs standalone, API token costs, and how to use Grok."
date: "2026-06-27"
updated: "2026-09-25"
recheckBy: "2026-10-19"  # updated 2026-09-25: xAI flagship is now grok-4.7 (Sep 21, same $2/$6 price); Claude comparator now Opus 5.5 ($4/$20); generic 30-day pricing/ranking volatility check
author: "Samy BEN SADOK"
tags: ["grok-pricing", "grok", "supergrok", "xai", "pricing", "ai-pricing"]
draft: false
---

Grok is free to start, and for a lot of people that is the end of the story. If you want more, the standalone paid plans run $10 a month for SuperGrok Lite, $30 for SuperGrok, $100 for SuperGrok Plus, and $300 for SuperGrok Heavy, though Heavy is discounted to $99 a month for three months as of this writing. There are also team plans at $30 per seat, and a developer API billed per token from about $1 per million.
...
Here is the whole lineup in one place, at US prices as of September 2026.
...
<tr><td><strong>SuperGrok Plus</strong></td><td>$100</td><td>Everything in SuperGrok, plus 1080p video, much higher usage, priority access</td><td>Heavy Imagine/Voice/Build users who do not need multi-agent mode</td></tr>
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/grok-pricing/grok-plans-june-2026.png" alt="Grok's official plans page showing SuperGrok Lite at $10, SuperGrok with a 7-day free trial then $30, and SuperGrok Heavy at $99 for three months then $300, in June 2026 (SuperGrok Plus launched afterward and is not shown here)." w="1280" h="720" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Grok's standalone plans on grok.com, June 2026, including the live SuperGrok Heavy promo. SuperGrok Plus launched after this capture; see the table above for the current lineup.</figcaption>
</figure>
...
## SuperGrok vs SuperGrok Lite vs SuperGrok Plus vs SuperGrok Heavy

The standalone subscriptions all carry the SuperGrok name, and the differences between them are mostly about usage limits and how many agents you can run, not four completely different products. Here is what each one is for, with prices from [Grok's plans page](https://grok.com/plans).
...
### SuperGrok Plus ($100 a Month)

Sits between SuperGrok and SuperGrok Heavy. It adds 1080p video generation in Grok Imagine (up from SuperGrok's standard resolution), significantly higher usage across Chat, Imagine, Voice, and Build, faster replies, and priority access at peak times, but not Heavy's multi-agent mode. It fits someone who creates a lot of video or hits SuperGrok's usage caps regularly but does not need Heavy's parallel-agent research workflow.
...
<tr><td>1080p video, higher limits, no multi-agent</td><td>SuperGrok Plus</td><td>$100</td></tr>
...
The current flagship is **grok-4.7**, released September 21, 2026, at the same $2 input and $6 output per million tokens and 500K-token context window as [grok-4.6](https://geotoolbox.ai/blog/grok-4-6) (August 12, 2026) before it. Watch the context tier, because the headline price is only half the story: xAI's docs list grok-4.7 at $2 input / $6 output for prompts **under 200K tokens**, and **$4 / $12 above that**, with cached input at $0.50 (rising to $1 above 200K). Since the model's selling point is a 500K window, any prompt that actually uses it bills at the higher rate. xAI also serves a Grok 4.7 Fast variant with twice the output speed at twice the token rates, but only through Cursor and Grok Build, not as a public API model. grok-4.7 is pricier than the outgoing grok-4.3 ($1.25/$2.50, also doubling above 200K), but still under rivals like Claude Opus 5.5 ($4/$20) and the prior-generation GPT-5.6 Sol ($4/$20 since OpenAI's August 21, 2026 cut, and promotional only through November 21); at the long-context tier its $4 input ties both of them rather than undercutting either. OpenAI's newer GPT-6 Sol ($2/$10 since September 22, 2026) matches grok-4.7 on standard input and costs more on output. grok-4.3 remains the value option, and at $1.25 input and $2.50 output it undercuts the comparable frontier models from OpenAI and Anthropic, whose top tiers run several times higher. That price-per-intelligence is xAI's main pitch to developers right now.
...
<tbody>
<tr><td><strong>xAI Grok</strong></td><td>SuperGrok $30</td><td>grok-4.7, $2.00 / $6.00 (grok-4.3, $1.25 / $2.50)</td></tr>
<tr><td><strong>OpenAI ChatGPT</strong></td><td>ChatGPT Plus about $20</td><td>GPT-6 Astra, about $10.00 / $50.00 (GPT-6 Sol, $2.00 / $10.00)</td></tr>
<tr><td><strong>Anthropic Claude</strong></td><td><a href="https://geotoolbox.ai/blog/claude-pricing">Claude Pro</a> about $20</td><td>Claude Opus 5.5, about $4.00 / $20.00</td></tr>
...
**Pay $100 for SuperGrok Plus** if you create a lot of video with Grok Imagine and want 1080p output, or you regularly hit SuperGrok's usage caps, but you don't need Heavy's multi-agent mode.
...
Grok is free to start. Standalone paid plans are SuperGrok Lite at $10, SuperGrok at $30, SuperGrok Plus at $100, and SuperGrok Heavy at $300, currently discounted to $99 for the first three months. Team plans are $30 per seat, and the developer API is billed separately per token.
...
It depends on the tier. SuperGrok Lite at $10 undercuts ChatGPT Plus, but the mainstream SuperGrok tier at $30 costs more than Plus at about $20. On the API it is clearer: grok-4.3 at $1.25 and $2.50 per million tokens is cheaper than [GPT-5.6 Sol](https://developers.openai.com/api/docs/pricing), which runs about $4 and $20 on the promotional rate OpenAI set on August 21, 2026 and has committed to only through November 21, and cheaper than its successor GPT-6 Sol at $2 and $10 (since September 22, 2026).
...
- Grok plans and pricing - Grok (xAI) - `grok.com/plans`
- xAI API pricing - xAI Docs - `docs.x.ai/developers/pricing`
- New Grok Imagine limits spark user response - Calcalist - `calcalistech.com/ctechnews/article/rkbynj99bx`
...
- OpenAI API pricing (GPT-5.6 Sol) - OpenAI - `developers.openai.com/api/docs/pricing`
