...
It depends on the tier. SuperGrok Lite at $10 undercuts ChatGPT Plus, but the mainstream SuperGrok tier at $30 costs more than Plus at about $20. On the API it is clearer: grok-4.3 at $1.25 and $2.50 per million tokens is cheaper than [GPT-5.5](https://developers.openai.com/api/docs/pricing), which runs about $5 and $30.
...
- [OpenAI API pricing (GPT-5.5) - OpenAI](https://developers.openai.com/api/docs/pricing)
