---
title: "Gemini API Pricing in $YEAR: Every Model, Tier, and Hidden Cost"
description: "Gemini API pricing $YEAR: every model's token cost, the four service tiers, the free tier, Vertex vs Developer API, and the hidden costs that inflate your bill."
date: "2026-07-02"
recheckBy: "2026-12-01"  # Claude Sonnet 5 $2.00 input made permanent 2026-08-11 (planned $3.00 rise cancelled). 09-25: added GPT-6 Sol ($2/$10) + GPT-6 Luna ($0.10/$0.50), launched 2026-09-22 in Work/Codex/API, to the OpenAI comparison row (Astra unchanged, GPT-5.6 Sol/Luna unchanged and still what standard ChatGPT runs). 09-26 review fixes: Opus 5.5 ($4/$20) replaces Opus 5 in the Anthropic row; OpenAI's 272K long-context threshold distinguished from Gemini's 200K cliff.
updated: "2026-09-25"
...
<tr><td><strong>Gemini 3.5 Flash-Lite</strong></td><td>$0.30</td><td>$2.50</td><td>New budget tier, fastest in the 3.5 line (July 2026)</td></tr>
<tr><td><strong>Gemini 3.6 Flash</strong></td><td>$1.50</td><td>$7.50</td><td>New default workhorse, successor to 3.5 Flash (July 2026)</td></tr>
<tr><td><strong>Gemini 3.5 Flash</strong></td><td>$1.50</td><td>$9.00</td><td>Superseded by 3.6 Flash</td></tr>
...
One naming note, since older guides get it wrong. As of July 21, 2026, the current default workhorse is **Gemini 3.6 Flash** at $1.50 input and $7.50 output, the successor to 3.5 Flash (which stays live at the higher $9.00 output but is now superseded). Google also shipped **Gemini 3.5 Flash-Lite** at $0.30 / $2.50 as a newer budget tier. The rates come straight from [Google's Gemini API pricing page](https://ai.google.dev/gemini-api/docs/pricing), the source of record, which changes often enough to check before you commit a budget. For how the two new models compare head to head, see our [Gemini 3.6 Flash vs 3.5 Flash-Lite](https://geotoolbox.ai/blog/gemini-3-6-flash-vs-3-5-flash-lite) guide.
...
Here is Gemini 3.6 Flash across all four tiers.
...
<tbody>
<tr><td><strong>Standard</strong></td><td>$1.50</td><td>$7.50</td><td>Baseline price, normal latency</td></tr>
<tr><td><strong>Batch</strong></td><td>$0.75</td><td>$3.75</td><td>50% off, up to 24 hours to return</td></tr>
<tr><td><strong>Flex</strong></td><td>$0.75</td><td>$3.75</td><td>About 50% off, latency-tolerant, can be queued</td></tr>
<tr><td><strong>Priority</strong></td><td>$2.70</td><td>$13.50</td><td>Roughly 1.8x Standard, non-sheddable traffic</td></tr>
</tbody>
</table>
...
The practical trap is reading a number without knowing its tier. If an AI Overview tells you Gemini 3.6 Flash costs $2.70 per million input tokens, it is quoting the Priority rate, not the $1.50 headline. Always confirm which tier a quoted price belongs to before you budget against it.
...
Second, the 200K context cliff doubles Pro input. On the Pro models, once a single prompt crosses 200,000 tokens of [context](https://geotoolbox.ai/blog/how-does-ai-search-work), the input rate roughly doubles and output climbs with it: Gemini 3.1 Pro input goes from $2.00 to $4.00 per million, output from $12.00 to $18.00. Retrieval pipelines that stuff large documents into every call cross that line on every request without anyone noticing, because dashboards show averages and the cliff hides in the few oversized prompts.
...
<tr><td><strong>OpenAI</strong></td><td>GPT-6 Luna, $0.10 / $0.50 (Work/Codex/API; GPT-5.6 Luna, which standard ChatGPT still runs, is $0.20 / $1.20)</td><td><a href="https://geotoolbox.ai/blog/gpt-6-astra">GPT-6 Astra</a>, $10.00 / $50.00 (GPT-6 Sol below it at $2.00 / $10.00 in Work/Codex/API; GPT-5.6 Sol, which standard ChatGPT still runs on paid plans, is $4.00 / $20.00, promotional to Nov 21, 2026)</td></tr>
<tr><td><strong>Anthropic Claude</strong></td><td>Haiku 4.5, $1.00 / $5.00</td><td>Fable 5.1, $10.00 / $50.00 (Opus 5.5 below it at $4.00 / $20.00)</td></tr>
</tbody>
</table>

Gemini 2.5 Flash at $0.30 input and $2.50 output is a fraction of what the frontier models charge, and the fair fight is Flash against each rival's own cheap tier: GPT-6 Luna, which OpenAI added to Work, Codex and the API on September 22, 2026, at [OpenAI's published rates](https://developers.openai.com/api/docs/pricing), and Claude Haiku 4.5. That fight Gemini now loses on the headline rate, because GPT-6 Luna is $0.10 input against Flash's $0.30, an even wider gap than GPT-5.6 Luna's $0.20 (the cheap model standard ChatGPT still runs), though Flash still undercuts Haiku 4.5 at $1.00. You can read the full breakdowns in our [ChatGPT API pricing](https://geotoolbox.ai/blog/chatgpt-pricing) and [Claude API pricing](https://geotoolbox.ai/blog/claude-pricing) guides.

There is a subtler wrinkle no table row captures: the 200K cliff erodes Gemini's long-context edge. Gemini 3.1 Pro at $2.00 input undercuts GPT-5.6 Sol by half, ties GPT-6 Sol's own $2.00 input rate, and undercuts [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra) by 80%, on prompts up to 200,000 tokens. Cross that line and Gemini's input doubles to $4.00 while Anthropic holds its rates flat and OpenAI holds flat up to 272,000 tokens, so the gap narrows sharply, though even at $4.00 Gemini 3.1 Pro still sits under GPT-5.5's $5.00. Past 272,000 input tokens OpenAI applies its own surcharge, doubling input and adding half again on output for the whole request, so GPT-6 Sol moves to $4.00 and $15.00 and ties Gemini 3.1 Pro's post-cliff input rate again. Where it can actually flip is against a cheaper-tier rival: Claude Sonnet 5 undercuts Gemini's post-cliff $4.00 at its $2.00 input rate (which Anthropic made permanent in August 2026, cancelling the planned $3.00 rise). A workload that lives in very long context can erase Gemini's short-context price win, so price the cliff into your own token distribution before you commit.
...
For high-volume work OpenAI's cheap tier is now clearly cheaper: Gemini 2.5 Flash is $0.30 input against GPT-6 Luna at $0.10 (the Work/Codex/API tier OpenAI added September 22, 2026) or GPT-5.6 Luna at $0.20 (the cheap model standard ChatGPT still runs). But reasoning tokens and context length can flip a base-rate comparison, so benchmark both on your real prompts. See our [ChatGPT API pricing](https://geotoolbox.ai/blog/chatgpt-pricing) guide for the full numbers.
...
- Gemini Developer API pricing - Google (per-model token rates, service tiers, media meters) - `ai.google.dev/gemini-api/docs/pricing`
- Gemini API billing and usage tiers - Google (tier caps, spend controls) - `ai.google.dev/gemini-api/docs/billing`
- Gemini API additional terms - Google (free-tier data-use policy) - `ai.google.dev/gemini-api/terms`
- Gemini API model deprecations - Google (shutdown and migration dates) - `ai.google.dev/gemini-api/docs/deprecations`
- Vertex AI generative AI pricing - Google Cloud (rate parity, caching discounts) - `cloud.google.com/gemini-enterprise-agent-platform/generative-ai/pricing`
- OpenAI API pricing - OpenAI (comparison rates) - `developers.openai.com/api/docs/pricing`
