...
date: "2026-07-04"
updated: "2026-09-05"
recheckBy: "2026-11-05"  # backfilled 2026-09-05 freshness audit (no prior guard); names the current Claude tiers by context window; the Fable tier moved to 5.1 on 2026-09-01. Re-verify the lineup on platform.claude.com
...
<tr><td><strong>Claude Opus 5</strong> (current Opus)</td><td>1M tokens</td><td>Automatic on Max, Team, and Enterprise. Pro must enable usage credits</td></tr>
...
<tr><td><strong>Legacy</strong> (Opus 4.8 / 4.7 / 4.6, Sonnet 4.6)</td><td>1M tokens</td><td>Opus 4.8 and 4.7 follow the Opus rules above. Sonnet 4.6 is not part of the automatic upgrade and requires usage credits on every subscription plan, including Max</td></tr>
</tbody>
</table>
