...
As of late June 2026 there is no confirmed return date. The restrictions remain in place and the models are still offline while Anthropic and the government negotiate. This is a fast-moving story, so treat the specifics here as a June 2026 snapshot and check Anthropic's announcements for the current state.
