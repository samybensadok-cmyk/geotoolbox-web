...
**Update, September 22, 2026:** [Claude Opus 5.5](https://www.anthropic.com/news/claude-opus-5-5) has since superseded Opus 5 as Anthropic's current Opus model, at $4/$20 per million tokens versus Opus 5's $5/$25. The Opus-5-specific comparisons, cost math and benchmark figures below describe the model as it stood when Fable 5.1 launched and are unchanged; see our [Claude pricing guide](https://geotoolbox.ai/blog/claude-pricing) for the current lineup.
...
The one independent number to anchor on comes from Artificial Analysis, whose Intelligence Index put Fable 5.1 at 66 at launch, the top score in its class and ahead of GPT-5.6 Sol. That is a third-party aggregate rather than a vendor benchmark, which makes it the most useful single figure in the launch. OpenAI's [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra), released two days later at the same $10/$50 list price, scored 61 on that same index version and still sat behind Fable 5.1 on the v4.2 revision that followed. Artificial Analysis has since rescaled the index again, to v4.3.2 (September 2026): on that scale Fable 5.1 and GPT-6 Astra (max) are tied at 53, both behind the new #1, [Claude Opus 5.5](https://www.anthropic.com/news/claude-opus-5-5) (max), at 58. The v4.2 figures above and the v4.3.2 figures here are different scales and should not be compared directly.
...
OpenAI's frontier model is now [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra), released two days after Fable 5.1 at the same $10 and $50 per million tokens; that head-to-head is covered in the Astra article. Sol is the cheaper OpenAI rival, and against it the two win on different axes. On the published benchmarks, Fable 5.1 leads: it took the top score (66) on the Artificial Analysis Intelligence Index at launch, ahead of Sol, and it leads across the coding and science evals in the table above, from Terminal-Bench-Science (52.6% versus 22.4%) to CursorBench (73.4% versus 67.2%).

Price runs the other way. GPT-5.6 Sol's pricing is roughly $4 input and $20 output per million tokens on a promotional rate, less than half Fable 5.1's per-token cost; its successor GPT-6 Sol (September 22, 2026) is $2 and $10, a fifth of it. For teams doing high-volume work where Sol is "good enough," that gap matters.
...
- Intelligence Index v4.3.2 leaderboard (Claude Fable 5.1, GPT-6 Astra, Claude Opus 5.5) - Artificial Analysis, Sept 2026 - `artificialanalysis.ai/leaderboards/models`
- Claude Opus 5.5 - Anthropic, Sept 22 2026 - `anthropic.com/news/claude-opus-5-5`
