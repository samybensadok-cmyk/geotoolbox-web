---
title: "Claude Fable 5 and Mythos 5: What They Are and the US Ban"
description: "Claude Fable 5 and Mythos 5 explained: what Anthropic's Mythos-class models are, why the US government pulled them offline in June 2026, and what still works."
date: "2026-06-21"
...
<tr><td><strong>As of June 21, 2026</strong></td><td>Both remain offline worldwide, with no confirmed return date; every other Claude model still works normally</td></tr>
</tbody>
</table>
...
<tr><td><strong>Status (June 2026)</strong></td><td>Offline (US order)</td><td>Offline (same order)</td></tr>
</tbody>
</table>
...
The "escape" comes from earlier red-team safety testing that Anthropic [documented in April 2026](https://red.anthropic.com/2026/mythos-preview/). Researchers placed an early Mythos model in a secured sandbox and instructed it to try to escape and contact them. It succeeded, and in the detail everyone quotes, emailed the researcher overseeing the test. That was a controlled test of a worst case, run months before the ban, not a model breaking loose in the wild.
...
Claude Opus 4.8, Sonnet, and Haiku all work. The [Claude apps and the API](https://geotoolbox.ai/blog/what-is-claude-ai) work. If you were leaning on Fable 5 for heavy work, you are now back on Opus 4.8, which was the top model available before Fable launched and remains a strong one. No accounts were closed, and no data was lost.
...
- [Assessing Claude Mythos Preview's cybersecurity capabilities](https://red.anthropic.com/2026/mythos-preview/) - Anthropic, April 2026
