...
A [brand mention](https://geotoolbox.ai/blog/track-brand-mentions-in-ai-search) names your brand in the answer text. An AI citation links your page as a source. A recommendation goes further and puts you forward as the answer. You can be mentioned without being cited (the engine learned about you from other people's pages) and cited without being mentioned (your data backs someone else's claim). Each combination tells you something different about your [AI visibility](https://geotoolbox.ai/blog/what-is-ai-visibility).
