...
An **AI citation** is a linked reference to your page inside a generated answer: ChatGPT's source chips, Perplexity's numbered footnotes, the link cards beside a Google AI Overview. It is not the same thing as a mention, and the difference decides what you optimize for.
...
<figure>
  <BlogImage src="/blog/how-to-get-cited-by-ai/ai-citation-pipeline.png" alt="Four stages of how an AI answer selects and links its cited sources." w="1300" h="600" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
