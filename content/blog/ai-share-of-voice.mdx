...
Before you trust any share-of-voice number, settle the one input every tool takes for granted: whether the AI engines can read your pages at all. geotoolbox's free [AI search checker](https://geotoolbox.ai/features/content-analyzer) fetches your page as the major AI crawlers, flags a block or a render gap, and grades how citable it is from 0 to 100, in under a minute. Clear that first, fix a stable prompt set and an honest competitor list, then track your share over time so the number you report is one you can defend.
