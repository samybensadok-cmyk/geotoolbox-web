...
AI share of voice is the percentage of AI answers, across a set of prompts, where your brand gets named instead of a competitor. It is the closest thing AI search has to a ranking, and the fastest-growing metric in the category.

It is also the easiest to game, mostly by accident. The number you get depends entirely on which prompts you test and which competitors you count, and most tools never show you either. This guide covers how AI share of voice is calculated, what a good score looks like, why two tools rarely agree, and how to read the number without fooling yourself.
...
The sharpest modern version is share of search: your share of brand searches in a category. Presenting the metric at [the IPA's EffWorks 2020 conference](https://ipa.co.uk/news/binet-presents-fast-cheap-predictive-share-of-search-metric), Les Binet showed it works as a leading indicator of market share, often moving six to twelve months ahead of sales, and later IPA work found share of search lined up with roughly 83% of market share across thirty case studies.
...
**AI share of voice = (AI responses that mention your brand / total responses across your prompt set) × 100**

Run 100 prompts, get named in 30 of the answers, and your share of voice is 30%. Add competitors to the same run and you see the full split: you at 30%, the category leader at 40%, two others sharing the rest.
...
Stack the prompt set with questions you already win and your number climbs. Leave a strong rival off the competitor list and your slice of the remaining mentions looks bigger. Even innocent choices distort it: rewording prompts with synonyms alone can swing the measured share by double digits. The universe of buyer questions is effectively infinite, and every tool samples a sliver of it and treats that sliver as the whole.
...
Most tools still publish directional bands. Use them as orientation, not targets:
...
This is why mature measurement layers sentiment on top: not just your share of voice, but your share of positive voice. A mention where the AI actively recommends you is worth far more than one where you are the cautionary example. By most counts only a minority of AI brand mentions are clearly positive, so the gap between "mentioned" and "recommended" is wide enough to matter.
...
The two failures look identical in a report and have opposite fixes. One is solved by better content and earned mentions; the other by a one-line change to a robots file or a firewall rule. In our testing, this reachability gap explains more flat-zero results than weak content does, and no share-of-voice dashboard surfaces it.
...
There is no universal benchmark, because the number depends on your prompt set, your competitor list, and how mentions are counted. As rough orientation, under 15% is emerging, 15 to 30% is competitive, 30 to 50% is strong, and 50%+ is dominance, but context flips it: 15% can be the lead in a crowded field, while 50% is mere parity in a two-brand market. The signal that matters is your trend over time and your share against the specific competitors you named.

**How do you calculate AI share of voice?**
Run a fixed set of buyer-relevant prompts across the AI engines you care about, then divide the number of answers that mention your brand by the total answers, times 100. Decide upfront whether a "mention" means any name-drop, a citation to your site, or a position-weighted recommendation, because the three methods produce different numbers from the same data.

**How is AI share of voice different from traditional share of voice?**
Traditional share of voice measures your slice of advertising, media, or brand searches, all of which have stable, external denominators. AI share of voice measures your slice of AI answers, and its denominator is one you construct by choosing prompts and competitors. The idea is the same; the missing fixed denominator is what makes the AI version easier to misreport.
