...
Microsoft Copilot is the AI assistant Microsoft has put almost everywhere: a free chatbot on the web, a button in Word and Excel, an assistant built into Windows, and a paid layer that reads your work email. If you want the plain version of what Copilot actually is, which versions exist, what they cost, and whether it is just ChatGPT with a Microsoft badge, this is it, current as of August 2026.
...
<tbody>
<tr><td><strong>Underlying models</strong></td><td>OpenAI GPT-5.6 (plus Claude options and in-house MAI models)</td><td>OpenAI GPT-5.6</td></tr>
