...
Read the provenance and freshness rows again. That is where OKF v0.2 standardizes something [retrieval](https://geotoolbox.ai/blog/what-is-rag) leaves to each implementation.
