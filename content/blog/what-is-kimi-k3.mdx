...
date: "2026-07-17"
recheckBy: "2026-08-31"  # weights public (July 27); reasoning_effort low/high/max landed (confirmed 2026-08-08). Qwen3.8-Max open-weights (08-12) and Qwen3.8-27B (~08-14) both resolved and live elsewhere in the corpus; this file DOES reference Qwen3.8-Max at the K3-launch-timing line (updated 08-19 to note the 08-12 text-weights opening; the earlier 'doesn't reference Qwen' note was wrong and caused a sweep to skip it) — recheck for independent K3 benchmarks
updated: "2026-09-07"
recheckByNote: "09-07: fixed AA Intelligence Index (v4.1.1-stale '60, tied with GLM-5.3' -> verified v4.2 '50, GLM-5.3 49, not tied') at the 2 spots that hardcoded the number. NOT done this pass, scope boundary of a lighter-touch sweep: the article's many 'Fable 5' / 'GPT-5.6 Sol' comparisons throughout (intro quote, benchmark table, cost-per-task, recommendation table, FAQ) are anchored to specific vendor-reported numbers tied to those exact model versions and were not individually re-verified against Claude Fable 5.1 / GPT-6 Astra (both released since) - that needs its own forensic pass, flagging rather than silently leaving or overclaiming a full fix."
...
<tbody>
<tr><td><strong>AA Intelligence Index</strong></td><td>50 (top open model, v4.2, Sept 2026)</td><td>higher</td><td>higher</td><td><strong>Independent</strong> (Artificial Analysis)</td></tr>
