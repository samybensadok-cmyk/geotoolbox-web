...
date: "2026-07-18"
updated: "2026-07-28"
recheckBy: "2026-08-11"  # API top-up promo ends 2026-08-11 (nearest); then K2.5 + moonshot-v1 retire 2026-08-31; subscriptions paused 2026-07-19 reopening undated
...
<Callout type="note">
A couple of dates will age parts of this page: an API top-up promotion runs to August 11, and the K2.5 and moonshot-v1 models retire August 31. (Kimi K3's open weights, once pending, went public on July 27, 2026 under a custom Kimi K3 License.) The K2.6 credit exemption in particular is a vendor policy about a model that is now one generation behind, so re-check it before relying on it.
</Callout>
...
- K3 launch top-up promotion, running July 15 to August 11, 2026 - Moonshot AI developer docs, accessed July 20, 2026 - `platform.kimi.ai/docs/pricing/promotion`
