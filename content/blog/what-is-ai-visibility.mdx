...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-ai-visibility/what-drives-ai-visibility-stack.png" alt="Diagram of the three layers that drive AI visibility, in order: crawler reachability, machine-readable structure, and third-party corroboration" w="2600" h="1156" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
