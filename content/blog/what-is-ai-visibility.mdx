...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-ai-visibility/ai-overview-citations-decoupling.png" alt="Bar chart showing the share of Google AI Overview citations from top-10 ranking pages falling from 76% in mid-2025 to 38% in early 2026" w="1040" h="518" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Ranking and AI Overview citation are visibly decoupling, per Ahrefs' 863,000-SERP tracking.</figcaption>
</figure>
...
<tr><td><strong>Citation rate</strong></td><td>How often do your own pages get used as a source?</td><td><a href="https://geotoolbox.ai/blog/how-to-get-cited-by-ai">AI citations</a> carry the referral traffic</td></tr>
...
The bigger change is official first-party data. In June 2026, Microsoft expanded [its AI visibility reporting in Bing Webmaster Tools](https://blogs.bing.com/search/June-2026/New-AI-Visibility-Insights-in-Bing-Webmaster-Tools-Intents-Topics-Citation-Share-Compare) with query intents, topic clusters, and a citation-share view showing your slice of all citations for the same grounding queries, on top of the Copilot and Bing citation counts it began publishing in February. Google began rolling out [generative-AI performance reports in Search Console](https://developers.google.com/search/blog/2026/06/gen-ai-performance-reports) the same month, showing impressions in AI Overviews and AI Mode; the rollout started with a subset of sites and, as of August 31, 2026, covers all websites worldwide. Clicks, CTR, position, and query data are still not included. For the first time, part of your AI visibility is observable from the platform side instead of reconstructed through synthetic prompts.
...
Yes, and it is increasingly common. In Ahrefs' tracking, the share of Google AI Overview citations coming from top-10 pages fell from 76% in mid-2025 to 38% in 2026 (Ahrefs also improved its citation parsing between the two studies, so the figures are not strictly comparable), so ranking and AI citation have visibly decoupled. Ranking well still helps, but it no longer guarantees a place in the answer.
