...
date: "2026-08-01"
updated: "2026-08-08"
recheckBy: "2026-09-15"  # pricing page warns of a coming "significant" overall price increase, subject to official notice (verified live 2026-08-08, no peak/off-peak scheme shown); V4-Flash build (0731) + independent benchmarks still moving
...
<tbody>
<tr><td><strong>V4-Flash</strong></td><td>284B / 13B active</td><td>Chat, extraction, classification, summarization, high-volume agent loops, most coding</td><td>$0.14 in / $0.28 out</td></tr>
<tr><td><strong>V4-Pro</strong></td><td>1.6T / 49B active</td><td>Hard reasoning, complex multi-step analysis, the most demanding code</td><td>$0.435 in / $0.87 out</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td><strong>V4-Flash</strong></td><td>$0.14</td><td>$0.0028</td><td>$0.28</td></tr>
<tr><td><strong>V4-Pro</strong></td><td>$0.435</td><td>$0.003625</td><td>$0.87</td></tr>
</tbody>
</table>

A few catches separate that sticker price from your actual bill.

**A price increase is likely coming, and DeepSeek is signaling it.** As of August 2026 the rates above are flat all day, with no time-of-day surcharge to schedule around. But the pricing page now carries an unusual warning: DeepSeek says it plans to "raise the overall pricing for DeepSeek API services in the near future, with a significant increase expected," the specifics "subject to official notice." (A peak/off-peak multiplier that circulated after V4's launch is not on the current pricing page.) In a market where these prices mostly fall, that is worth pricing into any budget you build on today's rates.
...
Possibly. As of August 2026 the rates are flat all day, but DeepSeek's pricing page warns it plans to raise overall API pricing "in the near future, with a significant increase expected," the specifics "subject to official notice." No amount or date is given, so budget on today's rates but treat them as a floor, not a promise. (An earlier peak/off-peak surcharge that circulated after V4's launch is not on the current pricing page.)
