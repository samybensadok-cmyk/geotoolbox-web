...
<table>
  ...
  <tbody>
    <tr><td>AI search bots read your llms.txt</td><td>A file on Search Engine Land logged zero visits from GPTBot, ClaudeBot, PerplexityBot, or Google-Extended across roughly ten weeks of server logs (August to October 2025)</td><td>Semrush</td></tr>
    ...
    <tr><td>Major AI providers support it</td><td>None have committed to parsing it; Google's John Mueller: none of the AI services have said they use it</td><td>Google / Ahrefs</td></tr>
...
You can answer this for your own site in five minutes: publish the file, wait a few weeks, and grep your server logs for requests to /llms.txt by bot user agent. Every published test so far has come back empty for the search crawlers, which is stronger evidence than any vendor statement.
