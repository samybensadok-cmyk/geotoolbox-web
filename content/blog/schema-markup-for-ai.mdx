...
If you want the machine's-eye view of a specific page, the [Content Analyzer](https://geotoolbox.ai/features/content-analyzer) grades it the way this article thinks. It checks whether your JSON-LD is present, well-formed, and type-correct, diffs what renders with and without JavaScript, and scores how citable the content itself is: the plumbing and the substance in one pass.
