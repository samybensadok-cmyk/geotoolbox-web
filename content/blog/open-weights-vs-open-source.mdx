...
<tr><td><strong>Qwen (Alibaba)</strong></td><td>Open-weight, up to a point</td><td>Apache 2.0 (Qwen3 series, through Qwen3.6)</td><td>None on the Apache 2.0 line, which stops at Qwen3.6; the 3.7 generation is API-only. On August 12, 2026 Alibaba published Qwen3.8-Max weights (text-only variant) under a bespoke "Qwen3.8-Max" license, its first open-weight Max-class model</td></tr>
