...
- [Open Source Initiative - The Open Source AI Definition 1.0 (OSAID)](https://opensource.org/ai/open-source-ai-definition)
- [Wikipedia - Llama (language model): open source status and license](https://en.wikipedia.org/wiki/Llama_(language_model))
- [Meta - Llama 4 Community License Agreement](https://www.llama.com/llama4/license/)
- [Google - Gemma 4 released under Apache 2.0](https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/)
- [OpenAI - gpt-oss open-weight models, Apache 2.0 (GitHub)](https://github.com/openai/gpt-oss)
- [DeepSeek-R1 - MIT License (GitHub)](https://github.com/deepseek-ai/DeepSeek-R1)
- [Qwen3 - Apache 2.0 open-weight models (GitHub)](https://github.com/QwenLM/Qwen3)
- [Epoch AI - Open-weight models lag the best closed models by about three and a half months](https://epoch.ai/data-insights/open-weights-vs-closed-weights-models)
- [Forbes - Open Weight Definition Adds Balance To Open Source AI Integrity](https://www.forbes.com/sites/adrianbridgwater/2025/01/22/open-weight-definition-adds-balance-to-open-source-ai-integrity/)
