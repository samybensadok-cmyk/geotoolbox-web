...
Meanwhile the open-weight releases kept coming, and mostly from Chinese labs: DeepSeek V4 under MIT, GLM-5.2 under MIT, Tencent's Hunyuan Hy3 under Apache 2.0, and Kimi K3, whose weights went public on July 27 under its own custom license.
