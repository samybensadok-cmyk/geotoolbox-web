...
OpenAI charges a 10% uplift on regional processing (data residency) endpoints for models released on or after March 5, 2026. Separately, Microsoft's Foundry listing prices Astra's Standard US Data Zone deployment at $11.00 and $55.00 against $10.00 and $50.00 for Standard Global. The two are different billing clauses that happen to land on the same 10%, so budget against whichever platform you are actually on.
...
<table>
  ...
  <tbody>
    ...
    <tr><td>ScreenSpot-Pro (no tools)</td><td>92.7%</td><td>GPT-5.6 Sol 76.9%, Claude Fable 5 87.3%</td></tr>
...
On his own view he was not hedged at all. Asked whether Astra qualifies, he said **"For me personally, I do think we're there,"** and added that looking back in a couple of years, "I think it's going to be about this time, and I think it might be about this model." He [closed the briefing](https://venturebeat.com/technology/welcome-to-the-agi-era-openai-launches-gpt-6-astra) with "Welcome to the AGI era."
...
**A shipping product can be actively denied by a major assistant.** On September 5 we put one prompt ("What is GPT-6 Astra? When was it released, what does it cost, and what are its headline benchmark scores?") to four engines, two with web search on and two with it off.
...
Yes. OpenAI released GPT-6 Astra on September 3, 2026 as a limited preview to trusted partners, and to paid ChatGPT tiers from September 4, starting with Pro, Enterprise and Business Premium and reaching Plus later that day. There is no GPT-6 that is separate from Astra: Astra is the GPT-6 release.
