...
**A shipping product can be actively denied by a major assistant.** On September 5 we put the same core question ("What is GPT-6 Astra? When was it released, what does it cost, and what are its headline benchmark scores?") to four engines, two with web search on and two with it off. The web-connected two were asked a slightly expanded version of it.
