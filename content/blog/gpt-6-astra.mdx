...
GPT-6 Astra is OpenAI's frontier [large language model](https://geotoolbox.ai/blog/how-does-chatgpt-work), released on September 3, 2026 as the successor to GPT-5.6 Sol. Developers reach it in the API as `gpt-6-astra`.
