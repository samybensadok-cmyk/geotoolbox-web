...
date: "2026-06-29"
updated: "2026-09-25"
recheckBy: "2026-11-21"   # volatile: OpenAI has repriced GPT-5.6 twice (Terra/Luna 2026-07-30, Sol 2026-08-21). Sol's $4/$20 is PROMOTIONAL and committed only "at least through November 21, 2026" — recheck ON that date whether it holds, extends or reverts to $5/$30. Re-verify the standard, long-context and Fast mode rates at developers.openai.com/api/docs/pricing, the availability table at help.openai.com art. 20001354, and whether the Cerebras rollout of Sol has actually shipped (announced for July 2026, unconfirmed). 09-25: added GPT-6 Sol/Luna Sept-22 launch in Work/Codex/API ($2/$10, $0.10/$0.50) superseding GPT-5.6 there; GPT-5.6 Sol price unchanged at $4/$20. 09-26: gpt-5-6-access-by-product-aug2026.png kept as a dated 7 Aug 2026 snapshot (operator ruling: dated access charts are captioned, not regenerated); figcaption notes the GPT-6 Sol/Luna change.
...
**Update, September 5, 2026:** GPT-5.6 is no longer OpenAI's newest generation. [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra) shipped on September 3, 2026 and sits above Sol as the frontier model. Sol remains the cheaper working model at $4/$20 against Astra's $10/$50, and everything below still describes the GPT-5.6 family accurately.

**Update, September 25, 2026:** GPT-5.6 is now superseded in ChatGPT Work, Codex, and the API too. On September 22, OpenAI added [GPT-6 Sol and GPT-6 Luna](https://geotoolbox.ai/blog/gpt-6-astra) to Work and Codex for Plus, Pro, Business, Enterprise, and Edu plans, at $2.00/$10.00 and $0.10/$0.50 per million tokens on the API, roughly half GPT-5.6's promotional rate (Free and Go get GPT-6 Luna in the desktop app only, not in standard Chat). Standard ChatGPT chats still run GPT-5.6 (Sol on Plus and above, Luna on Free and Go), and GPT-6 Astra remains OpenAI's best model overall.
...
GPT-5.6 is OpenAI's GPT-5-generation family of [large language models](https://geotoolbox.ai/blog/how-does-chatgpt-work), first shown in limited preview on June 26, 2026 and released broadly on July 9. It was OpenAI's newest generation until [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra) shipped on September 3, 2026 and took the frontier slot above it. The headline change is structural. Instead of a single flagship, GPT-5.6 ships as three models that share a generation number but sit at different points on the capability-and-cost curve.

The naming carries the logic. In OpenAI's new scheme, the number (5.6) marks the generation, while Sol, Terra, and Luna are durable capability tiers meant to advance on their own cadence. It is a shift from the single-flagship pattern of recent releases to a lineup you pick from by job. GPT-5.6 is the last step in the GPT-5 series, the successor to GPT-5.5 and the generation directly below [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra).
...
Since August 6, 2026, every ChatGPT plan reaches GPT-5.6, but not the same model. Free and Go now default to **Luna**, replacing GPT-5.5; Plus and above default to **Sol** and can pick a reasoning level. Terra is the one tier that never appears in a standard chat. Since September 22, 2026, ChatGPT Work and Codex also carry GPT-6 Sol and GPT-6 Luna from Plus up; the list below covers the GPT-5.6 models. Product by product:
...
<figure className="not-prose my-8">
  ...
  <figcaption className="mt-3 text-center text-sm text-gray-500">Access as of 7 August 2026: every ChatGPT plan reaches GPT-5.6, but not the same model. Luna became the Free and Go default on 6 August 2026; Terra never appears in a standard chat. Since 22 September 2026, Work and Codex also carry GPT-6 Sol and Luna, which this chart predates.</figcaption>
</figure>
...
Sol is the flagship of the GPT-5.6 family, for the hardest reasoning, coding, and security tasks, and the only model with max and ultra reasoning modes. Terra is a balanced everyday model with GPT-5.5-class quality at a lower price. Luna is the fastest and cheapest, built for high-volume, routine work.
...
About 1,050,000 tokens, or roughly 1.05 million, with a maximum output of 128,000 tokens, shared across Sol, Terra, and Luna. The [context window](https://geotoolbox.ai/blog/how-does-ai-search-work) is what the model can hold in a single request; the 128,000 ceiling is how much of that it can write back.
