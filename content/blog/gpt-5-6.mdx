...
OpenAI has not officially published the context window for the preview. Early reports cite figures between 1 million and 1.5 million tokens, but they conflict and none trace to an official spec, so treat the number as unconfirmed for now.
...
- [OpenAI announces the next chapter for ChatGPT: GPT-5.6 now available](https://9to5mac.com/2026/07/09/openai-announcing-the-next-chapter-for-chatgpt-today-watch-here/) - 9to5Mac
