...
- [x402 documentation: Overview and How It Works](https://docs.cdp.coinbase.com/x402/welcome) - Coinbase Developer Docs
- [Coinbase debuts x402 for internet-native stablecoin payments](https://www.pymnts.com/cryptocurrency/2025/coinbase-debuts-x402-internet-native-stablecoin-payments/) - PYMNTS (launch, May 2025)
- [Introducing x402 V2](https://www.x402.org/writing/x402-v2-launch) - x402 (open standard)
- [Launching the x402 Foundation, and support for x402 transactions](https://blog.cloudflare.com/x402/) - Cloudflare
- [The x402 Foundation](https://www.linuxfoundation.org/x402foundation) - Linux Foundation
- [Agent Payments Protocol (AP2)](https://ap2-protocol.org/) and the [A2A x402 extension](https://github.com/google-agentic-commerce/a2a-x402) - Google and Coinbase
- [Free-Riding in the AI Economy: Demystifying Logic Flaws in x402-Enabled Payment Systems](https://arxiv.org/abs/2605.30998) - arXiv
- [What is x402?](https://www.ledger.com/academy/topics/economics-and-regulation/what-is-x402) - Ledger Academy
