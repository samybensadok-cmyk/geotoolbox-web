...
- [What's next for Chinese open-source AI](https://www.technologyreview.com/2026/02/12/1132811/whats-next-for-chinese-open-source-ai/) - MIT Technology Review
- [More of Silicon Valley is building on free Chinese AI](https://www.nbcnews.com/tech/innovation/silicon-valley-building-free-chinese-ai-rcna242430) - NBC News
- [After Anthropic shutdown, China's Z.ai closes frontier gap](https://www.reuters.com/world/asia-pacific/after-anthropic-shutdown-chinas-zai-closes-frontier-gap-it-plans-dual-listing-2026-06-25/) - Reuters
- [Hidden vulnerabilities in AI-coded software](https://www.crowdstrike.com/en-us/blog/crowdstrike-researchers-identify-hidden-vulnerabilities-ai-coded-software/) - CrowdStrike
- [DeepSeek R1 is now available on Azure AI Foundry](https://azure.microsoft.com/en-us/blog/deepseek-r1-is-now-available-on-azure-ai-foundry-and-github/) - Microsoft Azure
- [Artificial intelligence industry in China](https://en.wikipedia.org/wiki/Artificial_intelligence_industry_in_China) - Wikipedia
- [DeepSeek API documentation](https://api-docs.deepseek.com/) - DeepSeek
- [Open models on Hugging Face](https://huggingface.co/models) - Hugging Face
- [Colibri proof-of-concept runs GLM-5.2's 1.5-TB model on 25GB of RAM](https://www.tomshardware.com/tech-industry/artificial-intelligence/colibri-proof-of-concept-gains-frontier-level-1-5-tb-ai-model-novel-approach-runs-on-only-25gb-of-ram-and-shows-promise-for-local-ai-setups) - Tom's Hardware, July 2026
