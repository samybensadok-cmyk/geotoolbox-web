...
date: "2026-06-27"
updated: "2026-08-14"
recheckBy: "2026-09-14"  # Qwen weights-status resolved 08-14 (shipped 08-12, text-only, bespoke license). STILL PENDING for the freshness track: Kimi row K2.6 -> K3, and open-vs-closed.png regen (June-2026 capture, now date-scoped in alt+figcaption)
...
<tbody>
<tr><td><strong>DeepSeek V4</strong></td><td>DeepSeek (Hangzhou)</td><td>Yes</td><td>~1M</td><td>Cheap reasoning and coding</td><td>~$0.14 (Flash)</td></tr>
