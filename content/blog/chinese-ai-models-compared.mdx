...
date: "2026-06-27"
updated: "2026-08-07"
recheckBy: "2026-08-14"  # volatile: Qwen3.8-Max weights committed for the week of 2026-08-10, licence unannounced; also re-check the Kimi row (K2.6 -> K3) in the Batch 4 pass
...
<tr><td><strong>Qwen3.8-Max</strong></td><td>Alibaba</td><td>Smaller models yes; flagship weights promised for the week of Aug 10, 2026, not yet published</td><td>1M</td><td>Multilingual, agents, multimodal</td><td>$2</td></tr>
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/chinese-ai-models-compared/open-vs-closed.png" alt="Most Chinese frontier AI models ship open weights you can download and self-host; the top Qwen, Baidu's Ernie 5.1, and ByteDance's Doubao stay API-only." w="2200" h="1470" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">The open downloads span four current flagships plus open siblings from Qwen and Ernie; the top Qwen, Baidu's Ernie 5.1, and ByteDance's Doubao stay closed.</figcaption>
</figure>
