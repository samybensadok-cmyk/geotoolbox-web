...
date: "2026-07-22"
updated: "2026-08-14"
recheckBy: "2026-09-14"  # weights shipped 08-12 (text-only, bespoke license); re-check license terms + any multimodal/27B drop
...
Qwen matters disproportionately here because of how it spreads. As we covered in our [Qwen explainer](https://geotoolbox.ai/blog/what-is-qwen), it is the most-downloaded open model family in the world, fine-tuned and rebranded inside products that never mention Alibaba. Now that the Max weights have shipped, and if the promised 27B checkpoint follows, they will propagate into that same ecosystem, and their answers about your company travel with them, into tools you will never audit.
