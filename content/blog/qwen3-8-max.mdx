...
date: "2026-07-22"
updated: "2026-09-07"
recheckBy: "2026-09-21"  # 09-07: fixed a v4.1.1-stale AA Intelligence Index cell (Kimi K3 was "60", verified live at artificialanalysis.ai now v4.2 "50"). Prior: weights shipped 08-12 (text-only, bespoke license). RESOLVED 08-18: Qwen3.8-27B (open-weights, Apache 2.0, multimodal vision-language) shipped ~08-14 on Hugging Face, verified live; re-check license terms on the Max weights
...
<tr><td><strong>Kimi K3</strong></td><td>2.8T (claimed)</td><td>StackPerf 83/100; AA Intelligence Index 50 (v4.2, Sept 2026)</td><td>$3 in / $15 out</td><td>Published on Hugging Face under a custom Kimi K3 License</td></tr>
