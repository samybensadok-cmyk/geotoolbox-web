...
date: "2026-07-22"
updated: "2026-09-25"
recheckBy: "2026-10-09"  # 09-25: AA re-versioned to v4.3.2; fixed the Kimi K3 comparison-table cell from v4.2-stale "50" to "44, #3 open-weight" (now behind MiMo-V2.6-Pro 46 and GLM-5.3 45). 09-26: added Qwen3.8-Max own AA v4.3.2 scores to the same table (API 0902 checkpoint 45, proprietary; open Qwen3.8-2.4T-A95B text weights 40), verified on artificialanalysis.ai/models/qwen3-8-max and /models/qwen3-8-2-4t-a95b. 09-07: fixed a v4.1.1-stale AA Intelligence Index cell (Kimi K3 was "60", verified live at artificialanalysis.ai now v4.2 "50"). Prior: weights shipped 08-12 (text-only, bespoke license). RESOLVED 08-18: Qwen3.8-27B (open-weights, Apache 2.0, multimodal vision-language) shipped ~08-14 on Hugging Face, verified live; re-check license terms on the Max weights
...
<tbody>
<tr><td><strong>Qwen3.8-Max</strong></td><td>2.4T total, 95B active (vendor-stated)</td><td>Vendor table: 86.6 Terminal-Bench 2.1, 67.7 SWE-bench Pro, 92.6 GPQA. Independently, Artificial Analysis measures 81.3 on Terminal-Bench 2.1; AA Intelligence Index 45 for the API model (0902 checkpoint) and 40 for the open 2.4T-A95B text weights (v4.3.2, Sept 2026)</td><td>$2 in / $6 out</td><td>Open since August 12, 2026 (text-only variant, bespoke "Qwen3.8-Max" license); multimodal version API-only</td></tr>
<tr><td><strong>Kimi K3</strong></td><td>2.8T (claimed)</td><td>StackPerf 83/100; AA Intelligence Index 44, #3 open-weight (v4.3.2, Sept 2026)</td><td>$3 in / $15 out</td><td>Published on Hugging Face under a custom Kimi K3 License</td></tr>
