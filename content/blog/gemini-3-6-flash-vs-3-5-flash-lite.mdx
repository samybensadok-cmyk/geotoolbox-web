...
As of the July 21, 2026 release, Gemini 3.5 Pro is still testing with partners and Google has only said broad availability is coming. DeepMind confirmed it has started pre-training Gemini 4 but gave no date. Our [Gemini 3.5 Pro tracker](https://geotoolbox.ai/blog/gemini-3-5-pro) follows what is confirmed. (Verified still accurate as of August 8, 2026, against Google's published model list.)
