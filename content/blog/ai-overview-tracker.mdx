...
No, that only affects Gemini training and grounding. If you actually want out of AI Overviews, the levers are the snippet controls (nosnippet, max-snippet), blocking Googlebot itself, or the Search Console exclusion toggle rolling out in the UK. The full set of controls, searcher-side and site-side, is in our guide to [turning off AI Overviews](https://geotoolbox.ai/blog/how-to-turn-off-ai-overviews).
