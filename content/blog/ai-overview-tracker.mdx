...
What changed is that in June 2026 Google added a separate Search Console report for its generative-AI surfaces, [introduced on the Search Central blog](https://developers.google.com/search/blog/2026/06/gen-ai-performance-reports) and rolling out gradually rather than to everyone at once. It shows **impressions** for AI Overviews and the newer AI Mode (counted together, not split), with an opt-out toggle. That is real progress, and it kills the blanket claim, still repeated by most tracker vendors, that "Search Console can't see AI Overviews." It can now, partly.
...
<table>
  ...
  <tbody>
    <tr><td>geotoolbox</td><td>Citation + share-of-voice scan, plus a reachability and render check on the page itself</td><td>No (AIO only; see the AI Mode section above)</td><td>ChatGPT, Perplexity + Google AIO free; up to 7 engines by tier</td><td>Yes</td><td>Free / from $39/mo (billed annually)</td><td>Teams that want to know <strong>why</strong> they are missing, not just that they are</td></tr>
    ...
    <tr><td>AthenaHQ</td><td>Enterprise answer-engine analytics</td><td>Yes</td><td>Multi-engine</td><td>No</td><td>~$295/mo (~$95/mo billed annually) reported</td><td>Large orgs needing governance</td></tr>
  </tbody>
</table>
...
- [Google AI Overviews Surges Across 9 Industries](https://www.searchenginejournal.com/google-ai-overviews-surges-across-9-industries/568448/) - Search Engine Journal, 2026 (data: BrightEdge)
- [AIO Impact on Google CTR: September 2025 Update](https://www.seerinteractive.com/insights/aio-impact-on-google-ctr-september-2025-update) - Seer Interactive, November 2025
- [AIO Impact on Google CTR: 2026 Update](https://www.seerinteractive.com/insights/aio-impact-on-google-ctr-2026-update) - Seer Interactive, April 2026 (CTR leveling out at 2.4% by Feb 2026; +120% clicks per impression when cited)
- [Update: AI Overviews Reduce Clicks by 58%](https://ahrefs.com/blog/ai-overviews-reduce-clicks-update/) - Ahrefs, February 2026 (Dec 2023 vs Dec 2025, 300K keywords)
- [Google Search's I/O 2026 updates](https://blog.google/products-and-platforms/products/search/search-io-2026/) - Google, May 2026 (AI Mode past one billion monthly users)
...
- [Are AI Mode and AI Overviews Just Different Versions of the Same Answer? (730K Responses Studied)](https://ahrefs.com/blog/ai-overviews-vs-ai-mode/) - Ahrefs, 2025 (13.7% citation overlap between the two surfaces)
- [AI Overviews Change Every 2 Days (But Never Change Their Mind)](https://ahrefs.com/blog/ai-overview-change/) - Ahrefs, 2025 (run-to-run citation volatility)
