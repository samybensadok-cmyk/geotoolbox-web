...
<table>
  ...
  <tbody>
    <tr><td>geotoolbox</td><td>Citation + share-of-voice scan, plus a reachability and render check on the page itself</td><td>No (AIO only; see the AI Mode section above)</td><td>ChatGPT, Perplexity + Google AIO free; up to 8 engines by tier</td><td>Yes</td><td>Free / from $39/mo (billed annually)</td><td>Teams that want to know <strong>why</strong> they are missing, not just that they are</td></tr>
