...
At the main tier they match: Claude Pro and ChatGPT Plus are both about $20. On the API it depends on the model. Claude Opus 5 runs about $5 and $25 per million tokens, close to [GPT-5.6](https://geotoolbox.ai/blog/gpt-5-6), while Claude Sonnet 5 at $2 and $10 undercuts it for most production work.
