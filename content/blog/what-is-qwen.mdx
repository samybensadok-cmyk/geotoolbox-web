...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-qwen/qwen-open-family-closed-flagship.png" alt="Checklist of Qwen model lines with open weights, ending with the closed API-only Qwen3.7-Max flagship." w="1100" h="753" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Most Qwen lines are downloadable open weights — but the flagship Max tier is API-only.</figcaption>
</figure>
...
- Alibaba's Qwen family records 700 million downloads - Xinhua, January 2026 - `english.news.cn/20260113/004b0522f987475cbf83ffc3a8d009aa/c.html`
