...
<figure className="not-prose my-8">
  <BlogImage src="/blog/gemini-pricing/gemini-plan-prices.png" alt="Gemini's four consumer plans side by side, from free to Google AI Ultra, at prices unchanged since June 2026." w="1100" h="670" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">The four consumer tiers at US prices, unchanged since June 2026 — the API is a separate, per-token price book.</figcaption>
</figure>
