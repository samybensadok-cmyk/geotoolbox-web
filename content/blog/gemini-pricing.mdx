...
<figure className="not-prose my-8">
  <BlogImage src="/blog/gemini-pricing/gemini-plan-prices.png" alt="Gemini's four consumer plans side by side, from free to Google AI Ultra, at June 2026 prices." w="1100" h="670" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">The four consumer tiers at US prices, June 2026 — the API is a separate, per-token price book.</figcaption>
</figure>
...
<tr><td><strong>Anthropic Claude</strong></td><td>Claude Pro about $20</td><td>Claude Sonnet 5, about $3.00 / $15.00</td></tr>
</tbody>
</table>

Gemini's Flash models are among the cheapest credible options for high-volume work. Gemini 2.5 Flash at $0.30 input and $2.50 output is a fraction of what the frontier models charge: GPT-5.5 runs about $5.00 and $30.00, and Claude Sonnet 5 about $3.00 and $15.00. The fair fight is Flash against each rival's own cheap tier, but even there Gemini tends to win on price, and at scale that gap is real money.
