...
Gemini grounds on the **Google index** and the same content feeds [Google's AI features](https://developers.google.com/search/docs/appearance/ai-features), including [AI Overviews](https://geotoolbox.ai/blog/what-are-google-ai-overviews) and [AI Mode](https://geotoolbox.ai/blog/what-is-google-ai-mode). Being cited by Gemini and by Google's AI surfaces is largely the same job: earn a place in Google's index and write passages an AI can lift cleanly. Our [Gemini SEO guide](https://geotoolbox.ai/blog/gemini-seo) goes deeper.
