...
<tr><td><strong>Top model (June 2026)</strong></td><td>GPT-5.5 (Instant, Thinking, Pro)</td><td>Grok 4.3</td></tr>
...
<tr><td><strong>Context window</strong></td><td>About 1M tokens on GPT-5.5</td><td>About 1M tokens on Grok 4.3</td></tr>
...
This is where being current to June 2026 flips the usual answer. Older comparisons confidently tell you one model holds far more than the other. On the flagships that is no longer true. Per [xAI's own model docs](https://docs.x.ai/developers/models), Grok 4.3 (the current flagship while [Grok 5](https://geotoolbox.ai/blog/grok-5) trains) handles up to 1 million tokens, and GPT-5.5 sits around the same. At the flagship tier the context window is effectively a tie.
...
<tr><td><strong>API, per 1M tokens</strong></td><td>GPT-5.5 at about $5 in / $30 out</td><td>Grok 4.3 at about $1.25 in / $2.50 out</td></tr>
</tbody>
</table>

On the API the gap is large and runs in Grok's favor. Per [xAI's pricing](https://docs.x.ai/developers/models), Grok 4.3 is roughly $1.25 per million input tokens and $2.50 per million output, while [GPT-5.5](https://openai.com/index/introducing-gpt-5-5/) sits near $5 and $30. If you generate at volume, that difference compounds fast, though caching discounts and how many reasoning tokens each model burns can narrow the real-world gap.
