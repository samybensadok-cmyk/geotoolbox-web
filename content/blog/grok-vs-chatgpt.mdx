...
date: "2026-06-24"
updated: "2026-09-19"
recheckBy: "2026-10-06"  # flagship-comparison table; re-verify both cells before this date
...
<figure className="not-prose my-8">
  ...
  <figcaption className="mt-3 text-center text-sm text-gray-500">The tale of the tape, August 2026: each assistant leans on different jobs, and most heavy users end up running both.</figcaption>
</figure>
...
<tr><td><strong>Top model (September 2026)</strong></td><td><a href="https://geotoolbox.ai/blog/gpt-6-astra">GPT-6 Astra</a> (Sept 3), with GPT-5.6 (Sol, Terra, Luna) below it</td><td>Grok 4.6</td></tr>
...
<tr><td><strong>Context window</strong></td><td>About 1M tokens on GPT-5.6</td><td>About 500K tokens on Grok 4.6</td></tr>
...
<tr><td><strong>API, per 1M tokens</strong></td><td>GPT-5.6 (Sol) at about $4 in / $20 out (promotional to Nov 21, 2026)</td><td>Grok 4.6 at about $2 in / $6 out</td></tr>
</tbody>
</table>

On the API the gap is large and runs in Grok's favor. Per [xAI's pricing](https://docs.x.ai/developers/models), Grok 4.6 is roughly $2 per million input tokens and $6 per million output, undercutting [GPT-5.6 (Sol)](https://openai.com/index/previewing-gpt-5-6-sol/) at near $4 and $20. Sol was $5 / $30 until August 21, 2026, when OpenAI cut it 20% on input and 33% on output; that lower rate is promotional and committed only through November 21, so the gap here may widen again. Those Grok rates cover prompts under 200K tokens; past that they double to $4 / $12, which still lands under Sol on output and now exactly ties its $4 input. If you generate at volume, that difference compounds fast, though caching discounts and how many reasoning tokens each model burns can narrow the real-world gap.
