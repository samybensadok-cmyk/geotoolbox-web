...
Everything starts with Bing being able to crawl, index, and rank your pages. If [Bingbot](https://geotoolbox.ai/blog/ai-crawlers) cannot reach a page, Copilot cannot cite it, full stop. So the first pass is plumbing, and it is usually a quick win because most sites have never been tuned for Bing at all.
