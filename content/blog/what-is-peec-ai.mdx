...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-peec-ai/peec-pricing-model-limit.png" alt="Peec AI's July 2026 plan prices with the three-model limit and per-model add-on costs." w="1100" h="716" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
