...
<tr><td><strong>Terminal-Bench 2.1</strong></td><td>67.0%</td><td>80.4%</td><td>Not published</td><td>Command-line tool use</td></tr>
...
SWE-bench Pro is the hardest, most coding-specific test of the five, and it's the clearest Opus win: Opus 4.8 leads 69.2% to 63.2%, and Anthropic is upfront that Opus remains "the model of choice for higher accuracy" on this kind of work. Opus also leads on OSWorld-Verified and edges Humanity's Last Exam. But it doesn't sweep the table, and the popular "Opus wins everything" summary is wrong on two rows. Anthropic didn't publish an Opus 4.8 score on Terminal-Bench 2.1 in the Sonnet 5 comparison at all (that row is shown against other vendors' models, not Opus); Sonnet 5's 80.4% is the top published Claude number there, and where third parties have since run Opus 4.8 on the same harness it lands below Sonnet 5, in the 75-79% range. And on GDPval-AA v2, which scores real-world knowledge tasks rather than coding puzzles, Sonnet 5 numerically edges Opus 4.8, 1,618 to 1,615, a gap close enough to read as a tie. So the honest read is narrower than the headline: Opus leads the pure-coding and computer-use tests, and the two models trade the rest.
...
- [Claude Sonnet 5 review: Should you switch? - CodeRabbit](https://www.coderabbit.ai/blog/claude-sonnet-5-review) - independent post-launch code-review benchmark: precision gains, the bug-recall regression vs Sonnet 4.6, and the medium-effort recommendation
- [Claude Sonnet 5 Pricing 2026: The Hidden Costs and Real Savings - Finout](https://www.finout.io/blog/claude-sonnet-5-pricing-2026-the-hidden-costs-and-real-savings-behind-the-cost-neutral-launch) - the worked cost example showing the September 1 standard-rate crossover
