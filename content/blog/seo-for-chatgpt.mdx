...
Why bother? Because the audience is now mainstream. [Pew Research found](https://www.pewresearch.org/internet/2026/06/17/americans-and-ai-2026-chatbots-smart-devices-and-views-on-impact/) that 44% of US adults had used ChatGPT, per a survey published June 2026, up from 34% a year earlier and 18% in 2023. The usage numbers behind that trend are just as large: OpenAI announced [900 million weekly active users](https://techcrunch.com/2026/02/27/chatgpt-reaches-900m-weekly-active-users/) in February 2026, and the search side specifically had already passed [1 billion web searches in a single week](https://x.com/OpenAI/status/1916947241086095434) by April 2025, per OpenAI's own announcement. When nearly half the country is asking a chatbot questions, being absent from its answers is a real gap in coverage.
...
A practical way to think about ChatGPT Search is a [retrieve-and-cite loop](https://geotoolbox.ai/blog/how-chatgpt-search-works): it gathers candidate sources from search partners, OpenAI crawling/indexing, and partner content, then applies proprietary ranking and citation systems. Your job is to be in that candidate pool and to be the cleanest answer in it.
