...
Inkling arrives into a field where the best open models have, until now, been Chinese. DeepSeek, Kimi, and Zhipu's GLM set the open-weight bar, and Moonshot raised it further a day later with [Kimi K3](https://geotoolbox.ai/blog/what-is-kimi-k3), a 2.8-trillion-parameter model that scored well above Inkling on the same independent index, though K3's own weights were not yet public as of this writing, with Moonshot targeting July 27. Thinking Machines is pitching Inkling as a serious US entry that claims comparable performance. Here is how it sits against the field.
