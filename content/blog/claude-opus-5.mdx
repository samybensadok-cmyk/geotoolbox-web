...
date: "2026-07-25"
updated: "2026-09-05"
recheckBy: "2026-10-06"  # backfilled 2026-09-05 freshness audit (no prior guard); positions Opus 5 against the Fable tier, which moved to 5.1 on 2026-09-01. Re-verify Anthropic's "highest available capability" guidance
...
It is a [reasoning model](https://geotoolbox.ai/blog/how-ai-models-think), and it is the default model on Claude Max and the strongest model available on Claude Pro. It is not on the free tier.
