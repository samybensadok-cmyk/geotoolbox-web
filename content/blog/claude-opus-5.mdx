...
<table>
  ...
  <tbody>
    <tr><td>ChatGPT (GPT-5.6 Terra)</td><td>On</td><td>Correct</td></tr>
    ...
    <tr><td>ChatGPT (GPT-5.6 Terra)</td><td><strong>Off</strong></td><td>Failed, could not verify any of it</td></tr>
