...
<tr><td><strong>Top models (July 2026)</strong></td><td>Opus 4.8, Sonnet 5, and the newer Fable 5</td><td>The GPT-5.5 generation, with mini and nano variants (and the new <a href="https://geotoolbox.ai/blog/gpt-5-6">GPT-5.6 preview</a>)</td></tr>
...
<tr><td><strong>Context window</strong></td><td>Up to <a href="https://platform.claude.com/docs/en/about-claude/models/overview">1M tokens on Opus 4.8 and Sonnet 5</a></td><td>Up to about 1M tokens on the GPT-5.5 API; the consumer app exposes less, by plan</td></tr>
