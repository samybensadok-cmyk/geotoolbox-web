...
The catch is that the two engines reach for different sources, so showing up in one does not mean showing up in the other. Both sit on the same underlying machinery of [how AI search works](https://geotoolbox.ai/blog/how-does-ai-search-work), but they weight it differently, which splits into two concrete jobs.
