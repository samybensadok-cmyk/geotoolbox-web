...
<tr><td><strong>Top models (June 2026)</strong></td><td>Opus 4.8, Sonnet 4.6, and the newer Fable 5</td><td>The GPT-5.5 generation, with mini and nano variants</td></tr>
...
The catch is that the two engines reach for different sources, so showing up in one does not mean showing up in the other, and Gemini adds a third pool again, which we cover in [Claude vs Gemini](https://geotoolbox.ai/blog/claude-vs-gemini). Both sit on the same underlying machinery of [how AI search works](https://geotoolbox.ai/blog/how-does-ai-search-work), but they weight it differently, which splits into two concrete jobs.
