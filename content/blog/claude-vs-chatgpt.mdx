...
<tr><td><strong>Top models (July 2026)</strong></td><td>Opus 4.8, Sonnet 5, and the newer Fable 5</td><td>The <a href="https://geotoolbox.ai/blog/gpt-5-6">GPT-5.6 generation</a> (Sol, Terra, Luna), now OpenAI's flagship (GPT-5.5 is the prior generation)</td></tr>
...
<tr><td><strong>Context window</strong></td><td>Up to <a href="https://platform.claude.com/docs/en/about-claude/models/overview">1M tokens on Opus 4.8 and Sonnet 5</a></td><td>Reportedly ~1M on the GPT-5.6 API (OpenAI has not confirmed a figure); the consumer app exposes less, by plan</td></tr>
