...
date: "2026-07-02"
updated: "2026-08-15"
recheckBy: "2026-08-29"  # volatile. RESOLVED 08-15: the Think button + uncapped text chats for Free/Go are ROLLING OUT (staged) from the week of 2026-08-10 — live but not universal ("if you still see a cap, your account has not switched over yet", felloai 08-12) — so framed as rolling out, not complete; re-check by 08-29 that it finished. Ads verified 08-15 vs sibling chatgpt-ads (08-15) + SearchEngineLand/AdExchanger/eMarketer: now on Free/Go LOGGED IN OR OUT (logged-out expansion ~Jul 2026, all-audience; personalized targeting stays logged-in adults), ad-free mode opt-out (fewer daily messages, no image-gen tools) + Temporary Chat = no ads; Mexico/Brazil rolling out. STILL OPEN (could not verify — openai.com Cloudflare-403 here, no reachable route restated it): whether the 08-06 Instant/Thinking→Sol collapse made the "54K Instant / 256K reasoning" per-plan context rows (lines ~88, 78, 185) stale terminology — do NOT touch those numbers until a reachable primary source confirms.
