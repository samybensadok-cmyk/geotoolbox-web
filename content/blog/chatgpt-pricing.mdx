...
OpenAI's newest model, [GPT-6 Astra](https://geotoolbox.ai/blog/gpt-6-astra), landed on September 3, 2026 and is rolling out to Plus, Pro, Business and Enterprise. It is not on Free, and inside ChatGPT it draws on your plan allowance rather than the API rate.
...
<tbody>
<tr><td><strong>GPT-5.6 Sol</strong> (flagship)</td><td>$4.00†</td><td>$20.00†</td><td>Hardest coding, agents, research, security</td></tr>
