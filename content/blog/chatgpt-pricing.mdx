...
date: "2026-07-02"
updated: "2026-08-07"
recheckBy: "2026-08-14"  # volatile: OpenAI cut GPT-5.6 API prices on 2026-07-30 and changed the free tier on 2026-08-06 (Luna default). The Think button + uncapped text chats for Free and Go land the week of 2026-08-10 — confirm they shipped, then re-read the Free/Go sections and the per-window caps note. Also OPEN: the same 08-06 update collapsed Instant/Thinking into one Sol model for Plus and Pro, so the "54K Instant / 256K reasoning" per-plan context rows may be stale terminology — openai.com is Cloudflare-403 here, so re-verify the plan comparison from a reachable route before touching those numbers.
...
Here is the whole consumer and team lineup in one place, at [US prices from OpenAI](https://openai.com/chatgpt/pricing/) as of July 2026. Subscription prices have not moved since: the July 30 API cut and the August 6 free-tier change both left the plan prices untouched.
...
<tbody>
<tr><td><strong>Free</strong></td><td>$0/mo</td><td>GPT-5.6 Luna by default, uncapped text chats from mid-August, ads in some markets</td><td>Casual, occasional use</td></tr>
