...
ChatGPT pricing moved more than once in 2026. Go went global in January, a second Pro tier appeared in April, OpenAI cut Business pricing that same month, and the GPT-5.6 models (Sol, Terra, Luna) previewed in June and became generally available on July 9. Most pricing guides you will find still quote a tier list that has changed. Below is every current price, reconciled and dated July 2026, plus the question the numbers exist to answer: which plan, if any, you should actually pay for.
