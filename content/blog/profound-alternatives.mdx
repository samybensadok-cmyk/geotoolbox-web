...
<table>
  ...
  <tbody>
    ...
    <tr><td>geotoolbox</td><td>Tracking + reachability</td><td>Free / from $49/mo</td><td>ChatGPT free, 3 engines from $49, up to 8 by tier; also checks crawler access</td></tr>
  </tbody>
</table>
