...
<table>
  ...
  <tbody>
    ...
    <tr><td>geotoolbox</td><td>Tracking + reachability</td><td>Free / from $39/mo (annual)</td><td>ChatGPT free, 3 engines from $39, up to 7 by tier; also checks crawler access</td></tr>
  </tbody>
</table>
