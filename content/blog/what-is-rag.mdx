...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-rag/rag-retrieve-augment-generate.png" alt="Three-step RAG flow: retrieve matching passages, augment the prompt, generate a grounded answer." w="1100" h="648" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">The RAG loop: find the passages, paste them into the prompt, write an answer grounded in them.</figcaption>
</figure>
...
- What Is Retrieval-Augmented Generation, aka RAG? - NVIDIA, 2023 (updated 2025) - `blogs.nvidia.com/blog/what-is-retrieval-augmented-generation`
- Retrieval-augmented generation - Wikipedia - `en.wikipedia.org/wiki/Retrieval-augmented_generation`
