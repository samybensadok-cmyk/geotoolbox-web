...
<tbody>
<tr><td><strong>Gemini 3.6 Flash</strong></td><td>Fast, everyday answers, agents, and coding; the default you get most of the time</td><td>Current default model (July 2026); the fast model you get in the app and in Search, successor to 3.5 Flash</td></tr>
