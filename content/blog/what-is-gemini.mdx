...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-gemini/gemini-model-app-assistant.png" alt="Three cards separating Gemini the model family, the chat app, and the assistant layer." w="1100" h="635" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
