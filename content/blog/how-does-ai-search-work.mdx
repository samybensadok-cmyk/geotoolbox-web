...
AI search isn't one thing. ChatGPT, Perplexity, Gemini, Claude, and Google AI Overviews each handle your query differently. But the core process they share is the same: read the question, search the web, pick the good sources, write a grounded answer with citations. For where all of this stands in 2026, across every engine, see our [state of AI search](https://geotoolbox.ai/blog/state-of-ai-search-2026) field report.
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/how-does-ai-search-work/ai-search-four-step-loop.png" alt="Four steps of AI search: query understanding, retrieval, source evaluation, cited answer." w="1300" h="499" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Every major AI search engine runs this same loop — only the implementations differ.</figcaption>
</figure>
