---
title: "Comment fonctionne réellement ChatGPT ? Le modèle Transformer, expliqué en termes simples"
description: "Comment fonctionne ChatGPT ? Le mécanisme en détail : tokens, représentations, attention et prédiction du token suivant, et ce que chaque étape implique pour votre visibilité en matière d'IA."
date: "2026-06-12"
...
<tbody>
<tr><td>Réfléchit à votre question et la comprend</td><td>Prédit le token suivant à partir de modèles, un token à la fois</td></tr>
...
<tr><td>Effectue une recherche sur le Web à chaque fois qu’il répond</td><td>Uniquement lorsqu'il effectue une recherche sur le Web ; le reste du temps, aucune donnée n'est récupérée</td></tr>
...
- une **valeur** : que dois-je emporter ?
...
Le premier est la **connaissance paramétrique**, c'est-à-dire les modèles figés dans les poids lors de l'apprentissage. C'est ce qui intervient lorsque aucun outil n'est activé : vaste, mais statique par nature, figé à la fin de l'apprentissage, et ne contenant aucune copie de votre page, seulement un écho statistique du texte qui y ressemblait.
...
Il en va de même pour l’espoir de pouvoir acheter un emplacement publicitaire. OpenAI [a commencé à diffuser des publicités identifiées comme telles dans ChatGPT début 2026](https://techcrunch.com/2026/02/09/chatgpt-rolls-out-ads/), mais celles-ci apparaissent à part de la réponse et sont signalées comme telles ; à la mi-2026, il n’existe toujours pas de système d’enchères permettant d’intégrer votre marque directement dans le texte généré. La réponse est le résultat d’un calcul basé sur des poids et, parfois, d’une requête en temps réel, et il n’y a pas de processus de paiement pour l’un ou l’autre.
...
- [Wikipédia : GPT-3 (175 milliards de paramètres, 96 couches)](https://en.wikipedia.org/wiki/GPT-3)
- [TechCrunch : ChatGPT lance des publicités (février 2026)](https://techcrunch.com/2026/02/09/chatgpt-rolls-out-ads/)
