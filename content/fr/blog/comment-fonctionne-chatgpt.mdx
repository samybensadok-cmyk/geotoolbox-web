...
<figure className="not-prose my-8">
  <BlogImage src="/blog/comment-fonctionne-chatgpt/chatgpt-next-token-loop.png" alt="La boucle en quatre étapes de ChatGPT : tokenisation, embeddings, pile d’attention, choix du token suivant." w="1300" h="403" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
...
Depuis le lancement des publicités, OpenAI fait tourner un quatrième robot d’exploration : **OAI-AdsBot** vérifie la sécurité des pages soumises comme publicités. Il n’a aucun rôle dans la recherche organique, ce sont toujours OAI-SearchBot et ChatGPT-User qui la conditionnent, mais toute entreprise diffusant des ChatGPT Ads le retrouvera dans ses propres journaux serveur.

<figure className="not-prose my-8">
  <BlogImage src="/blog/comment-fonctionne-chatgpt/connaissances-parametriques-vs-recherche.png" alt="Connaissances paramétriques et recherche en temps réel comparées : ce qu’elles sont, quand elles interviennent, leur fraîcheur et le robot qui y donne accès." w="1300" h="591" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Deux voies, deux robots : les connaissances paramétriques sont toujours actives, la recherche en temps réel ne se déclenche qu’à la demande.</figcaption>
</figure>
...
Il en va de même pour l’espoir de pouvoir acheter un emplacement publicitaire. OpenAI [a commencé à diffuser des publicités identifiées comme telles aux États-Unis le 9 février 2026](https://help.openai.com/en/articles/20001047-ads-in-chatgpt), a ouvert un gestionnaire de publicités en libre-service au milieu de l’année (OpenAI décrit ce mécanisme comme [une enchère au second prix pondérée par la pertinence](https://help.openai.com/en/articles/20001207-ads-in-chatgpt-the-basics)), puis [a étendu les publicités à 31 marchés européens fin août 2026, dont la France](https://openai.com/index/chatgpt-ads-expands-across-europe/). Mais ces publicités restent dans un encart signalé, distinct de la réponse, jamais à l’intérieur : la documentation d’OpenAI précise qu’elles « peuvent apparaître sous la fin d’une réponse », qu’elles sont « visuellement séparées de la réponse de ChatGPT », et que les annonceurs n’ont « aucune possibilité de façonner, classer ou modifier les réponses de ChatGPT ». En septembre 2026, il n’existe toujours aucune enchère permettant de placer une marque dans le texte généré lui-même. Ce qui s’en rapproche le plus, ce sont les « Sponsored Agents », en test aux États-Unis depuis le 16 septembre 2026 : après un clic sur une publicité, on peut démarrer une conversation distincte et clairement signalée avec l’agent d’une entreprise sponsor, toujours en dehors de la réponse, et toujours après un clic. La réponse est le résultat d’un calcul basé sur des poids et, parfois, d’une requête en temps réel, et il n’y a pas de processus de paiement pour l’un ou l’autre.
...
- The Verge : Sam Altman sur la rumeur des 100 000 milliards de paramètres (janvier 2023) - `theverge.com/2023/1/18/23560328/openai-gpt4-rumor-release-sam-altman-interview`
- OpenAI : Extension des publicités ChatGPT à l’Europe (août 2026) - `openai.com/index/chatgpt-ads-expands-across-europe`
- OpenAI : Politique de confidentialité UE - `openai.com/policies/eu-privacy-policy`
