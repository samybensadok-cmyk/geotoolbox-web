...
- [Vaswani et al. (2017) : « Attention Is All You Need » (l’article sur le Transformer)](https://arxiv.org/abs/1706.03762)
- [Ouyang et al. (2022) : Entraînement de modèles de langage à suivre des instructions grâce à des retours d’information humains (RLHF / InstructGPT)](https://arxiv.org/abs/2203.02155)
- [Stephen Wolfram : Que fait ChatGPT et pourquoi ça marche ?](https://writings.stephenwolfram.com/2023/02/what-is-chatgpt-doing-and-why-does-it-work/)
- [Aide OpenAI : ChatGPT dit-il la vérité ?](https://help.openai.com/en/articles/8313428-does-chatgpt-tell-the-truth)
- [Wikipédia (FR) : GPT-3, 175 milliards de paramètres](https://fr.wikipedia.org/wiki/GPT-3)
- [Wikipedia : GPT-3, architecture (96 couches)](https://en.wikipedia.org/wiki/GPT-3)
- [Siècle Digital : Les publicités arrivent dans ChatGPT (2026)](https://siecledigital.fr/2026/03/30/publicites-sur-chatgpt-deja-100-millions-de-dollars-de-revenus/)
- [The Conversation : Comment fonctionne ChatGPT ? Décrypter son nom pour comprendre les modèles de langage](https://theconversation.com/comment-fonctionne-chatgpt-decrypter-son-nom-pour-comprendre-les-modeles-de-langage-206788)
