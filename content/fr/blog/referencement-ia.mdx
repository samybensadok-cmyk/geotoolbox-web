...
- Les AI Overviews et le Mode IA (AI Mode) de Google sont actifs en France depuis le 22 juillet 2026, après l'accord sur les droits voisins avec la presse française. Suivez aussi vos citations sur ChatGPT, Perplexity, Claude et Mistral Vibe.
...
Sur llms.txt en particulier : Google indique explicitement ne pas l'utiliser comme signal de classement pour la recherche ou les AI Overviews, il ne fera donc pas grimper vos positions ni vos citations ; son propre [guide d'optimisation pour les fonctionnalités d'IA générative](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide) précise que Google Search ignore ces fichiers et que leur présence « ne nuira ni n'aidera » votre visibilité. Mais le 5 mai 2026 (déployé dans Lighthouse 13.3.0), Google a bien ajouté un [audit llms.txt à Chrome Lighthouse](https://developer.chrome.com/docs/lighthouse/agentic-browsing/llms-txt) au titre des bonnes pratiques de navigation agentique. Il vaut la peine de savoir ce que vérifie exactement cet audit : il ne signale une page qu'en cas d'erreur serveur lors de la récupération du fichier ; si le fichier est simplement absent (une 404 classique), l'audit est marqué comme non applicable, car le fichier reste optionnel. Un llms.txt absent ne fait donc pas échouer l'audit Lighthouse. Ajoutez-le comme brique d'infrastructure peu coûteuse pour aider les agents IA à naviguer sur votre site, pas parce que l'audit l'exige ni parce que cela fera bouger votre classement, et faites-le après l'accessibilité et la structure.
...
On ne gère bien que ce que l'on voit, et le référencement IA reste en partie invisible. La Search Console n'a pas commencé à compter le trafic des surfaces IA de Google en juin 2026 : les impressions des AI Overviews et du Mode IA étaient déjà incluses dans le rapport de performance général, au sein du type de recherche « Web ». Ce que Google a [lancé le 3 juin 2026](https://developers.google.com/search/blog/2026/06/gen-ai-performance-reports), c'est une vue distincte dédiée aux fonctionnalités d'IA générative, qui permet enfin de les isoler, avec une limite réelle à connaître avant de s'y fier : elle n'affiche que les impressions, sans clics, sans CTR, sans position moyenne ni détail par requête. Elle couvre la Recherche et Discover, regroupe AI Overviews et Mode IA dans un même bloc qu'on ne peut pas séparer ; le déploiement a commencé par un sous-ensemble de sites et couvre l'ensemble des sites du monde entier depuis le 31 août 2026. Rien d'équivalent n'existe pour les moteurs conversationnels, et le trafic venu d'un outil d'IA atterrit généralement dans vos analytics comme trafic direct ou référent, sans mot-clé associé. Les classements ne disent plus tout, eux non plus : la reconduction 2026 de l'étude Ahrefs, sur des données de décembre 2025, a trouvé que les AI Overviews sont associés à une [baisse de 58 % du taux de clic](https://ahrefs.com/blog/ai-overviews-reduce-clicks-update/) pour le premier résultat organique, contre 34,5 % dans son étude d'avril 2025 : vous pouvez donc garder la première position et perdre quand même du trafic. Vous recoupez alors plusieurs signaux pour dégager une tendance, sans jamais obtenir un comptage exact.

<Callout type="warning" title="En France, les AI Overviews sont là depuis le 22 juillet 2026">
Le déploiement des AI Overviews et du Mode IA (AI Mode) de Google en France était bloqué par le dossier des droits voisins avec la presse française. Le différend s'est réglé fin juin 2026 (lettre officielle de Google aux éditeurs le 29 juin), et le lancement a eu lieu le 22 juillet 2026, avec trois engagements : un mécanisme d'opt-out par site, des statistiques distinctes entre recherche classique et recherche IA, et le maintien de la rémunération au titre des droits voisins pour environ 450 éditeurs français déjà sous accord. Le retard était réglementaire, pas technique : les AI Overviews fonctionnent déjà en français en Belgique et en Suisse depuis mars 2025. Concrètement, le rapport IA de la Search Console va commencer à refléter des données pour les sites français à mesure de la montée en charge : continuez de suivre vos citations sur ChatGPT, Perplexity, Claude et Mistral Vibe, dont le comportement de citation est du même type que celui des AI Overviews désormais actifs.
</Callout>
...
### Les AI Overviews sont-ils actifs en France ?

Oui, depuis le 22 juillet 2026, après l'accord sur les droits voisins avec la presse française conclu fin juin. La montée en charge est progressive : suivez aussi vos citations directement sur ChatGPT, Perplexity, Claude et Mistral Vibe, dont le comportement de citation est du même type.
...
- Guide d'optimisation pour les fonctionnalités d'IA générative dans la recherche Google - Google Search Central - `developers.google.com/search/docs/fundamentals/ai-optimization-guide`
...
- Les AI Overviews réduisent les clics (étude originale) - Ahrefs, avril 2025 - `ahrefs.com/blog/ai-overviews-reduce-clicks`
- Introducing Search Generative AI performance reports in Search Console - Google Search Central, 3 juin 2026 - `developers.google.com/search/blog/2026/06/gen-ai-performance-reports`
