...
- [Comet (navigateur)](https://en.wikipedia.org/wiki/Comet_(browser)) - Wikipédia (moteur, dates de lancement par plateforme)
- [Comet, le navigateur IA de Perplexity, désormais gratuit](https://www.blogdumoderateur.com/comet-navigateur-ia-perplexity-gratuit/) - Blog du Modérateur
- [On a testé Comet, le navigateur du futur par Perplexity](https://www.clubic.com/actualite-578316-on-a-teste-comet-le-navigateur-du-futur-par-perplexity-ai.html) - Clubic
- [Comet AI browser now free; Max users get a Background Assistant](https://techcrunch.com/2025/10/02/perplexitys-comet-ai-browser-now-free-max-users-get-new-background-assistant/) - TechCrunch
- [Sécurité des navigateurs agentiques : injection indirecte de prompt dans Comet](https://brave.com/blog/comet-prompt-injection/) - Brave
- [CometJacking : un clic peut retourner Comet contre vous](https://layerxsecurity.com/blog/cometjacking-how-one-click-can-turn-perplexitys-comet-ai-browser-against-you/) - LayerX
- [Comet jusqu'à 85 % plus vulnérable au phishing que Chrome](https://layerxsecurity.com/fr/blog/layerx-finds-that-perplexitys-comet-browser-is-up-to-85-more-vulnerable-to-phishing-and-web-attacks-than-chrome/) - LayerX (FR)
- [Audit de Comet par modélisation des menaces et injection de prompt](https://blog.trailofbits.com/2026/02/20/using-threat-modeling-and-prompt-injection-to-audit-comet/) - Trail of Bits
- [PleaseFix : détournement d'agent zero-click dans Comet](https://zenity.io/research/pleasefix-vulnerabilities) - Zenity Labs
- [Qu'est-ce que Perplexity Comet et pourquoi est-il sur mon site ?](https://www.humansecurity.com/ai-agent/perplexity-comet/) - HUMAN Security
- [Amazon fait bloquer l'agent IA de Perplexity par la justice](https://siecledigital.fr/2026/03/10/amazon-bloque-lagent-ia-de-perplexity-devant-la-justice/) - Siècle Digital
- [Amazon adresse des menaces juridiques à Perplexity](https://techcrunch.com/2025/11/04/amazon-sends-legal-threats-to-perplexity-over-agentic-browsing/) - TechCrunch
- [OpenAI lance un navigateur IA : ChatGPT Atlas](https://techcrunch.com/2025/10/21/openai-launches-an-ai-powered-browser-chatgpt-atlas/) - TechCrunch
- [Navigateur Comet : l'aspirateur à données personnelles assumé](https://www.roboto.fr/blog/navigateur-comet-de-perplexity-l-aspirateur-donn-es-personnelles-assum-) - Roboto.fr
- [L'État français déploie l'IA de Mistral auprès d'un million de fonctionnaires](https://www.channelnews.fr/letat-francais-deploie-mistral-ai-aupres-dun-million-de-fonctionnaires-et-inclut-la-souverainete-numerique-dans-les-objectifs-2026-2029-de-lugap-157317) - ChannelNews
- [AI Act, article 50 : obligation de transparence](https://artificialintelligenceact.eu/article/50/) - EU AI Act
