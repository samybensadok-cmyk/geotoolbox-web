...
### Perplexity Comet est-il sûr ?
Pour de la lecture et du résumé à faible enjeu, le risque est modéré. Pour les tâches agentiques, soyez prudent. Des chercheurs de Brave, LayerX, Trail of Bits, Zenity, Guardio et Hacktron ont tous démontré des attaques par injection de prompt, où des instructions cachées dans une page détournent l'assistant. Évitez de lancer l'agent dans des sessions avec des données bancaires, médicales ou professionnelles tant que le problème n'est pas mieux maîtrisé.
