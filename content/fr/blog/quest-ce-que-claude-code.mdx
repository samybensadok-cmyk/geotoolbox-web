...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>Mode rapide</strong></td><td>10 $ / 50 $ par million de tokens (entrée / sortie), pour Opus 4.8</td><td>Préversion de recherche, forfaits à la consommation</td></tr>
  </tbody>
</table>
