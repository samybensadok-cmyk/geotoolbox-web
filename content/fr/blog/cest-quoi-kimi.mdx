...
- [Dépôt Kimi K2 (spécifications et licence)](https://github.com/moonshotai/kimi-k2) - Moonshot AI, 2025
- [Fiche et licence du modèle Kimi K2-Instruct](https://huggingface.co/moonshotai/Kimi-K2-Instruct) - Moonshot AI (Hugging Face)
- [Benchmarks Kimi K2 Thinking](https://huggingface.co/moonshotai/Kimi-K2-Thinking) - Moonshot AI (Hugging Face), 2025
- [Kimi, un assistant IA open source aux capacités avancées](https://www.blogdumoderateur.com/tools/kimi/) - Blog du Modérateur
- [Moonshot AI lance Kimi K2.6, un modèle open source](https://intelligence-artificielle.developpez.com/actu/382470/) - Developpez.com
- [Présentation de Moonshot AI](https://en.wikipedia.org/wiki/Moonshot_AI) - Wikipédia
- [Moonshot AI lève 2 milliards de dollars pour une valorisation de 20 milliards](https://techcrunch.com/2026/05/07/chinas-moonshot-ai-raises-2b-at-20b-valuation-as-demand-for-open-source-ai-skyrockets/) - TechCrunch, mai 2026
...
- [Incident d'exposition de données entre utilisateurs de Kimi](https://oecd.ai/en/incidents/2026-04-21-8c79) - Observatoire des incidents de l'OCDE.AI, avril 2026
- [Évaluation indépendante de la sécurité de Kimi K2.5](https://arxiv.org/abs/2604.03121) - arXiv, avril 2026
