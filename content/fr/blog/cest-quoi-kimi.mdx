...
<figure className="not-prose my-8">
  <BlogImage src="/blog/what-is-kimi-ai/kimi-app-vs-open-weights.png" alt="Deux cartes opposant l'application Kimi fermée de Moonshot aux poids ouverts du modèle Kimi K2." w="1100" h="646" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">La distinction clé de Kimi : l'application et l'API sont fermées, tandis que les poids du modèle K2 sont ouverts et exécutables par tous.</figcaption>
</figure>
...
<tr><td><strong>Kimi K3</strong></td><td>Juillet 2026</td><td>Le nouveau modèle général de référence : MoE de 2 800 milliards de paramètres, contexte d'un million de tokens</td></tr>
</tbody>
</table>
