...
<tr><td><strong>Kimi K2.6</strong></td><td>Avril 2026</td><td>Le modèle général de référence actuel : plus rapide, agents et codage front-end renforcés</td></tr>
...
<tr><td><strong>API</strong></td><td>Modèle actuel K2.6 : env. 0,95 $ en entrée / 4,00 $ en sortie par million de tokens</td><td>Intégrez Kimi à vos applications ; API compatible OpenAI</td></tr>
