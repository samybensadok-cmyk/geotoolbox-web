...
On parle d'hallucination de l'IA lorsqu'un modèle de langage génère des informations fausses ou inventées et les présente comme des faits. La cause est structurelle : un grand modèle de langage [prédit un texte probable](https://geotoolbox.ai/blog/how-does-chatgpt-work). Il ne vérifie pas la véracité de ses affirmations. [OpenAI l'explique](https://openai.com/index/why-language-models-hallucinate/) sans détour : les modèles « devinent » parce que leur entraînement et leurs tests les récompensent lorsqu'ils tentent une réponse plutôt que d'admettre une incertitude.
