...
<tr><td>Les sections autonomes survivent mieux à l'extraction</td><td><strong>Mécanisme confirmé</strong></td><td>Un passage récupéré se lit hors de son environnement ; un passage qui dépend d'un « comme mentionné plus haut » arrive brisé. C'est de la logique de récupération, pas un résultat d'étude</td></tr>
