...
date: "2026-08-07"
updated: "2026-09-17"
recheckBy: "2026-11-05"  # backfilled 2026-09-05 freshness audit (no prior guard); tarifs et quotas Semrush/Ahrefs. Revérifier les grilles publiques des deux éditeurs
...
- **Semrush a poussé plus loin l'intégration de la visibilité IA dans sa plateforme** : son kit coûte 99 $/mois par domaine, là où chez Ahrefs la visibilité IA démarre à 50 $/mois pour le suivi de prompts personnalisés (puis 100 et 250 $/mois), et l'index de visibilité IA se facture à partir de 199 $/mois par plateforme, ou 699 $/mois pour toutes les plateformes.
...
<Callout type="note" title="Mise à jour, septembre 2026">
geotoolbox.ai a continué de grandir depuis ce test. À la mi-septembre, Ahrefs recense 194 mots-clés organiques (environ 4,6 fois le chiffre de juillet) et Semrush environ 5 300 (contre ~1 500) : le même écart qui s'élargit, mais à une plus grande échelle. Les clics réels de la Google Search Console sont passés de 382 par mois à environ 3 700. Le retournement : c'est désormais l'estimation d'Ahrefs qui tombe presque exactement sur ce chiffre réel, tandis que celle de Semrush est passée en dessous, un rappel que l'outil le plus proche de la réalité n'est pas figé, il peut changer à mesure qu'un site mûrit. Le reste de cet article, y compris le test de douze jours ci-dessous, reflète le relevé original de juillet-août 2026 ; nous laissons ces chiffres comme exemple méthodologique plutôt que de réécrire toute la démarche autour d'une cible mouvante.
</Callout>
...
Ahrefs répond avec Brand Radar, et sur la couverture brute des moteurs, c'est en fait le plus large des deux : il indexe le même ensemble ChatGPT / Aperçus IA / Mode IA / Gemini / Perplexity, plus Microsoft Copilot (et, gratuites pendant la période bêta, les surfaces de découverte YouTube, TikTok et Reddit), adossé à un index qu'Ahrefs annonce à plus de 456 millions de prompts mensuels en date de septembre 2026, avec sa propre comparaison de concurrents et son suivi de prompts personnalisés. Cette largeur s'accompagne de deux bémols : Grok n'apparaît plus sur la page produit actuelle de Brand Radar (la documentation d'aide d'Ahrefs mentionne toujours son index comme en pause), et Claude n'est disponible que pour le suivi de prompts personnalisés, pas comme l'une des six plateformes pleinement indexées — ses requêtes consomment aussi des vérifications supplémentaires. Là où Brand Radar perd, c'est sur la présentation et le prix.
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Coût réel d'utilisation</td><td><strong>99 $/mois par domaine</strong> (même prix mensuel ou annuel), ou inclus dans les offres Semrush One (Starter, Pro+, Advanced)</td><td>Petit quota quotidien désormais inclus dès l'offre Lite ; suivi de prompts personnalisés en paliers à partir de <strong>50 $/mois</strong> (puis 100 et 250 $/mois), ou l'<strong>index de visibilité IA à partir de 199 $/mois par plateforme</strong> — 699 $/mois pour toutes les plateformes</td></tr>
  </tbody>
</table>

Deux réserves avant de lire ce tableau comme un carton plein de Semrush. D'abord, le kit de Visibilité IA se vend à part (il n'est pas fondu dans SEO, Guru ni Business) : c'est une vraie ligne sur la facture ; là où il gagne, c'est sur la présentation et le prix d'entrée de la suite de visibilité complète, pas sur une couverture de moteurs plus large. Les unités diffèrent aussi : les 99 $ de Semrush sont par domaine et se multiplient sur un portefeuille de clients, tandis que Brand Radar d'Ahrefs facture son offre d'entrée de suivi de prompts personnalisés à 50 $/mois (puis 100 et 250 $/mois) et son index de visibilité IA à partir de 199 $/mois par plateforme, ou 699 $/mois pour toutes les plateformes. Une agence multimarque doit faire ses propres calculs. Ensuite, les deux outils modélisent la visibilité IA avec des prompts simulés plutôt qu'en observant de vraies sessions d'utilisateurs : traitez leurs scores comme vous traitez leurs estimations de trafic, excellents pour votre propre tendance et pour comparer des concurrents, pas un décompte littéral de chaque fois qu'un humain a vu votre nom. (Une petite réserve tirée de notre propre compte : le panneau Distribution par LLM du kit affichait des données pour quatre des cinq moteurs documentés, Perplexity n'ayant encore rien pour notre domaine.)
...
Oui. Le kit de Visibilité IA de Semrush suit comment votre marque apparaît sur ChatGPT, le Mode IA et les Aperçus IA de Google, Gemini et Perplexity, avec un score de visibilité IA, une part de voix, Prompt Research, un détail des sources citées et un suivi quotidien de 25 prompts personnalisés pour comparer les concurrents. Il est facturé à part (99 $/mois par domaine, au même prix mensuel ou annuel, ou inclus dans les offres Semrush One — Starter, Pro+ et Advanced), il ne fait pas partie des offres SEO standard. Ahrefs propose un suivi similaire via Brand Radar sur un ensemble de moteurs encore plus large (il ajoute Copilot, plus les surfaces de découverte gratuites pendant la bêta YouTube, TikTok et Reddit, et Claude pour le suivi de prompts personnalisés uniquement) ; chaque offre Ahrefs à partir de Lite inclut désormais un petit quota quotidien de prompts, avec un suivi de prompts personnalisés à partir de 50 $/mois et un index de visibilité IA à partir de 199 $/mois par plateforme, ou 699 $/mois pour toutes les plateformes.
...
- Fonctionnalités Semrush pour la visibilité IA (couverture des moteurs par offre) - Semrush, vérifié le 17 septembre 2026 - `semrush.com/kb/1626-ai-visibility-features`
...
{/* date-ok: date la mise à jour de la source Style Factory citée, pas la fraîcheur de cet article */}
- Ahrefs vs Semrush (2026) : lequel utiliser ? (test de domaines référents sur 10 domaines) - Style Factory, mis à jour le 2 septembre 2026 - `stylefactoryproductions.com/blog/ahrefs-vs-semrush`
