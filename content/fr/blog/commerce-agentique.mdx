...
- Le vrai levier français est arrivé : depuis le 22 juillet 2026, après l'accord sur les droits voisins de fin juin, le Mode IA et les AI Overviews de Google sont déployés en France.
...
<Callout type="tip" title="Nouveau en France : la découverte par IA est là">
Le contexte français a basculé en 2026. Après l'accord sur les droits voisins conclu fin juin, Google a déployé le **Mode IA (AI Mode)** et les **AI Overviews** en France le 22 juillet 2026. La couche « découverte » par IA est donc un enjeu concret pour les marques françaises, bien avant que le paiement agentique n'arrive ici.
</Callout>
...
Partiellement. La découverte par IA (comparer des produits, être recommandé dans ChatGPT, Gemini ou Perplexity) fonctionne déjà, et le Mode IA de Google est déployé en France depuis le 22 juillet 2026. En revanche le paiement autonome de bout en bout n'est pas encore ouvert aux marchands ni aux consommateurs français : le RGPD, la DSP2 (authentification forte) et le règlement européen sur l'IA en freinent le déploiement, car sans mécanisme fiable de consentement ou de mandat pré-autorisé, un agent ne peut pas être présumé autorisé à payer. Aujourd'hui, l'enjeu français est d'être trouvable et compréhensible, pas payable dans un agent.
