...
Les grands produits d'IA intègrent désormais des modes « agent ». [Google Gemini](https://geotoolbox.ai/blog/what-is-gemini) et ChatGPT disposent tous deux de modes qui naviguent et agissent. Claude, d'Anthropic, sait piloter un ordinateur et écrire du code à l'échelle d'un projet. [Microsoft Copilot](https://geotoolbox.ai/blog/what-is-copilot), Salesforce Agentforce et Perplexity font tourner des agents qui exécutent des tâches, et des plateformes comme [Microsoft Copilot Studio](https://geotoolbox.ai/blog/copilot-studio) permettent aux entreprises de créer les leurs. Même Apple s'y est mis : en 2026, la marque a doté son assistant de la capacité d'agir pour le compte de l'utilisateur et d'enchaîner des tâches à sa place, au lieu de seulement répondre.
