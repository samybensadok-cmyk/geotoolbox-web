...
- [IA constitutionnelle : l'innocuité à partir de retours d'IA](https://www.anthropic.com/research/constitutional-ai-harmlessness-from-ai-feedback) - Anthropic, 2022
- [La Constitution de Claude](https://www.anthropic.com/news/claudes-constitution) - Anthropic, 2023 (mise à jour 2026)
- [Attention Is All You Need (l'article sur le Transformer)](https://arxiv.org/abs/1706.03762) - Vaswani et al., 2017
- [Mapping the Mind of a Large Language Model](https://www.anthropic.com/news/mapping-mind-language-model) - Anthropic, 2024
...
- [Présentation des modèles Claude](https://platform.claude.com/docs/en/about-claude/models/overview) - Anthropic
- [Déclaration d'Anthropic sur la suspension de Fable 5 et Mythos 5](https://www.anthropic.com/news/fable-mythos-access) - Anthropic, juin 2026
- [CNIL : s'opposer à la réutilisation de ses données pour l'entraînement d'un agent conversationnel](https://www.cnil.fr/fr/ia-comment-sopposer-la-reutilisation-de-ses-donnees-personnelles-entrainement-agent-conversationnel) - CNIL
