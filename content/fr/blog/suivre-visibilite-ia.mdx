...
- En France, la méthode de suivi la plus citée (le canal AI Assistants de GA4, lancé le 13 mai 2026) s'appuie sur un outil dont l'usage a déjà valu trois sanctions de la CNIL pour des transferts de données vers les États-Unis, avec des contrôles renforcés et des amendes qui grimpent jusqu'à 300 000 € en 2026.
- Les AI Overviews et le Mode IA (AI Mode) de Google sont déployés en France depuis le 22 juillet 2026, avec une montée en charge progressive, une fois réglée la question des droits voisins avec la presse. Suivre ChatGPT et Perplexity reste prioritaire, mais Google entre désormais dans l'équation française.
...
<table>
  ...
  <tbody>
    <tr><td><a href="https://geotoolbox.ai/blog/ai-share-of-voice">Part de voix</a></td><td>La fréquence à laquelle vous apparaissez face à vos concurrents, sur un ensemble de prompts</td><td>Lancez des prompts, divisez vos mentions par le total, ou utilisez un <a href="https://geotoolbox.ai/blog/ai-rank-tracker">outil de suivi de classement IA</a></td><td>Le nombre dépend entièrement des prompts choisis</td></tr>
    ...
    <tr><td>Trafic référent IA</td><td>Les visites qui proviennent réellement d'outils IA</td><td>Le canal AI Assistants de GA4, complété par des règles de référent</td><td>Largement sous-évalué (voir plus loin)</td></tr>
...
D'abord, les réponses ne sont pas déterministes. Posez la même question deux fois au même modèle et la liste de marques peut changer du tout au tout. [SparkToro a fait tourner 12 prompts 2 961 fois](https://sparktoro.com/blog/new-research-ais-are-highly-inconsistent-when-recommending-brands-or-products-marketers-should-take-care-when-tracking-ai-visibility/), via 600 volontaires, sur ChatGPT, Claude et les AI Overviews de Google : pour ChatGPT et l'IA de Google, la probabilité d'obtenir deux fois la même liste de marques tombe sous 1 sur 100, et sous 1 sur 1 000 pour le même ordre. Claude redonne un peu plus souvent la même liste, mais se montre encore moins régulier sur l'ordre.
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/how-to-track-ai-visibility/free-ai-visibility-method.png" alt="Cinq étapes pour suivre gratuitement sa visibilité IA, des prompts jusqu'à la part de voix." w="1100" h="572" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Toute la méthode gratuite en cinq étapes — c'est la régularité des passages mensuels qui donne du sens aux chiffres (moteurs illustrés côté US ; en France, ajoutez Vibe).</figcaption>
</figure>
...
Le premier, c'est le **trafic référent IA**, et GA4 fait maintenant une partie du travail à votre place. Depuis le 13 mai 2026, quand le référent correspond à un assistant reconnu, GA4 attribue automatiquement à la visite un support (medium) « ai-assistant » et la regroupe dans le canal [AI Assistants](https://support.google.com/analytics/answer/9756891) du regroupement de canaux par défaut, un libellé que la documentation française n'a pas encore traduit. La liste des assistants reconnus s'est élargie depuis le lancement : Google cite désormais ChatGPT, Gemini, DeepSeek, Copilot et Grok à titre d'exemples, mais Perplexity en reste toujours absent au 3 juillet 2026 ; gardez donc un segment de référent dédié à perplexity.ai en plus du canal natif. Attendez-vous à un chiffre à la fois faible et sous-évalué : le [benchmark de Conductor](https://www.conductor.com/academy/aeo-geo-benchmarks-report/) sur 1 215 domaines d'entreprise situe le trafic référent IA à 1,08 % de l'ensemble du trafic web sur dix secteurs clés, dont 87,4 % en provenance de ChatGPT, avec une croissance d'environ 1 % par mois, sur du trafic américain mesuré de mai à septembre 2025. Et quand un modèle supprime le référent, la visite atterrit silencieusement en « Direct » : traitez donc ce que vous voyez comme un plancher, pas un décompte complet.
...
<Callout type="tip" title="Nouveau en France : le Mode IA de Google est arrivé">
Les AI Overviews et le Mode IA (AI Mode) de Google sont déployés en France depuis le 22 juillet 2026, avec une montée en charge progressive, une fois réglée la question des droits voisins avec la presse française (environ 450 éditeurs concernés). Concrètement : suivre ChatGPT et Perplexity reste essentiel, et les rapports IA générative de Search Console vont commencer à se remplir côté France à mesure du déploiement. Ce chantier n'est plus à préparer : il est ouvert.
</Callout>
...
- The 2026 AEO / GEO Benchmarks Report - Conductor, mise à jour du 6 juillet 2026 (1 215 domaines d'entreprise ; trafic États-Unis, dix secteurs clés, mai-septembre 2025) - `conductor.com/academy/aeo-geo-benchmarks-report`
