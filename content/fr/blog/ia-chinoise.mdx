...
date: "2026-07-20"
updated: "2026-08-14"
recheckBy: "2026-09-14"  # poids Qwen3.8-Max publies 12/08 (texte seul, licence maison; ligne+section+alt mis a jour 14/08). PENDING piste freshness : ligne Kimi K2.6 -> K3 + regen open-vs-closed.png (capture juin 2026, desormais datee)
...
[Le modèle phare actuel de DeepSeek](https://geotoolbox.ai/blog/what-is-deepseek) est [V4](https://geotoolbox.ai/blog/deepseek-v4), dont [TechCrunch a révélé la préversion fin avril 2026](https://techcrunch.com/2026/04/24/deepseek-previews-new-ai-model-that-closes-the-gap-with-frontier-models/), bâti sur la même architecture en mélange d'experts, sobre en calcul, qui a fait la réputation du laboratoire ; sa disponibilité générale est effective depuis le 20 juillet 2026. Il excelle en raisonnement et en code agentique, et côté prix, il est quasiment imbattable : le palier Flash tourne autour de 0,14 $ par million de tokens en entrée, là où les modèles occidentaux de pointe facturent plusieurs dollars. Au 8 août 2026, ces tarifs s'appliquent à toute heure, sans tarif réduit en heures creuses, mais la page tarifaire de DeepSeek prévient qu'une hausse générale « significative » est à prévoir, sous réserve d'une annonce officielle. Si votre question est « quel modèle chinois offre le meilleur rapport entre performances et coût », DeepSeek est généralement la réponse, et c'est là que la plupart des comparatifs entre DeepSeek et Qwen se jouent, sur le seul critère du prix.
