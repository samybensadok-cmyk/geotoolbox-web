...
date: "2026-07-20"
updated: "2026-08-19"
recheckBy: "2026-09-14"  # poids Qwen3.8-Max publies 12/08 (texte seul, licence maison; ligne+section+alt mis a jour 14/08). Prix DeepSeek mis a jour 18/08 (tarification heures pleines/creuses arrivee le 16/08) -- ce fichier avait ete manque par le sweep DeepSeek du 08-14/08-18, aucun jumeau ES n'existe. open-vs-closed.png REGENERE le 19/08 (date aout 2026, distinction texte-ouvert/multimodal-ferme de Qwen3.8-Max, Kimi->K3, alt+legende reecrits). GLM reste a 5.2 dans le graphique volontairement : poids ouverts GLM-5.3 pas publics avant ~28/08 (verifie HF zai-org 19/08). PENDING : ligne "Kimi K2" du tableau en prose -> K3 (item freshness distinct)
