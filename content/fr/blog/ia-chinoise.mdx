...
date: "2026-07-20"
updated: "2026-08-18"
recheckBy: "2026-09-14"  # poids Qwen3.8-Max publies 12/08 (texte seul, licence maison; ligne+section+alt mis a jour 14/08). Prix DeepSeek mis a jour 18/08 (tarification heures pleines/creuses arrivee le 16/08) -- ce fichier avait ete manque par le sweep DeepSeek du 08-14/08-18, aucun jumeau ES n'existe. PENDING piste freshness : ligne Kimi K2.6 -> K3, GLM-5.3 (sorti 08-14, pas encore reflete), + regen open-vs-closed.png (capture juin 2026, desormais datee)
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/chinese-ai-models-compared/open-vs-closed.png" alt="La plupart des modèles d'IA chinois de pointe sont publiés en poids ouverts, téléchargeables et auto-hébergeables ; sur cette capture de juin 2026, le modèle phare de Qwen, l'Ernie 5.1 de Baidu et le Doubao de ByteDance restent en API fermée (depuis le 12 août 2026, le dernier Qwen Max publie des poids texte seul sous licence maison)." w="2200" h="1470" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Les téléchargements ouverts couvrent quatre modèles phares actuels ainsi que les déclinaisons ouvertes des gammes Qwen et Ernie ; le modèle phare de Qwen, l'Ernie 5.1 de Baidu et le Doubao de ByteDance restent fermés.</figcaption>
</figure>
