...
<tr><td><strong>DeepSeek-V4</strong> (aperçu ; version stable prévue mi-juillet 2026)</td><td>Avril 2026</td><td>V4-Pro (1 600 milliards de paramètres au total / 49 milliards actifs) et V4-Flash (284 milliards / 13 milliards actifs), tous deux avec un contexte de 1 million de tokens</td></tr>
</tbody>
</table>

Quelques points à retenir. La plupart de ces modèles sont de type « mélange d'experts » (mixture-of-experts, ou MoE) : ils comportent un nombre considérable de paramètres, mais n'en activent qu'une petite partie pour chaque [token](https://geotoolbox.ai/blog/what-are-tokens-in-ai), ce qui explique leur faible coût d'exécution. Le grand saut d'avril 2026 a été l'[aperçu de V4](https://api-docs.deepseek.com/news/news260424), qui a porté la fenêtre de contexte à un million de tokens et donné naissance à deux modèles distincts : un modèle Flash rapide et un modèle Pro plus lourd, tous deux publiés en poids ouverts sous licence MIT.
