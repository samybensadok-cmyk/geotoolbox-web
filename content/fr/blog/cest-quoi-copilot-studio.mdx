...
Ce ne sont pas des cas d'école. Au Royaume-Uni, la National Zakat Foundation a construit un agent Copilot Studio qui classe les demandes d'aide par urgence, et avec l'automatisation qui l'entoure [a réduit de 80 % les délais d'attente pour le versement des aides](https://www.microsoft.com/en/customers/story/23068-national-zakat-foundation-microsoft-copilot-studio), des délais qui prenaient auparavant quatre à cinq mois, sur environ 10 000 demandes d'aide traitées chaque mois.
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>Préachat (CCCU)</strong></td><td>Engagement annuel, jusqu'à 20 % de remise</td><td>Déploiements importants et engagés</td></tr>
...
- [Présentation de Copilot Studio, Microsoft Learn (FR)](https://learn.microsoft.com/fr-fr/microsoft-copilot-studio/fundamentals-what-is-copilot-studio)
- [Tarifs de facturation et gestion, Microsoft Learn (FR)](https://learn.microsoft.com/fr-fr/microsoft-copilot-studio/requirements-messages-management)
- [Licences Copilot Studio, Microsoft Learn (FR)](https://learn.microsoft.com/fr-fr/microsoft-copilot-studio/billing-licensing)
- [Tarifs de Microsoft Copilot Studio (FR)](https://www.microsoft.com/fr-fr/microsoft-365-copilot/pricing/copilot-studio)
- [Estimateur d'utilisation des agents Copilot Studio, Microsoft](https://microsoft.github.io/copilot-studio-estimator/)
- [Témoignage client National Zakat Foundation, Microsoft](https://www.microsoft.com/en/customers/story/23068-national-zakat-foundation-microsoft-copilot-studio)
- [L'intelligence artificielle, CNIL](https://www.cnil.fr/fr/intelligence-artificielle)
...
- [Discussion communautaire r/copilotstudio, Reddit](https://www.reddit.com/r/copilotstudio/comments/1ip7y97/what_is_your_experience_with_copilot_studio_does/)
