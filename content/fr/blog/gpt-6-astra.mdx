...
GPT-6 Astra est le [grand modèle de langage](https://geotoolbox.ai/blog/how-does-chatgpt-work) frontière d'OpenAI, sorti le 3 septembre 2026 en tant que successeur de GPT-5.6 Sol. Les développeurs y accèdent dans l'API sous le nom `gpt-6-astra`.
