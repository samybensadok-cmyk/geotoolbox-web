...
GPT-6 Astra est le [grand modèle de langage](https://geotoolbox.ai/blog/how-does-chatgpt-work) frontière d'OpenAI, sorti le 3 septembre 2026 en tant que modèle frontière au-dessus de la gamme GPT-5.6 (le successeur direct de GPT-5.6 Sol est GPT-6 Sol, pas Astra). Les développeurs y accèdent dans l'API sous le nom `gpt-6-astra`.
...
Si le cadre [agentique](https://geotoolbox.ai/blog/agentic-ai) vous est nouveau, disons simplement qu'Astra est un [modèle de raisonnement](https://geotoolbox.ai/blog/how-ai-models-think) avec une bien plus grande autonomie que la [famille GPT-5.6](https://geotoolbox.ai/blog/gpt-5-6) qu'il remplace.
...
La page de tarification ne précise jamais où s'arrête le contexte court et où commence le contexte long, mais la fiche du modèle le fait : **au-delà de 272 000 tokens en entrée, la requête entière est facturée à 2 fois le tarif d'entrée et de cache, et 1,5 fois le tarif de sortie**. Cette seule règle reproduit toute la ligne « contexte long », et c'est le chiffre à retenir pour modéliser un budget API. Les écritures en cache sont facturées à 1,25 fois le tarif d'entrée non mis en cache, et Flex, comme Batch, revient à 50 %. Pour une vue d'ensemble sur les [coûts en tokens](https://geotoolbox.ai/blog/ai-token-cost) selon les fournisseurs, et ce que coûte réellement une [fenêtre de contexte](https://geotoolbox.ai/blog/how-does-ai-search-work), ces deux lectures complètent bien celle-ci.

## GPT-6 Sol et GPT-6 Luna rejoignent la famille

Astra est sorti seul le 3 septembre. Trois semaines plus tard, le 22 septembre 2026, OpenAI a ajouté deux nouveaux modèles GPT-6 : **GPT-6 Sol** et **GPT-6 Luna**. Contrairement à Astra, aucun des deux n'est un modèle de pointe. La formulation d'OpenAI est explicite : « GPT-6 Astra continues to be our best model across the board ». Sol et Luna remplacent plutôt [GPT-5.6 Sol et Luna](https://geotoolbox.ai/blog/gpt-5-6) comme paliers de travail et rapide au sein de ChatGPT Work et Codex, pour les formules Plus, Pro, Business, Enterprise et Edu. Free et Go n'ont GPT-6 Luna que dans l'application de bureau, pas dans le chat classique.

Sur l'API, GPT-6 Sol coûte 2,00 $ en entrée et 10,00 $ en sortie par million de tokens, GPT-6 Luna 0,10 $ et 0,50 $, soit chacun environ la moitié du tarif promotionnel de son équivalent GPT-5.6 (4 $/20 $ pour Sol, 0,20 $/1,20 $ pour Luna) et une fraction des 10,00 $/50,00 $ d'Astra. Un chat ChatGPT classique tourne toujours sur GPT-5.6 à l'heure où ces lignes sont écrites, pas sur GPT-6 Sol ou Luna. Trois semaines après son lancement, la famille GPT-6 se compose donc d'un modèle de pointe (Astra) et de deux modèles de travail (Sol, Luna) situés en dessous, en prix comme en périmètre produit.
...
**Mise à jour du 25 septembre 2026 :** Artificial Analysis a de nouveau republié une version de son Intelligence Index, désormais **v4.3.2**. Sur cette échelle, Astra obtient **53**, à égalité avec Claude Fable 5.1, tandis que **Claude Opus 5.5** mène l'indice général avec **58**. Les chiffres v4.1.1 et v4.2 ci-dessus correspondent chacun à l'échelle de leur jour, pas à celle-ci : Artificial Analysis révise ses évaluations et sa notation d'une version de l'indice à l'autre (la v4.3.2 a réancré et réajusté deux de ses tests notés par classement), donc des scores de versions différentes ne sont jamais directement comparables, seul le classement relatif au sein d'une même version l'est.
...
<table>
  ...
  <tbody>
    ...
    <tr><td>AA Intelligence Index v4.3.2</td><td>53</td><td>53 (à égalité)</td><td>Indépendant</td></tr>
...
Fable 5.1 menait l'indice d'intelligence générale au lancement (v4.2) ; sur la révision actuelle, v4.3.2, les deux sont à égalité à 53, tandis que Claude Opus 5.5 mène désormais l'indice général avec 58. Fable 5.1 garde une meilleure économie de cache, à un quart du tarif d'entrée en cache d'Astra, ce qui compte beaucoup pour des boucles d'agent qui relisent sans cesse le même contexte.
...
Pour la mécanique derrière tout cela, voir [comment fonctionne la recherche ChatGPT](https://geotoolbox.ai/blog/how-chatgpt-search-works), ce qu'est une [citation IA](https://geotoolbox.ai/blog/how-to-get-cited-by-ai), et notre définition de la [visibilité IA](https://geotoolbox.ai/blog/what-is-ai-visibility).

## Foire aux questions

### GPT-6 est-il sorti ?

Oui. OpenAI a lancé GPT-6 Astra le 3 septembre 2026 en préversion limitée pour des partenaires de confiance, puis sur les forfaits ChatGPT payants à partir du 4 septembre, en commençant par Pro, Enterprise et Business Premium, avant d'atteindre Plus dans ChatGPT Work et Codex plus tard le même jour. Astra est la version de pointe de GPT-6 ; le 22 septembre 2026, OpenAI a ajouté deux autres modèles GPT-6, Sol et Luna, comme modèles de travail au sein de ChatGPT Work et Codex, en dessous d'Astra en prix comme en périmètre.

### Qu'est-ce que GPT-6 Astra ?

C'est le modèle frontière d'OpenAI, au-dessus de GPT-6 Sol et Luna, conçu pour du travail agentique de long terme et l'usage d'un ordinateur, plutôt que pour la conversation. Dans l'API, il porte le nom `gpt-6-astra`.
