...
date: "2026-07-22"
updated: "2026-08-14"
recheckBy: "2026-09-14"  # poids Qwen3.8-Max publiés le 12/08/2026 (HF Qwen/Qwen3.8-2.4T-A95B, vérifié en direct le 14/08) : texte seul, contexte natif 262 144 tokens, licence maison « Qwen3.8-Max » (pas Apache 2.0). À re-vérifier : conditions précises de la licence, éventuelle variante multimodale/27B, et le PNG qwen-open-family-closed-flagship.png (régénéré le 14/08)
...
Ce bémol a pris de l'ampleur, avant de se résorber en partie. La génération 3.7 est restée fermée : Qwen3.7-Max en mai 2026 et Qwen3.7-Plus début juin, tous deux uniquement via l'API, et leurs poids ne sont jamais venus. Qwen3.8-Max semblait devoir suivre, jusqu'au 12 août 2026, date à laquelle Alibaba a publié ses poids (texte seul, sous licence maison « Qwen3.8-Max », pas Apache 2.0) : le premier Max ouvert, même si la version multimodale complète reste API uniquement. Pour la 3.6, les poids avaient suivi l'API en quelques semaines ; la génération 3.7 ne les a jamais eus. Le modèle de milieu de gamme vers lequel se tourneraient la plupart des développeurs reste donc fermé, alors même que le modèle phare s'est en partie ouvert. En revanche, Alibaba n'a pas ralenti ses publications ouvertes ailleurs, avec des poids sous Apache 2.0 pour des modèles d'agents, d'embedding et de robotique tout au long de juin et juillet 2026.
