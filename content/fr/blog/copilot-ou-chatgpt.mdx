...
<tbody>
<tr><td><strong>Gratuit</strong></td><td>0 € : chat, réponses web avec citations, génération d'images, voix</td><td>0 € : GPT-5.6 (Terra), limites plus strictes</td></tr>
...
- [Tarifs et forfaits Microsoft 365 Copilot](https://www.microsoft.com/fr-fr/microsoft-365-copilot/enterprise) : tarification entreprise et business
- [Découvrez Microsoft 365 Premium](https://www.microsoft.com/fr-fr/microsoft-365/blog/2025/10/01/meet-microsoft-365-premium-your-ai-and-productivity-powerhouse/) : offre grand public remplaçant Copilot Pro
- [Élargissement du choix de modèles dans Microsoft 365 Copilot](https://www.microsoft.com/fr-fr/microsoft-365/blog/2025/09/24/expanding-model-choice-in-microsoft-365-copilot/) : les modèles Claude d'Anthropic dans Copilot
- [Copilot Cowork est disponible pour tous](https://www.microsoft.com/fr-fr/microsoft-365/blog/2026/06/16/copilot-cowork-is-now-generally-available/) : les agents 2026 sur les modèles d'Anthropic
- [GPT-5.6, modèle privilégié de Microsoft 365 Copilot](https://openai.com/index/gpt-5-6-preferred-model-microsoft-365-copilot/) : disponibilité et bascule du modèle
- [Principaux risques de sécurité de Microsoft Copilot, Forcepoint](https://www.forcepoint.com/blog/insights/top-microsoft-copilot-security-risks) : risque de sur-partage des données
- [Tarifs et forfaits ChatGPT](https://chatgpt.com/pricing) : paliers et modèles de ChatGPT
- [La justice française suspend l'usage de ChatGPT en entreprise, ActuIA](https://www.actuia.com/actualite/la-justice-francaise-suspend-lusage-de-chatgpt-dans-une-entreprise-un-signal-fort-pour-tous-les-projets-ia/) : arrêts de la Cour d'appel de Paris, 21 mai 2026
- [Étude OpinionWay pour SEO.fr sur l'usage de l'IA en France](https://www.seo.fr/blog/etude-exclusive-opinionway) : notoriété et usage des assistants IA (février 2026)
