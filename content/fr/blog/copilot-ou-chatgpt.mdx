...
Les deux ont une version gratuite. Le Copilot gratuit couvre le chat, les réponses web avec citations, la génération d'images et la voix, et beaucoup de tests lui donnent un léger avantage sur la génération d'images gratuite. Le ChatGPT gratuit fait tourner GPT-5.6 Luna, la variante rapide, qui a remplacé GPT-5.5 comme modèle par défaut le 6 août 2026, et à partir de la semaine du 10 août ses conversations texte ne sont plus plafonnées du tout, même si les fichiers, les images et la voix gardent leurs propres limites et que le modèle phare Sol reste réservé aux formules payantes. Sur les fonctionnalités, ils sont proches ; la plus grosse différence, c'est que le Copilot gratuit s'intègre aux applications Microsoft, tandis que ChatGPT donne accès à un ensemble d'outils autonomes plus large.
