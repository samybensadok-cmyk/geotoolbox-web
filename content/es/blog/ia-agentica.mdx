...
Entonces, ¿es ChatGPT una IA agéntica? Por sí solo, no. El modelo base es IA generativa. Activa ChatGPT Work, el modo agéntico de OpenAI (lanzado en julio de 2026, sustituyendo poco a poco al antiguo «agent mode» desde el mes siguiente), conéctalo a herramientas, y ese mismo modelo empieza a comportarse de forma agéntica. La etiqueta depende de lo que el sistema sabe hacer, no del nombre de la marca. Si quieres los mecanismos de fondo, nuestra entrada de glosario sobre el [agente de IA](https://geotoolbox.ai/glossary/ai-agent) los detalla.
...
La adopción es genuinamente amplia. [Una encuesta de PwC](https://www.pwc.com/us/en/tech-effect/ai-analytics/ai-agent-survey.html) a 300 directivos estadounidenses (mayo de 2025) reveló que el 79 % afirmaba que su empresa ya estaba usando agentes de IA, y que dos de cada tres de quienes ya los usaban declaraban un valor medible, sobre todo en productividad. Andrew Ng ayudó a popularizar el concepto de sistemas agénticos, y ya en 2024 escribió que un artículo que usara ese término le daba más ganas de leerlo, porque era «menos probable que fuera puro marketing». Dos años después, la etiqueta está pegada a casi cualquier cosa, señal de que una palabra útil ha dejado de serlo.
...
<figure className="not-prose my-8">
  <BlogImage src="/blog/ia-agentica/calculo-fiabilidad.png" alt="Gráfico que muestra cómo una precisión del 95 %, 90 % y 85 % por paso se traduce en un 60 %, 35 % y 20 % de éxito en una tarea de agente de 10 pasos." w="1040" h="350" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">La longitud de la barra es la probabilidad de que las 10 etapas se completen sin un solo fallo.</figcaption>
</figure>
...
No por defecto. El modelo base de ChatGPT es IA generativa, lo que significa que crea contenido en respuesta a un prompt. Cuando activas ChatGPT Work (el modo agéntico de OpenAI, lanzado en julio de 2026, sustituyendo poco a poco al antiguo «agent mode» desde agosto de 2026) y lo conectas a herramientas, ese mismo modelo puede planificar y actuar a lo largo de varios pasos, lo que hace que esa configuración sea agéntica. Que algo sea agéntico depende de lo que sabe hacer, no del nombre de la marca.
