...
Hace un año, «modelo de IA chino» casi siempre quería decir DeepSeek. En agosto de 2026 quiere decir un sector lleno de laboratorios que publican modelos de primer nivel, la mayoría con [pesos abiertos](https://geotoolbox.ai/blog/open-weights-vs-open-source) descargables, y casi todos mucho más baratos que los sistemas cerrados estadounidenses. Estados Unidos ha respondido con su propio modelo abierto de frontera, [Inkling](https://geotoolbox.ai/blog/inkling-ai) de Thinking Machines, pero es al pelotón que aparece a continuación al que intenta dar alcance. Esta es la lista actual, con la versión que de verdad está activa hoy por hoy.
...
**La línea GLM de Zhipu cerró la brecha, y su buque insignia actual, [GLM-5.3](https://geotoolbox.ai/blog/what-is-glm-5-3), se lanzó el 14 de agosto de 2026.** Viene de Zhipu AI, un laboratorio de Pekín surgido de la Universidad de Tsinghua que opera a nivel internacional como Z.ai, y se lanzó el 14 de agosto de 2026 con una ventana de contexto de un millón de tokens, conservando la misma base 753B/40B que GLM-5.2 (todas las mejoras vienen del posentrenamiento). A diferencia de los términos MIT limpios de GLM-5.2, GLM-5.3 se distribuye bajo una licencia personalizada: los servicios de alojamiento con más de 10.000 millones de dólares de ingresos en cualquier periodo de 12 meses deben pasar una revisión de seguridad de Z.ai. En el Intelligence Index más reciente de Artificial Analysis (v4.3.2, septiembre de 2026) obtiene 45 puntos, el segundo modelo de pesos abiertos, por detrás del nuevo MiMo-V2.6-Pro de Xiaomi (46) y justo por delante de Kimi K3 (44, ahora tercero), y [Reuters informó](https://www.reuters.com/world/asia-pacific/after-anthropic-shutdown-chinas-zai-closes-frontier-gap-it-plans-dual-listing-2026-06-25/) de que Z.ai rivaliza con los modelos cerrados de frontera de OpenAI y Anthropic en código y tareas de agentes, a una fracción del costo. Z.ai salió a bolsa en Hong Kong en enero de 2026, y los inversores vieron en la decisión de regalar los pesos una victoria estratégica más que una pérdida.
...
<tr><td><strong>Hacer código y trabajo con agentes en serio, en abierto</strong></td><td>GLM-5.3</td><td>Entre los modelos chinos más fuertes en código y ejecuciones largas de agentes</td></tr>
...
No hay uno solo que sea el mejor. GLM-5.3 está entre los modelos chinos más fuertes en los rankings de código y agentes (el nuevo MiMo-V2.6-Pro de Xiaomi lo supera por un punto en el índice global de Artificial Analysis), DeepSeek V4 gana en precio, Qwen es la base abierta más adoptada y Kimi K2.6 es el más sólido para ejecuciones largas de agentes. La elección correcta depende de si te importa más el costo, la programación, el ajuste del modelo o el trabajo con agentes.
