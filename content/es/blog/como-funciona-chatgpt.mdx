...
Desde que se lanzaron los anuncios, OpenAI opera un cuarto rastreador: **OAI-AdsBot** valida la seguridad de las páginas enviadas como anuncios. No afecta a la recuperación orgánica, de eso siguen encargándose OAI-SearchBot y ChatGPT-User, pero cualquier empresa que gestione ChatGPT Ads lo encontrará en sus propios registros de servidor.

<figure className="not-prose my-8">
  <BlogImage src="/blog/como-funciona-chatgpt/conocimiento-parametrico-vs-busqueda.png" alt="Conocimiento paramétrico frente a búsqueda en vivo: qué son, cuándo actúan, su actualidad y qué rastreador los controla." w="1300" h="591" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
  <figcaption className="mt-3 text-center text-sm text-gray-500">Dos vías, dos rastreadores: el conocimiento paramétrico siempre está activo, la búsqueda en vivo solo se dispara bajo demanda.</figcaption>
</figure>
...
Lo mismo pasa con la esperanza de pagar por entrar. OpenAI [empezó a mostrar anuncios etiquetados en ChatGPT en Estados Unidos el 9 de febrero de 2026](https://help.openai.com/en/articles/20001047-ads-in-chatgpt), abrió un Ads Manager de autoservicio a mediados de año (OpenAI describe el mecanismo como [una subasta de segundo precio ponderada por relevancia](https://help.openai.com/en/articles/20001207-ads-in-chatgpt-the-basics)) y [extendió los anuncios a 31 mercados europeos a finales de agosto de 2026](https://openai.com/index/chatgpt-ads-expands-across-europe/). Pero esos anuncios aparecen en un bloque etiquetado y separado, debajo de la respuesta, nunca dentro de ella: la propia documentación de OpenAI dice que los anuncios «pueden aparecer debajo del final de una respuesta» y quedan «visualmente separados de la respuesta de ChatGPT», y que los anunciantes «no tienen ninguna capacidad para moldear, clasificar o alterar las respuestas de ChatGPT». A septiembre de 2026 sigue sin existir ninguna subasta que coloque tu marca dentro del texto generado. Lo más cercano son los «Sponsored Agents», en pruebas en Estados Unidos desde el 16 de septiembre de 2026: tras pulsar un anuncio, se puede iniciar una conversación aparte y claramente etiquetada con el agente de una empresa patrocinadora, siempre fuera de la respuesta y siempre después de un clic. La respuesta sale de los pesos y, a veces, de una obtención en vivo, y no hay caja registradora para ninguna de las dos.
...
No. Hablar con ChatGPT no enseña nada al modelo actual sobre tu marca: sus pesos están congelados y la [ventana de contexto](https://geotoolbox.ai/blog/how-does-ai-search-work) de la que lee se borra cuando termina el chat. La función de «memoria» es una libreta por usuario, no entrenamiento. Así que no tiene sentido intentar «contarle» al modelo quién eres dentro de un chat. Las únicas vías de entrada son el corpus de entrenamiento y la recuperación en vivo, ambas cubiertas más arriba.
</Callout>
...
- The Verge: Sam Altman sobre el rumor de los 100 billones de parámetros (enero de 2023) - `theverge.com/2023/1/18/23560328/openai-gpt4-rumor-release-sam-altman-interview`
- OpenAI: expansión de los anuncios de ChatGPT a Europa (agosto de 2026) - `openai.com/index/chatgpt-ads-expands-across-europe`
