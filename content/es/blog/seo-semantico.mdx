...
La forma corta de decirlo es «cosas, no cadenas». Una palabra clave es una cadena de caracteres. Un concepto o una [entidad](https://geotoolbox.ai/blog/entity-seo) es una cosa que se mantiene igual en cada forma de nombrarla. Optimiza para la cadena y ganas una consulta. Optimiza para la cosa y puedes aparecer para las muchas formas en que la gente pregunta por ella.
...
En parte. Google entiende el significado mediante sistemas como RankBrain y BERT, pero la recuperación es híbrida: sigue usando la coincidencia léxica, basada en palabras clave, junto a la [búsqueda semántica](https://geotoolbox.ai/blog/how-does-ai-search-work). De ahí que términos exactos como los nombres de producto y los códigos de error todavía tengan que aparecer en la página, aunque el significado haga la mayor parte del trabajo.
