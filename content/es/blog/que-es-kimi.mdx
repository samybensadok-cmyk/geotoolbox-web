...
date: "2026-08-21"
updated: "2026-09-05"
recheckBy: "2026-10-06"  # backfilled 2026-09-05 freshness audit (no prior guard); gemelo de what-is-kimi-ai. Moonshot retira modelos a ritmo rápido (K2 el 2026-05-25, K2.5 + moonshot-v1 el 2026-08-31). Reverificar la gama en platform.kimi.ai/docs/models
...
K2.5 ya no está disponible. Moonshot primero lo cerró a los usuarios de API recién registrados y después lo retiró el 31 de agosto de 2026, junto con la vieja familia `moonshot-v1`; las llamadas a cualquiera de los dos devuelven ahora un 404, y el único reemplazo que nombra Moonshot es `kimi-k3`. Para programación rutinaria, `kimi-k2.7-code` se ajusta mejor al presupuesto, pero esa es nuestra recomendación, no la de Moonshot.
