...
Lo que convierte esto en una disciplina de verdad y no en un cambio de nombre: las superficies no coinciden entre sí. [Ahrefs halló](https://ahrefs.com/blog/search-rankings-ai-citations/) que el **76 %** de las páginas citadas en las Vistas creadas con IA de Google (julio de 2025) también posicionan en el top 10 tradicional de Google, así que en esa superficie un buen SEO clásico sigue haciendo casi todo el trabajo. Pero ChatGPT y Perplexity beben de conjuntos de fuentes muy distintos: un [análisis de 680 millones de citas de IA](https://www.5wpr.com/research/state-of-ai-citations-2026/) encontró que solo alrededor del **11 %** de los dominios aparece citado en ambos. En la práctica, posicionar bien en Google, que te cite [ChatGPT](https://geotoolbox.ai/blog/seo-for-chatgpt) y que te cite [Perplexity](https://geotoolbox.ai/blog/perplexity-seo) son resultados distintos que mides por separado cuando esas superficies le importan a tu público. Lo mismo vale para [que te cite Gemini](https://geotoolbox.ai/blog/gemini-seo).
