...
**DeepSeek es un laboratorio chino de inteligencia artificial con sede en Hangzhou que desarrolla [grandes modelos de lenguaje (LLM)](https://geotoolbox.ai/blog/how-does-chatgpt-work) de pesos abiertos, además del chatbot que funciona sobre ellos.** Sus modelos más conocidos son DeepSeek-R1, un modelo de razonamiento, y las familias DeepSeek-V3 y V4 para uso general. La empresa fue fundada, y sigue financiada en su mayor parte, por High-Flyer, un fondo de cobertura cuantitativo.
