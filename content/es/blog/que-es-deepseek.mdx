...
description: "Qué es DeepSeek: el laboratorio chino de R1, V3 y V4, el mito de los 6 millones, pesos abiertos vs open source, si es seguro y cuánto cuesta. Septiembre de 2026."
date: "2026-08-20"
updated: "2026-09-19"
...
<table>
<thead>
<tr><th>Modelo (a septiembre de 2026)</th><th>Lanzamiento</th><th>Qué es</th></tr>
</thead>
<tbody>
...
<tr><td><strong>DeepSeek-V4-Pro</strong> (versión general desde el 13 de agosto de 2026)</td><td>Vista previa en abril de 2026, versión general en agosto de 2026</td><td>Modelo insignia para razonamiento y código: 1,6 billones de parámetros totales / 49 000 millones activos, 1 millón de tokens de contexto (384K de salida máxima), sin visión</td></tr>
<tr><td><strong>DeepSeek-V4.1-Flash</strong> (reemplazó a V4-Flash el 10 de septiembre de 2026)</td><td>Septiembre de 2026</td><td>Nivel rápido y barato con una nueva arquitectura codificador-decodificador causal: 552 000 millones + 196 000 millones (Engram) / 8000 millones activos en entrada, 16 000 millones en salida, 1 millón de tokens de contexto (384K de salida máxima), visión nativa</td></tr>
</tbody>
</table>

Algunas cosas que conviene saber. La mayoría son modelos de mezcla de expertos (MoE): almacenan un número enorme de parámetros pero solo activan una pequeña parte para cada [token](https://geotoolbox.ai/blog/what-are-tokens-in-ai), que es el truco detrás de su bajo costo de funcionamiento. El gran salto de abril de 2026 fue la [vista previa de V4](https://api-docs.deepseek.com/news/news260424), que llevó la ventana de contexto a un millón de tokens, con ambos modelos publicados como pesos abiertos bajo licencia MIT. V4 funcionó como vista previa desde el 24 de abril y su buque insignia V4-Pro alcanzó la disponibilidad general el 13 de agosto de 2026. (Curiosamente, la ficha del modelo V4-Pro sigue describiendo «una versión de vista previa de la serie DeepSeek-V4», aunque el producto ya se haya lanzado.)

El nivel Flash se movió dos veces desde la vista previa de abril: una actualización oficial a finales de julio, y un cambio de arquitectura completo el 10 de septiembre, DeepSeek-V4.1-Flash, que añade visión nativa y retira por completo la versión anterior de Flash. DeepSeek anunció brevemente que también enrutaría el tráfico de V4-Pro a este nuevo precio de Flash a partir del 14 de septiembre, y luego dio marcha atrás «en respuesta a la demanda de los usuarios»: V4-Pro sigue como su propio modelo, con precio separado, y los antiguos alias deepseek-chat y deepseek-reasoner se retiraron el 24 de julio de 2026 (llama ahora a deepseek-flash y deepseek-v4-pro). Para el detalle completo de los modelos lanzados, sus pruebas de rendimiento, sus precios y sus comparativas, consulta nuestra [guía de DeepSeek V4](https://geotoolbox.ai/blog/deepseek-v4).

Hay un modelo por el que la gente sigue preguntando y que falta: DeepSeek-R2. Se esperaba en 2025, pero a septiembre de 2026 no ha llegado. Las informaciones apuntan a que Liang no estaba satisfecho con su rendimiento y a problemas de hardware por la apuesta de entrenarlo en chips domésticos de Huawei. Como la gama cambia cada pocos meses, trata esta tabla como una foto de septiembre de 2026 y revisa la ficha de la versión que realmente uses.
...
Sí, DeepSeek es gratis a través de la app web y las apps móviles, sin pago. Donde de verdad destaca es en la API, con precios muy por debajo de los laboratorios estadounidenses, y Flash se abarató todavía más el 10 de septiembre. Las cifras de abajo son las [tarifas actuales de la API](https://api-docs.deepseek.com/quick_start/pricing); cambian, así que llama a `deepseek-flash` y `deepseek-v4-pro` en vez de los alias antiguos ya retirados.

<table>
<thead>
<tr><th>Cómo lo usas</th><th>Precio (a septiembre de 2026)</th><th>Qué obtienes</th></tr>
</thead>
<tbody>
<tr><td><strong>Chat gratis</strong></td><td>0 $</td><td>Acceso por web y app móvil, sin configuración</td></tr>
<tr><td><strong>API (V4.1-Flash)</strong></td><td>0,15 $ entrada (sin caché) / 0,60 $ salida en horas valle, hasta 0,30 $ / 1,20 $ en horas pico, por millón de tokens</td><td>El caballo de batalla barato y rápido; 1 millón de contexto (384K de salida máxima), ahora con visión nativa</td></tr>
<tr><td><strong>API (V4-Pro)</strong></td><td>0,66 $ entrada (sin caché) / 1,98 $ salida en horas valle, hasta 1,32 $ / 3,96 $ en horas pico, por millón de tokens</td><td>El modelo de mayor capacidad de DeepSeek, para razonamiento y agentes; 1 millón de contexto (384K de salida máxima)</td></tr>
...
La división entre horas valle y horas pico llegó el 16 de agosto de 2026, sustituyendo la tarifa plana de todo el día: las horas pico (de 01:00 a 04:00 y de 06:00 a 10:00 UTC, de lunes a viernes, excluyendo festivos oficiales chinos) cobran exactamente el doble de la tarifa valle; los fines de semana y festivos chinos se facturan siempre a tarifa valle. Luego, el 10 de septiembre de 2026, DeepSeek-V4.1-Flash reemplazó al modelo Flash con este nuevo precio, más bajo. DeepSeek también había anunciado que enrutaría V4-Pro a ese precio de Flash desde el 14 de septiembre, y dio marcha atrás: V4-Pro conserva su propio precio, sin cambios. La [página oficial de precios](https://api-docs.deepseek.com/quick_start/pricing) de DeepSeek sigue siendo la fuente a consultar antes de construir nada, ya que estas tarifas han cambiado tres veces este año. Los precios están en dólares, la moneda de facturación de la API.

En comparación, esos precios de API son una fracción de lo que cobran los principales modelos cerrados, que es la razón por la que quienes programan recurren a DeepSeek para tareas de gran volumen en las que el costo es determinante. El acceso viene en tres vías principales: la web y la app móvil gratis, la API compatible con OpenAI para construir, y el autoalojamiento de los pesos abiertos si quieres control total. El autoalojamiento es realista sobre todo para empresas con hardware de GPU serio, ya que los modelos insignia son grandes, pero es la vía que esquiva por completo la cuestión del alojamiento en China; para quien quiere esa misma distancia sin tener un clúster de GPU propio, un proveedor externo que aloje DeepSeek fuera de China es un punto medio práctico, además de las tres vías anteriores.
...
Sí. La web y las apps móviles son gratis, y la API está entre las más baratas de cualquier modelo importante, sobre unos 0,15 $ por millón de tokens de entrada (sin caché) en horas valle para el modelo V4.1-Flash a septiembre de 2026 (hasta 0,30 $ en las horas pico de DeepSeek). Los pesos abiertos también son gratis de descargar y ejecutar bajo licencia MIT si tienes el hardware. Los precios cambian: consulta la página oficial de tarifas.
...
- Precios de la API de DeepSeek - DeepSeek (oficial), verificado en vivo el 19 de septiembre de 2026 - `api-docs.deepseek.com/quick_start/pricing`
- Registro de cambios (lanzamiento de V4.1 Flash, continuidad de V4-Pro) - DeepSeek API Docs, verificado en vivo el 19 de septiembre de 2026 - `api-docs.deepseek.com/updates`
- Presentación de DeepSeek-V4.1-Flash - DeepSeek, 10 de septiembre de 2026 - `deepseek.com/en/news/deepseek-v4-1-flash`
