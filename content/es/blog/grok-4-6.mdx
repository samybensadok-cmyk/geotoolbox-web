...
date: "2026-08-13"
updated: "2026-09-25"
recheckBy: "2026-10-06"  # actualizado 2026-09-25: Grok 4.7 se lanzó el 21 sep 2026 y ahora es el buque insignia actual de xAI (mismo precio 2$/6$ que 4.6)
...
- Se lanzó como producto para desarrolladores (API, Cursor, Grok Build, complementos de Microsoft Office) y ahora también está disponible como chatbot de consumo, en el plan SuperGrok de 30 $/mes. La ventana de contexto sigue siendo de 500.000 tokens, la misma que en 4.5.
...
**Grok 4.6 es el modelo frontera de xAI, lanzado el 12 de agosto de 2026 y construido para agentes de larga duración, programación y trabajo de conocimiento.** Es una versión de [Grok](https://geotoolbox.ai/blog/what-is-grok), el asistente basado en un [gran modelo de lenguaje](https://geotoolbox.ai/blog/how-does-chatgpt-work) que fabrica xAI, la empresa que Elon Musk fundó en 2023 y que hoy opera como SpaceXAI tras la fusión con SpaceX de 2026. Si sigues los números de versión, 4.6 llega alrededor de un mes después de [Grok 4.5](https://geotoolbox.ai/blog/grok-4-5) y fue el buque insignia durante seis semanas, hasta que **Grok 4.7** lo sustituyó el 21 de septiembre de 2026, al mismo precio.
...
Grok 4.6 se lanzó como producto para desarrolladores y desde entonces ha llegado también a los productos de consumo. Según la ficha del modelo de xAI, está disponible a través de la API de xAI (como `grok-4.6`), como modelo por defecto en Grok Build, en todos los planes de Cursor y, algo llamativo, como modelo por defecto en los complementos de Microsoft Word, PowerPoint y Excel, un movimiento directo hacia el terreno de Copilot. También se puede enrutar a través de OpenRouter, Vercel, Cloudflare y otras pasarelas.

Ahora también es un chatbot de consumo. La página de precios de xAI incluye el «modelo Grok 4.6» entre las funciones del plan SuperGrok de 30 $/mes, en grok.com y las apps de iOS/Android: si te preguntas si Grok 4.6 es el modelo que te responde ahí hoy, la respuesta es sí. El estado de la versión integrada directamente en la app de X está menos claro, así que no des por hecho que esté al mismo nivel que la app independiente. Por encima de SuperGrok hay un plan SuperGrok Plus de 100 $/mes, que añade generación de vídeo en 1080p en Imagine, límites de uso mucho más altos y acceso prioritario en horas punta.
...
Dos factores más entran en la decisión. En gobernanza, la ficha del modelo de xAI documenta el comportamiento autónomo con detalle pero incluye poca evaluación formal del riesgo de autonomía, algo que conviene sopesar en un despliegue regulado o de empresa; y el panorama más amplio también cuenta, ya que X y la anterior organización de xAI enfrentan investigaciones abiertas en el Reino Unido y la UE (Ofcom, la ICO y un procedimiento formal de la UE bajo la DSA) que tienen que ver con el historial de la plataforma, no con ninguna resolución adversa contra la API de Grok 4.6. En cuanto a los tiempos, xAI lanzó **Grok 4.7** el 21 de septiembre de 2026, al mismo precio de 2 $/6 $ y a la misma velocidad, disponible a través de la API de xAI, Cursor, Grok Build y herramientas, enrutadores y nubes de terceros; si estás decidiendo hoy, esa es la opción más reciente que conviene evaluar primero. Para lo que se sabe de los próximos saltos, consulta [lo que sabemos de Grok 5](https://geotoolbox.ai/blog/grok-5).

## Preguntas frecuentes

### ¿Grok 4.6 es gratis?

No, pero ya no es exclusivo para desarrolladores. Se lanzó en superficies para desarrolladores (la API, Cursor, Grok Build y los complementos de Office) y desde entonces ha llegado al chat de consumo: la página de precios de xAI incluye Grok 4.6 en el plan SuperGrok de 30 $/mes, en grok.com y las apps de iOS/Android. La página de lanzamiento de xAI también anuncia una prueba gratuita de Grok Build, aunque otras fuentes la sitúan dentro de ese mismo plan SuperGrok; conviene revisar x.ai/build antes de dar por hecho el acceso gratuito. El uso de la API se paga.
...
Grok 4.7 ya llegó: xAI lo lanzó el 21 de septiembre de 2026, al mismo precio de 2 $/6 $ y a la misma velocidad que 4.6. Grok 5 es un modelo distinto y más grande, todavía en entrenamiento; ninguna fuente primaria da una fecha para él, así que trata cualquier plazo concreto como especulación.
