...
<tr><td><strong>Modelos (septiembre de 2026)</strong></td><td>Opus 5 y Sonnet 5 como caballo de batalla, con Fable 5.1 en el nivel superior (Fable 5 y Opus 4.8, ya de la generación anterior)</td><td>La generación <a href="https://geotoolbox.ai/blog/gpt-6-astra">GPT-6 Astra</a>, el modelo insignia de OpenAI desde el 3 de septiembre de 2026, por encima de la generación <a href="https://geotoolbox.ai/blog/gpt-5-6">GPT-5.6</a> (Sol, Terra, Luna)</td></tr>
...
<tr><td><strong>Ventana de contexto</strong></td><td>Hasta <a href="https://platform.claude.com/docs/en/models/overview">1.000.000 de tokens en Opus 5, Sonnet 5 y Fable 5.1</a> (Haiku 4.5 tiene 200.000)</td><td><a href="https://developers.openai.com/api/docs/models/gpt-6-astra">1.050.000 en las API de GPT-6 Astra y GPT-5.6</a>; la app expone bastante menos, por plan</td></tr>
...
<tr><td><strong>Claude</strong></td><td>Opus 5 / Sonnet 5 / Fable 5.1, moldeados por la IA Constitucional</td><td>claude.ai y Claude Code: búsqueda web, manejo de archivos, artefactos, programación agéntica</td></tr>
<tr><td><strong>ChatGPT</strong></td><td>GPT-6 Astra, por encima de la generación GPT-5.6, moldeada por RLHF</td><td>La app de ChatGPT: generación de imágenes, voz, GPT personalizados, navegación, herramientas</td></tr>
</tbody>
</table>
