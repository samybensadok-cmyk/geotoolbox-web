...
<figure className="not-prose my-8">
  <BlogImage src="/blog/claude-vs-chatgpt/claude-vs-chatgpt-scorecard-de.png" alt="Scorecard (September 2026, Opus 5.5 und Fable 5.1 gegen GPT-6 Astra), wo Claude und ChatGPT jeweils vorn liegen: Programmieren umstritten, Preis ein Unentschieden." w="1200" h="816" sizes="(min-width: 768px) 768px, 100vw" className="w-full h-auto rounded-2xl border border-[var(--surface-warm-border)]" />
...
<tr><td><strong>Top-Modelle (September 2026)</strong></td><td>Opus 5.5, Sonnet 5 und das höherwertige Fable 5.1 (Opus 5, Fable 5 und Opus 4.8 gelten inzwischen als Vorgänger bzw. Legacy)</td><td><a href="https://geotoolbox.ai/blog/gpt-6-astra">GPT-6 Astra</a>, OpenAIs Flaggschiff seit dem 3. September 2026, oberhalb von GPT-6 Sol und Luna (22. September 2026, in ChatGPT Work, Codex und der API), die die <a href="https://geotoolbox.ai/blog/gpt-5-6">GPT-5.6-Generation</a> ablösen</td></tr>
...
<tr><td><strong>Claude</strong></td><td>Opus 5.5 / Sonnet 5 / Fable 5.1, geformt durch Constitutional AI</td><td>claude.ai und Claude Code: Websuche, Dateiverarbeitung, Artefakte, agentisches Programmieren</td></tr>
<tr><td><strong>ChatGPT</strong></td><td>GPT-6 Astra, oberhalb von GPT-6 Sol und Luna, geformt durch RLHF</td><td>Die ChatGPT-App: Bildgenerierung, Sprache, Custom GPTs, Browsing, breite Werkzeuge</td></tr>
</tbody>
</table>
...
- OpenAI - Introducing GPT-6 Sol and Luna, 22. September 2026 - `openai.com/index/introducing-gpt-6-sol-and-luna`
