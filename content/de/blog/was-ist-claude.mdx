...
**Claude ist eine Familie von [großen Sprachmodellen](https://geotoolbox.ai/glossary/large-language-model) und ein darauf aufbauender KI-Assistent (Chatbot) von Anthropic.** Ein Sprachmodell ist eine KI, die anhand riesiger Textmengen trainiert wurde und dabei Muster in Sprache, Fakten und Zusammenhängen lernt. In dieser Hinsicht gehört Claude zur selben Kategorie wie ChatGPT und [Gemini](https://geotoolbox.ai/blog/what-is-gemini); es ist keine grundsätzlich andere Art von System.
