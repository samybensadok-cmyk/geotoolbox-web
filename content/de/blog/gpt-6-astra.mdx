...
date: "2026-09-05"
updated: "2026-09-25"
recheckBy: "2026-10-06"   # 09-25: GPT-6 Sol (2,00 $/10,00 $) + GPT-6 Luna (0,10 $/0,50 $) ergänzt, gestartet 22.09.2026 in Work/Codex für Plus+ (Astra unverändert, bleibt laut eigener Aussage OpenAIs bestes Modell); AA Intelligence Index erneut versioniert auf v4.3.2 (Astra 53, gleichauf mit Fable 5.1; Claude Opus 5.5 führt mit 58) – jeder AA-Wert in diesem Artikel muss mit Indexversion gekennzeichnet bleiben, Werte über Versionen hinweg sind nicht vergleichbar.
...
- **GPT-6 Astra ist OpenAIs neues Flaggschiff-Modell**, veröffentlicht am 3. September 2026 als Frontier-Modell über der GPT-5.6-Linie, erreichbar in der API als `gpt-6-astra`.
...
GPT-6 Astra ist OpenAIs neues [großes Sprachmodell](https://geotoolbox.ai/blog/how-does-chatgpt-work), veröffentlicht am 3. September 2026 als Frontier-Modell über der GPT-5.6-Linie (direkter Nachfolger von GPT-5.6 Sol ist GPT-6 Sol, nicht Astra). Entwickler erreichen es in der API unter der Kennung `gpt-6-astra`.
...
Falls dir der Begriff [agentisch](https://geotoolbox.ai/blog/agentic-ai) neu ist: Kurz gesagt ist Astra ein [Reasoning-Modell](https://geotoolbox.ai/blog/how-ai-models-think) mit deutlich mehr Handlungsspielraum als die [GPT-5.6-Familie](https://geotoolbox.ai/blog/gpt-5-6), die es ablöst.
...
Die Preisseite selbst sagt nirgends, wo kurzer und wo langer Kontext beginnt. Die Modellseite dagegen schon: **Prompts über 272.000 Input-Token werden für die gesamte Anfrage zum doppelten Input- und Cache-Satz sowie zum 1,5-fachen Output-Satz abgerechnet.** Diese eine Regel ergibt die gesamte Langkontext-Zeile von selbst. An dieser Grenze richtet sich ein API-Budget aus. Cache Writes werden zum 1,25-Fachen des ungecachten Input-Satzes berechnet, und Flex kostet wie Batch die Hälfte (50 %). Das [breitere Bild der Token-Kosten](https://geotoolbox.ai/blog/ai-token-cost) über Anbieter hinweg, und was ein [Kontextfenster](https://geotoolbox.ai/blog/how-does-ai-search-work) wirklich kostet, lohnen sich als Ergänzung dazu.

## GPT-6 Sol und GPT-6 Luna kommen zur Familie hinzu

Astra kam am 3. September allein. Drei Wochen später, am 22. September 2026, ergänzte OpenAI zwei weitere GPT-6-Modelle: **GPT-6 Sol** und **GPT-6 Luna**. Anders als Astra ist keines der beiden ein Frontier-Modell – OpenAIs eigene Formulierung ist eindeutig: „GPT-6 Astra continues to be our best model across the board." Sol und Luna ersetzen stattdessen [GPT-5.6 Sol und Luna](https://geotoolbox.ai/blog/gpt-5-6) als Arbeits- und Schnellstufe innerhalb von ChatGPT Work und Codex, für Plus, Pro, Business, Enterprise und Edu. Free und Go bekommen GPT-6 Luna nur in der Desktop-App, nicht im normalen Chat.

Auf der API kostet GPT-6 Sol 2,00 $ Input und 10,00 $ Output pro Million Token, GPT-6 Luna 0,10 $ und 0,50 $ – jeweils etwa die Hälfte des Aktionspreises des jeweiligen GPT-5.6-Pendants (4 $/20 $ für Sol, 0,20 $/1,20 $ für Luna) und ein Bruchteil von Astras 10,00 $/50,00 $. Ein normaler ChatGPT-Chat läuft Stand jetzt weiterhin auf GPT-5.6, nicht auf GPT-6 Sol oder Luna. Drei Wochen nach dem Start besteht die GPT-6-Familie also aus einem Frontier-Modell (Astra) plus zwei Arbeitsstufen-Geschwistern (Sol, Luna), die ihm bei Preis und Produktumfang untergeordnet sind.
...
**Update, 25. September 2026:** Artificial Analysis hat den Intelligence Index inzwischen erneut versioniert, auf **v4.3.2**. Auf dieser Skala erreicht Astra **53** Punkte, gleichauf mit Claude Fable 5.1, während **Claude Opus 5.5** den Gesamtindex mit **58** Punkten anführt. Die Werte v4.1.1 und v4.2 oben gelten jeweils für den Tag ihrer Skala, nicht für diese: Artificial Analysis ändert zwischen Indexversionen seine Tests und Bewertung (v4.3.2 hat zwei ratingbasierte Tests neu verankert und neu angepasst), Werte aus unterschiedlichen Versionen sind daher nie direkt vergleichbar, nur die relative Rangfolge innerhalb einer Version.
...
<table>
  ...
  <tbody>
    ...
    <tr><td>AA Intelligence Index v4.3.2</td><td>53</td><td>53 (gleichauf)</td><td>Unabhängig</td></tr>
...
Fable 5.1 führte den allgemeinen Intelligence Index beim Start (v4.2) an; nach der aktuellen Neuversionierung auf v4.3.2 liegen beide gleichauf bei 53, während Claude Opus 5.5 den Gesamtindex mit 58 anführt. Fable 5.1 hat weiterhin die günstigere Cache-Ökonomie, ein Viertel von Astras Cached-Input-Satz, was bei Agentenschleifen, die denselben Kontext wiederholt lesen, deutlich zu Buche schlägt.
...
Für die Mechanik dahinter: [wie die ChatGPT-Suche funktioniert](https://geotoolbox.ai/blog/how-chatgpt-search-works), was ein [KI-Zitat](https://geotoolbox.ai/blog/how-to-get-cited-by-ai) ist, und unsere Definition von [KI-Sichtbarkeit](https://geotoolbox.ai/blog/what-is-ai-visibility).

## Häufige Fragen

### Ist GPT-6 schon erschienen?

Ja. OpenAI veröffentlichte GPT-6 Astra am 3. September 2026 als begrenzte Vorschau für vertrauenswürdige Partner, ab dem 4. September für bezahlte ChatGPT-Tarife, zunächst Pro, Enterprise und Business Premium, später am selben Tag auch Plus in ChatGPT Work und Codex. Astra ist das Frontier-Release von GPT-6; am 22. September 2026 ergänzte OpenAI zwei weitere GPT-6-Modelle, Sol und Luna, als Arbeitsstufen-Geschwister innerhalb von ChatGPT Work und Codex, bei Preis und Umfang unter Astra.

### Was ist GPT-6 Astra?

Es ist OpenAIs Flaggschiff-Modell, oberhalb von GPT-6 Sol und Luna, entwickelt für lang laufende agentische Aufgaben und Computernutzung statt für reinen Chat. In der API heißt es `gpt-6-astra`.
