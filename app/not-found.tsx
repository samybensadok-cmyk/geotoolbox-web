            ...
            <ul className="mt-10 grid grid-cols-1 gap-3 sm:grid-cols-3">
              <li>
                ...
                >
                  ...
                  <p className="mt-1 text-[13px] leading-relaxed text-gray-600">Visibility across 8 AI engines in minutes.</p>
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  ...
                  <p className="mt-2 text-[15px] font-semibold text-gray-900">Eleven tools</p>
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-3xl border border-gray-200 bg-gradient-to-br from-gray-50 to-white p-6 shadow-lg shadow-gray-900/5 sm:p-8">
              ...
              <div className="mt-6 space-y-2.5">
                {["ChatGPT", "Perplexity", "Gemini", "Claude", "Google AI Overviews", "Google AI Mode", "Bing Copilot", "Grok"].map((engine) => (
              ...
              <p className="mt-6 font-mono text-[11px] text-gray-600">
                0 of 8 engines know this URL. Try a scan on something real.
              </p>
            </div>
          </div>
        </div>
