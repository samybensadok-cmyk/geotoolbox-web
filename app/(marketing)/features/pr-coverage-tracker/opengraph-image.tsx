...
export const alt = "PR Coverage Tracker: prove your earned media shows up in AI"
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flex: 1, paddingRight: 40 }}>
          ...
          <div style={{ fontSize: 56, fontWeight: 700, lineHeight: 1.05, color: "#111827", letterSpacing: "-0.02em" }}>
            Prove your earned media shows up in AI.
          </div>
          <div style={{ fontSize: 20, color: "#4b5563", marginTop: 20, lineHeight: 1.4 }}>
            Live, indexed, on-message, and cited by AI — for every placement you earned.
          </div>

          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: "auto", fontSize: 15, color: "#6b7280" }}>
            geotoolbox.ai/features/pr-coverage-tracker
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 420 }}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 20 }}>
              {[
                { label: "Live", value: "Indexed", color: "#15803d", bg: "#dcfce7" },
                { label: "Blocked", value: "In Google", color: "#a16207", bg: "#fef9c3" },
                { label: "Cited by AI", value: "ChatGPT · Perplexity", color: "#4338ca", bg: "#e0e7ff" },
              ].map((r) => (
