...
export const alt = "AI automation agency — custom AI agents, Claude skills and tools, by the operator whose own agents run this site"
export const size = { width: 1200, height: 630 }
export const contentType = "image/png"

export default function OGImage() {
  const { google, aiCitations } = proofStats
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flex: 1, paddingRight: 40 }}>
          ...
          <div style={{ fontSize: 20, color: "#4b5563", marginTop: 20, lineHeight: 1.4 }}>
            Claude skills, agents and custom tools. Fixed quotes. You own everything.
          </div>

          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: "auto", fontSize: 15, color: "#6b7280" }}>
            geotoolbox.ai/services/ai-automation-agency
          </div>
        </div>
