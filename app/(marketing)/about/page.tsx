...
export const metadata: Metadata = {
  title: "About",
  description:
    "GEO Toolbox is the AI visibility platform: 14 features and 10 free tools that measure your AI-search visibility across 8 engines.",
      ...
      <section className="relative overflow-hidden bg-[var(--surface-warm,theme(colors.amber.50))] px-6 pt-14 pb-16 sm:pt-20 sm:pb-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-gray-700">
            GEO Toolbox is the AI visibility platform that gets your brand cited by AI. Fourteen features and ten free tools that measure your visibility across eight engines, ChatGPT, Perplexity, Gemini, Claude, Google AI Overviews, Google AI Mode, Bing Copilot, and Grok, find why a page isn&apos;t cited, and win the citations your competitors are taking.
          </p>
        </div>
      </section>
