...
const faqs = [
  {
    ...
    answer:
      "Everything a brief needs for generative engine optimization: target keyword analysis, content framework (pillar, cluster, comparison, or FAQ), outline with H2/H3 structure, entity checklist, differentiation rules, and SERP gap analysis. Enough for a writer to ship something AI engines will cite.",
  },
  {
    question: "Which AI model generates the brief?",
    answer:
      "The brief is generated by AI models tuned on current search results, competitor content, and live AI citation patterns. It's built from real SERPs and real AI responses, not a generic LLM prompt, so the framework reflects what actually wins citations today.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "When GSC is connected, the brief factors in your existing rankings, clicks, and impressions to prioritize the highest-impact opportunities first: the keywords where better content earns both AI citations and organic traffic.",
  },
]
