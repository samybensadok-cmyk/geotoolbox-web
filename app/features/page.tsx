  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        slug: null,
        name: "Content Brief",
        blurb: "Generate a production-ready AI content brief for any keyword. Outline, entities, facts coverage, and SERP gap analysis — export as PDF or XLSX.",
        highlights: ["Outline + entities", "SERP gaps", "PDF / XLSX export"],
        deepLink: false,
      },
    ],
  },
