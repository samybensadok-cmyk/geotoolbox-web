    ...
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      ...
      <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-gray-600">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            <li>Revoke GEO Toolbox&apos;s access to your Google account at any time via your <a href="https://myaccount.google.com/permissions" className="text-accent-600 underline hover:text-accent-700">Google Account permissions</a></li>
