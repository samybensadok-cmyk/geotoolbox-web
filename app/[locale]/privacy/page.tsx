      ...
      <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-gray-600">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            ...
            <li>PostHog : événements d&rsquo;usage produit au sein de l&rsquo;application (soumis à consentement dans l&rsquo;EEE, au Royaume-Uni et en Suisse, relayés via notre propre domaine)</li>
        ...
        <section>
          ...
          <p className="mt-3">
            Nous utilisons également les cookies de mesure d&rsquo;audience décrits ci-dessous ; lorsque la réglementation applicable exige votre consentement — notamment pour les visiteurs de l&rsquo;EEE, du Royaume-Uni et de la Suisse — ces outils ne sont activés qu&rsquo;après votre acceptation du bandeau. Ils sont déposés par <strong>Google Analytics 4</strong> (trafic agrégé, pages vues, type d&rsquo;appareil, localisation approximative), <strong>Microsoft Clarity</strong> (schémas d&rsquo;interaction agrégés, y compris cartes de chaleur et relectures de session masquant les textes sensibles et les champs de formulaire) et — au sein de l&rsquo;application — <strong>PostHog</strong> (événements d&rsquo;usage produit, relayés via notre propre domaine). Aucun de ces outils n&rsquo;est utilisé à des fins publicitaires ni de suivi inter-sites.
          </p>
          <p className="mt-3">
